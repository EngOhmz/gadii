...
foreach($group->accountCodes as $account_code){
                         ...
                         $cr = \App\Models\JournalEntry::where('account_id', $account_code->account_id)->sum('credit');
                        $dr = \App\Models\JournalEntry::where('account_id', $account_code->account_id)->sum('debit');
