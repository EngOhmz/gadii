...
class TwiceMonth2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'twicemonthend:sms';
     ...
     * @var string
     */
    protected $description = 'Greetings Sms in twice a month end of month';
    ...
    public function handle()
    {
        ...
        if($results2->isNotEmpty()){
                ...
                //   $message = "Dear $row2->name, Act now! In just 1 day, your EMASUITE account expires, your account of $row2->slug is expiring at $row2->due_date. Pay now to seize the chance to simplify, manage, and grow your business smartly. Call +255655973248. Powered by UjuziNet.";
                  $message = "Dear $row2->name, we want your business to thrive. Inform us of any EMASUITE System challenges. What additions can help you grow? Contact: +255655973248. Manage business smartly with EMASUITE. Powered by UjuziNet.";
          ...
          $this->info('Twice a month in end month sms testing'); 
