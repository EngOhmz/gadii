...
class UsersController extends Controller
{
    ...
    public function affiliate()
    {
        ...
        $users = User::where('reference_no', auth()->user()->affiliate_no)->get();

        return view('affiliate.all_users',Compact('users'));
    }
    ...
    public function withdraw_methods()
    {
        ...
        return view('affiliate.withdraw_methods');
    }
    ...
    public function withdraw_request()
    {
        ...
        return view('affiliate.withdraw_request');
    }
    ...
    public function withdraw_settings()
    {
        ...
        return view('affiliate.withdraw_settings');
    }
