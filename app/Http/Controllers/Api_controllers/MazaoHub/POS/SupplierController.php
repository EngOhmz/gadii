...
class SupplierController extends Controller
{
    ...
    public function index(int $id)
    {
       ...
       if(!empty($usr)){
            ...
            $supply = Supplier::where('user_id', $added_by)->where('disabled','0')->get();
    ...
    public function indexOff(int $id, int $lastId)
    {
       ...
       if(!empty($usr)){
            ...
            $supply = Supplier::where('user_id', $added_by)->where('disabled','0')->where('id', '>', $lastId)->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        $data=Supplier::find($request->input('id'));
        $data->name=$request->input('name');
        $data->address=$request->input('address');
        $data->phone=$request->input('phone');
        $data->TIN=$request->input('TIN');
