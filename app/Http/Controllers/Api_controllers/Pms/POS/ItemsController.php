    ...
    public function index(int $id)
    {
       ...
       if(!empty($usr)){
            ...
            $added_by = $usr->added_by;
                ...
                $items = Items::where('added_by', $added_by)->whereIn('type', [1])->where('bar', 1)->where('restaurant', 1)->where('disabled','0')->orderBy('created_at', 'desc')->get();
    ...
    public function indexOff(int $id, int $lastId)
    {
       ...
       if(!empty($usr)){
            ...
            $added_by = $usr->added_by;
                ...
                $items = Items::where('added_by', $added_by)->whereIn('type', [1])->where('bar', 1)->where('restaurant', 1)->where('disabled','0')->where('id', '>', $lastId)->orderBy('created_at', 'desc')->get();
    ...
    public function store(Request $request)
    {
       ...
       if(!empty($usr)){
            ...
            $data->sales_price=$request->input('sales_price');
             $data->unit_price=$request->input('sales_price');
 ...
 if($nameArr > 0){ 
    ...
    public function quantity_update(Request $request){
     ...
     $lists= array(
          ...
          $cr= AccountCodes::where('account_name','Inventory')->where('added_by',$added_by)->first();
        //   dd($cr);
