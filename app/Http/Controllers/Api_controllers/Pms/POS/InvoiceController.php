...
class InvoiceController extends Controller
{
    ...
    public function index(int $id)
    {
       ...
       if(!empty($usr)){
        ...
        $invoices=Invoice::where('invoice_status',1)->where('added_by', $added_by)->orderBy('created_at', 'desc')->get();
    ...
    public function shopkeeper_index(int $id)
    {
        ...
        $invoices=Invoice::where('invoice_status',1)->where('store_id', $id)->orderBy('created_at', 'desc')->get();
    ...
    public function indexOff(int $id, int $lastId)
    {
       ...
       if(!empty($usr)){
        ...
        $invoices=Invoice::where('invoice_status',1)->where('added_by', $added_by)->where('id', '>' ,$lastId)->orderBy('created_at', 'desc')->get();
       ...
       if(!empty($usr)){
        ...
        //   =============
         ...
         $journal->client_id= $inv->client_id;
          ...
          $codes=AccountCodes::where('account_group','Receivables')->where('added_by', $added_by)->first();
          $journal = new JournalEntry();
