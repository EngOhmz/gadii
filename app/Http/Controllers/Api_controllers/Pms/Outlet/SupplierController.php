...
class SupplierController extends Controller
{
    ...
    public function index(int $id)
    {
       ...
       $added_by =  $usr->added_by;
        ...
        $supply = Supplier::where('user_id', $added_by)->get();
        ...
        $response=['success'=>false,'error'=>true,'message'=>'Failed to  Return Suppliers Cause User ID not found on users table Successfully'];
        return response()->json($response,200);
    }
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            $response=['success'=>false,'error'=>true,'message'=>'Failed to  Create Supplier Cause User ID not found on users table Successfully'];
            return response()->json($response,200);
        }
