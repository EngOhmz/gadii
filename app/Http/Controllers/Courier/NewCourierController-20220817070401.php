...
if(!empty($account)){
$balance=$account->balance -  $request->pcosts;
...
$account->update($item_to);
  ...
  $cr= AccountCodes::where('id',$request->bank_id)->first();
     ...
     $new['account_id']= $request->bank_id;
      ...
      $new['balance']=  0-$request->pcosts;
       $new[' exchange_code']= 'TZS';
        $new['added_by']=auth()->user()->added_by;
$balance=0-$request->pcosts;
     Accounts::create($new);
}
   ...
   // save into tbl_transaction
                             ...
                             $transaction= Transaction::create([
                               ...
                               'account_id' => $request->bank_id,
                                ...
                                'type' => 'Expense',
                                'amount' =>$request->pcosts,
                                'debit' => $request->pcosts,
...
if(!empty($account)){
$balance=$account->balance -  $request->lcosts;
$item_to['balance']=$balance;
$account->update($item_to);
}
  ...
  $cr= AccountCodes::where('id',$request->bank_id)->first();
     ...
     $new['account_id']= $request->bank_id;
       $new['account_name']= $cr->account_name;
      $new['balance']=  0-$request->lcosts;
       $new[' exchange_code']= 'TZS';
        $new['added_by']=auth()->user()->added_by;
$balance=0-$request->lcosts;
     Accounts::create($new);
}
   ...
   // save into tbl_transaction
                             ...
                             $transaction= Transaction::create([
                               ...
                               'account_id' => $request->bank_id,
                                ...
                                'type' => 'Expense',
                                'amount' =>$request->lcosts,
                                'debit' => $request->lcosts,
                                 'total_balance' =>$balance,
...
if(!empty($account)){
$balance=$account->balance -  $request->ocosts;
$item_to['balance']=$balance;
$account->update($item_to);
}
  ...
  $cr= AccountCodes::where('id',$request->bank_id)->first();
     ...
     $new['account_id']= $request->bank_id;
       $new['account_name']= $cr->account_name;
      $new['balance']=  0-$request->ocosts;
       $new[' exchange_code']= 'TZS';
        $new['added_by']=auth()->user()->added_by;
$balance=0-$request->ocosts;
     Accounts::create($new);
}
   ...
   // save into tbl_transaction
                             ...
                             $transaction= Transaction::create([
                               ...
                               'account_id' => $request->bank_id,
                                ...
                                'type' => 'Expense',
                                'amount' =>$request->ocosts,
                                'debit' => $request->ocosts,
                                 'total_balance' =>$balance,
...
if(!empty($account)){
$balance=$account->balance -  $request->dcosts;
$item_to['balance']=$balance;
$account->update($item_to);
}
  ...
  $cr= AccountCodes::where('id',$request->bank_id)->first();
     ...
     $new['account_id']= $request->bank_id;
       $new['account_name']= $cr->account_name;
      $new['balance']=  0-$request->dcosts;
       $new[' exchange_code']= 'TZS';
        $new['added_by']=auth()->user()->added_by;
$balance=0-$request->dcosts;
     Accounts::create($new);
}
   ...
   // save into tbl_transaction
                             ...
                             $transaction= Transaction::create([
                               ...
                               'account_id' => $request->bank_id,
                                ...
                                'type' => 'Expense',
                                'amount' =>$request->dcosts,
                                'debit' => $request->dcosts,
                                 'total_balance' =>$balance,
