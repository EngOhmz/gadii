...
$num=count($nameArr);
$pcosts=($request->pcosts/$num);
$lcosts=($request->lcosts/$num);
$ocosts=($request->ocosts/$num);
$dcosts=($request->dcosts/$num);
  ...
  $loading_cargo =CourierLoading::create(
                        [ 
                         ...
                         'pacel_number'=>$collection->pacel_number,
                          'confirmation_number'=>$collection->confirmation_number,
