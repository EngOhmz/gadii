...
class WorkOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $locations = Location::all()->where('type',3)->where('added_by', auth()->user()->added_by);
           ...
           $items = Items::all()->where('type',2);
           $users = User::all()->where('added_by', auth()->user()->added_by);
      
        return view('manufacturing.work_order',compact('work_orders','items','locationWs', 'locationFs', 'locations', 'users', 'billofmaterials'));
    }
    ...
    public function show(Request $request, $id)
   {
    ...
    public function edit($id)
    {
        ...
        return view('manufacturing.work_order',compact('data','id','items','locationWs', 'locationFs', 'locations', 'users', 'billofmaterials'));
    }
