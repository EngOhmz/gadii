...
class CarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cargo_agency.management.add_car', compact('cars'));
    }
    ...
    public function car_today()
    {
        ...
        return view('cargo_agency.management.car_today', compact('driverRoute'));
    }
    ...
    public function arrived()
    {
        ...
        return view('cargo_agency.management.arrived_car', compact('cars'));
    }
    ...
    public function arrived_car_store(Request $request)
    {
        ...
        return view('cargo_agency.search_view', compact('cars'));
    }
    ...
    public function all()
    {
        ...
        return view('cargo_agency.management.all_car', compact('cars'));
    }
    ...
    public function old()
    {
        ...
        return view('cargo_agency.management.old_car', compact('cars'));
    }
    ...
    public function car_routes()
    {
        ...
        return view('cargo_agency.management.car_routes', compact('cars'));
    }
    ...
    public function car_pacel()
    {
        ...
        return view('cargo_agency.management.car_pacels', compact('cars'));
    }
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($customers)
                ...
                ->addColumn('action', function ($row) {
                    return view('cargo_agency.management.action', compact('row'));
                })
                ->rawColumns(['action'])
                ->make(true);
        }

        return view('cargo_agency.management.customer_search');
    }
    ...
    public function customer_history(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($customers)
                ...
                ->addColumn('action', function ($row) {
                    return view('cargo_agency.management.delivery_action', compact('row'));
                })
                ->rawColumns(['action', 'added_by', 'created_at'])
                ->make(true);
        }

        return view('cargo_agency.management.customer_history');
    }
    ...
    public function pacel_store(Request $request)
    {
        if ($request->ajax()) {
            ...
            $date = '2023-07-10';
            $customers = CustomerPacel::where('idadi_stoo', '!=', '0')
            ...
            return DataTables::of($customers)
                ...
                ->addColumn('action', function ($row) {
                    return view('cargo_agency.management.pacel_action', compact('row'));
                })
                ->rawColumns(['action'])
                ->make(true);
        }
    ...
    public function car_today_routes(Request $request, $id)
    {
        ...
        return view('cargo_agency.management.car_today_routes', compact('carNumber', 'dataResult'));
    }
    ...
    public function car_pacel_detail(int $id, string $startDate, string $endDate)
    {
        ...
        $carId = $id;
        return view('cargo_agency.management.car_routes_pacel_detail', compact('pacelUnique', 'pacels', 'carNumber', 'total', 'total_paid', 'total_pacel', 'dt', 'carId', 'dt34'));
    }
    ...
    public function pacel_reg($customer_ID)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.dashboard.pacel_reg', compact('dataResult', 'dataResult2'))->setPaper($customPaper, 'portrait');
    ...
    public function car_manifest($id, $startDate, $endDate)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_manifest_pdf', compact('pacelUnique', 'pacels', 'carNumber', 'to_list', 'value', 'total_paid', 'total_pacel', 'total_customers', 'printed', 'driver', 'dr_no'))->setPaper($customPaper, 'portrait');
    ...
    public function car_manifest22($id, $startDate, $endDate)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_manifest_pdf22', compact('pacelUnique', 'pacels', 'carNumber', 'to_list', 'value', 'total_paid', 'total_pacel', 'total_customers', 'printed', 'driver', 'dr_no'))->setPaper($customPaper, 'portrait');
    ...
    public function car_manifest23($id, $startDate, $endDate)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_manifest_pdf23', compact('pacelUnique', 'pacels', 'carNumber', 'to_list', 'value', 'total_paid', 'total_pacel', 'total_customers', 'printed', 'driver', 'dr_no'))->setPaper($customPaper, 'portrait');
    ...
    public function car_manifest24($id, $startDate, $endDate)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_manifest_pdf24', compact('pacelUnique', 'pacels', 'carNumber', 'to_list', 'value', 'total_paid', 'total_pacel', 'total_customers', 'printed', 'driver', 'dr_no'))->setPaper($customPaper, 'portrait');
    ...
    public function car_manifestAll($id, $startDate, $endDate)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_manifest_pdfAll', compact('pacelUnique', 'pacels', 'carNumber', 'to_list', 'value', 'total_paid', 'total_pacel', 'total_customers', 'printed', 'driver', 'dr_no'))->setPaper($customPaper, 'portrait');
    ...
    public function car_invoice($id, $startDate, $endDate)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_invoice_pdf', compact('pacelUnique', 'pacels', 'car'))->setPaper($customPaper, 'portrait');
    ...
    public function car_invoice22($id, $startDate, $endDate)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_invoice_pdf22', compact('pacelUnique', 'pacels', 'car'))->setPaper($customPaper, 'portrait');
        return $pdf->stream('car_invoice.pdf');
    }
    ...
    public function car_invoice23($id, $startDate, $endDate)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_invoice_pdf23', compact('pacelUnique', 'pacels', 'car'))->setPaper($customPaper, 'portrait');
        return $pdf->stream('car_invoice.pdf');
    }
    ...
    public function car_single_invoice($id, $startDate, $endDate, $pacel_id)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.car_single_invoice_pdf', compact('pacelUnique', 'pacels', 'car'))->setPaper($customPaper, 'portrait');
        return $pdf->stream('cargo_agency.car_single_invoice.pdf');
    }
    ...
    public function show($id)
    {
        ...
        $pdf = PDF::loadView('cargo_agency.management.manifest_pdf', compact('data'))->setPaper($customPaper, 'portrait');
        return $pdf->stream('cargo_agency.delivery_ticket_store.pdf');
    }
    ...
    public function delivery_show($id)
    {
        ...
        $timecorrect = Customer::where('id', $data2->customer_id)->first();

        $result22 = 'kupakia';

        $data3 = PacelHistory::where('pacel_id', $id)
            ->where('activity', $result22)
            ->get();

        return view('cargo_agency.management.delivery_show', compact('data', 'data2', 'data3', 'timecorrect'));
    }
    ...
    public function customer_show($id)
    {
        ...
        return view('cargo_agency.management.customer_show', compact('data', 'data2', 'data3', 'timecorrect'));
    }
    ...
    public function pacel_show($id)
    {
        ...
        return view('cargo_agency.management.pacel_show', compact('data', 'data2', 'data3', 'timecorrect'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('cargo_agency.management.edit_car', compact('car'));
    }
