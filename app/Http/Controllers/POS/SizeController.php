...
class SizeController extends Controller
{
    ...
    public function index()
    {
        ...
        $category=Size::where('added_by',auth()->user()->added_by)->where('disabled','0')->get();
       return view('pos.purchases.item_size',compact('category'));
    }
    ...
    {        
        $data=Size::find($id);
       $category=Size::where('added_by',auth()->user()->added_by)->where('disabled','0')->get();
       return view('pos.purchases.item_size',compact('category','data','id'));
    }
