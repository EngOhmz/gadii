...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        $type="";
       return view('pos.sales.invoice',compact('name','client','currency','invoices','type'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($nameArr)){
            ...
            $cost['reference_no']= "INV-".$invoice->id."-".$data['invoice_date'];
  ...
  public function inventory_list()
    ...
    public function invoice_pdfview(Request $request)
    {
        ...
        $pdf = PDF::loadView('pos.sales.invoice_details_pdf')->setPaper('a4', 'landscape');
