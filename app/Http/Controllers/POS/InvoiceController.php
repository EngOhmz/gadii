...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($unpaid);
        return view('pos.sales.invoice',compact('name', 'bank_details', 'client','currency','invoices','type','bank_accounts','location','user','branch',
    ...
    {
        // Generate unique reference number starting with INV for invoice
    ...
    public function edit($id)
    {
        ...
        return view('pos.sales.invoice',compact('name','client','currency','data','id','items','bank_details','type','bank_accounts','location','user','branch',
            'pos_invoice','pos_due','total','unpaid','part','paid'
        ));
    }
