...
class ColorController extends Controller
{
    ...
    public function index()
    {
        ...
        $category=Color::where('added_by',auth()->user()->added_by)->where('disabled','0')->get();
       return view('pos.purchases.color',compact('category'));
    }
    ...
    {        
        $data=Color::find($id);
       $category=Color::where('added_by',auth()->user()->added_by)->where('disabled','0')->get();
       return view('pos.purchases.color',compact('category','data','id'));
    }
