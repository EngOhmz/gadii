...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        $task = Task::all()->where('added_by', auth()->user()->added_by)->whereNull('task_id')->where('disabled', '0');
        ...
        $count = Task::all()->where('added_by', auth()->user()->added_by)->whereNull('task_id')->where('disabled', '0')->count();
        $pro = $count + 1;
        $reference = "00" . $pro;

        $goal_tracking = GoalTracking::all()->where('added_by', auth()->user()->added_by);

        return view('project.task.index', compact('project', 'categories', 'billing_type', 'task', 'milestones', 'leads', 'users', 'reference', 'goal_tracking'));
    }
    ...
    public function edit($id)
    {
        ...
        $task = Task::all()->where('added_by', auth()->user()->added_by)->whereNull('task_id');
        $categories = TaskCategory::all()->where('added_by', auth()->user()->added_by);
        $billing_type = Billing_Type::all()->where('added_by', auth()->user()->added_by);
        ...
        return view('project.task.index', compact('data', 'categories', 'billing_type', 'task', 'id', 'project', 'leads', 'milestones'));
    }
    ...
    //     return view('project.task.project_details',compact('data', 'id','type'));
    // }
    ...
    public function show($id)
    {
        ...
        $comment_details = Comment::where('task_id', $id)->where('disabled', '0')->where('comments_reply_id', '0')->orderBy('comment_datetime', 'DESC')->get();
        $attach = Attachment::where('task_id', $id)->where('disabled', '0')->get();
        $notes = Notes::where('task_id', $id)->where('disabled', '0')->get();
        $activity = TaskActivity::where('task_id', $id)->get();
        $task = Task::all()->where('added_by', auth()->user()->added_by)->where('task_id', $id)->where('disabled', '0');
        $categories = TaskCategory::all()->where('added_by', auth()->user()->added_by);
        $milestones = Milestone::all()->where('added_by', auth()->user()->added_by);
        $users = User::all()->where('added_by', auth()->user()->added_by);


        $ccount = Comment::where('task_id', $id)->where('disabled', '0')->where('comments_reply_id', '0')->count();
        $attcount = Attachment::where('task_id', $id)->where('disabled', '0')->count();
        $ncount = Notes::where('task_id', $id)->where('disabled', '0')->count();
        $actcount = TaskActivity::where('task_id', $id)->count();
        $tcount = Task::where('added_by', auth()->user()->added_by)->where('task_id', $id)->where('disabled', '0')->count();

        return view('project.task.project_details', compact(
            'data',
            'id',
            'type',
            'comment_details',
    ...
    public function save_details(Request $request)
    {
        ...
        switch ($request->type) {
            case 'comments':
                ...
                return redirect(route('task.show', $request->task_id))->with(['success' => "Details Created Successfully", 'type' => 'comments']);
            ...
            case 'attachment':
                ...
                return redirect(route('task.show', $request->task_id))->with(['success' => "Details Created Successfully", 'type' => 'attachment']);
                break;
            ...
            case 'notes':
                ...
                return redirect(route('task.show', $request->task_id))->with(['success' => "Details Created Successfully", 'type' => 'notes']);
                break;
            ...
            case 'tasks':
                ...
                return redirect(route('task.show', $request->task_id))->with(['success' => "Details Created Successfully", 'type' => 'tasks']);
                break;
    ...
    public function update_details(Request $request)
    {
        ...
        switch ($request->type) {
            case 'attachment':
                ...
                return redirect(route('task.show', $request->task_id))->with(['success' => "Details Updated Successfully", 'type' => 'attachment']);
            ...
            case 'notes':
                ...
                return redirect(route('task.show', $request->task_id))->with(['success' => "Details Updated Successfully", 'type' => 'notes']);
    ...
    public function delete_details($type, $type_id)
    {
        ...
        switch ($type) {
            ...
            case 'delete-comments':
                ...
                return redirect(route('task.show', $id))->with(['success' => "Details Deleted Successfully", 'type' => 'comments']);
            ...
            case 'delete-attachment':
                ...
                return redirect(route('task.show', $id))->with(['success' => "Details Deleted Successfully", 'type' => 'attachment']);
            ...
            case 'delete-meetings':
                ...
                return redirect(route('task.show', $id))->with(['success' => "Details Deleted Successfully", 'type' => 'notes']);
            ...
            case 'delete-tasks':
                ...
                return redirect(route('task.show', $id))->with(['success' => "Details Deleted Successfully", 'type' => 'tasks']);
                break;
    ...
    public function discountModal(Request $request)
    {
        ...
        if ($type == 'assign') {
            ...
            $data = Task::find($id);
            return view('project.task.assign_user', compact('id', 'user', 'data'));
        } else if ($type == 'view') {
            $user = TaskAssignment::where('task_id', $id)->get();
            $data = Task::find($id);
            return view('project.task.view_user', compact('id', 'user', 'data'));
        }
    }
    ...
    public function assign_user(Request $request)
    {
        ...
        if (!empty($trans_id)) {
            ...
            return redirect(route('task.index'))->with(['success' => "Assignment Successfully"]);
        } else {

            return redirect(route('task.index'))->with(['error' => 'You have not chosen an entry']);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('task.index'))->with(['success' => 'Task Deleted Sussessfully']);
    }
    ...
    public function file_preview(Request $request)
    {
        ...
        return view('project.task.file_preview', compact('filename'));
    }
}
