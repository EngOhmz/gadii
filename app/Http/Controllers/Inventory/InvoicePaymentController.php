...
$balance=$payment->amount;
   ...
   // save into tbl_transaction
                ...
                return redirect(route('inventory_invoice.index'))->with(['success'=>'Payment Added successfully']);
            }else{
                return redirect(route('inventory_invoice.index'))->with(['error'=>'Amount should not be equal or less to zero']);
            }
       

        }else{
            return redirect(route('inventory_invoice.index'))->with(['error'=>'Amount should  be less than Invoice amount ']);
