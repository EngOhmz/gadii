...
class GoodIssueController extends Controller
{
    ...
    public function index()
    {
        ...
        $inventory=InventoryList::where('status','0')->orwhere('status','2')->get();
        $issue= GoodIssue::all();
...
GoodIssue::where('id',$id)->update(['status' => '1']);;
 ...
 switch ($request->id) {
        case 'Service':
              $type_id= Service::where('status','1')->orderBy('id', 'DESC')->groupBy('truck')->get(); 
            //$type_id= Service::all();                                                                                     
       ...
       case 'Maintenance':
           $type_id= Maintainance::where('status','1')->orderBy('id', 'DESC')->groupBy('truck')->get(); 
