...
class InvoiceController extends Controller
{
    ...
    //   if($usr){
       ...
       $added_by =  $usr->added_by;
        ...
        $invoices=Order::where('added_by', $id)->orderBy('created_at', 'desc')->get();
    ...
    public function indexOff(int $id, int $lastId)
    {
        ...
        $invoices=Order::where('added_by', $id)->where('id', '>' ,$lastId)->orderBy('created_at', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request,[
          ...
          $count=Order::where('added_by', $request->id)->count();
          $pro=$count+1;
