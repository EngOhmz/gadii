...
class LoginController extends Controller
{
    ...
    */
     ...
     public function login(Request $request)
    {
        ...
        $user = User::where('phone', $request->email)->where('disabled','0')->orWhere('email', $request->email)->where('disabled','0')->get()->first();
        ...
        if(!empty($user)){
            ...
            if(!empty($client)){
                    ...
                    return redirect()->back()->withInput($request->all())->with(['error' => 'invalid Password']);
                }
                        ...
                        return redirect()->back()->withInput($request->all())->withErrors(['error' => 'invalid Email or Phone Number']);
        }
