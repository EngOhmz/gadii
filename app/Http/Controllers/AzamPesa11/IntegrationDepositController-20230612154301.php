   ...
   public function get_call_back_data(Request $request){
                  ...
                  if(!empty($checkusrRoleCopy2)){
                      ...
                      $prc = Role::find($dbDeposit->role_id);
                        ...
                        $xy = $data->amount * 365;
                            ...
                            $due_dateBF = $xy / $checkusrRoleCopy2->year;
                            
                                if(is_float($due_dateBF)){
                                        $intpart=floor($due_dateBF);
                                         $due_dateCC= $intpart;
                                       }
                                      else{
                                         $due_dateCC=$due_dateBF;
                                }
                                ...
                                {
                                    $due_dateNew = $due_dateOld->addDays($due_dateCC);
                                }
                                else{
                                    
                                    $due_dateNew = $nowDT->addDays($due_dateCC);
                      ...
                      $prc = Role::find($dbDeposit->role_id);
                        ...
                        $xy = $data->amount * 365;
                            ...
                            $due_dateBF = $xy / $prc->year;
                                ...
                                $due_date = $nowDT->addDays($due_dateCC);
                  ...
                  if(!empty($checkusrRoleCopy2)){
                    ...
                    $prc = Role::find($dbDeposit->role_id);
                        ...
                        $due_dateBF = $xy / $checkusrRoleCopy2->year;
                            ...
                            // $due_dateOld = $checkusrRoleCopy2->due_date;
        ...
        //invoice payment
            ...
            //   -----------------------------------------------
              ...
              $number = $data->msisdn;
              $number22 = $usr->phone;
               $message = "Dear $usr->name , Payment confirmed! You have paid for  $aa->slug package for $due_dateCC days, ending on $dd. Enjoy managing your business like a pro!.Assistance: +255655973248.\n Powered by UjuziNet.";
              
              $message22 = "Dear $usr->name , Payment confirmed! You have paid for  $aa->slug package for $due_dateCC days, ending on $dd. Enjoy managing your business like a pro!.Assistance: +255655973248.\n Powered by UjuziNet.";
