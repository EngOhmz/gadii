...
class InvoiceSerialController extends Controller
{
    ...
    public function index()
    {
       ...
       $type="";
         $edit="";
       return view('pharmacy.pos.sales.invoice',compact('name','client','currency','invoices','type','edit'));
    }
    ...
    public function edit($id)
    {
      ...
      $type="";
       ...
       return view('pharmacy.pos.sales.invoice',compact('s_name','name','client','currency','data','s_items','type','edit','serial'));
    }
   ...
   public function discountModal(Request $request)
    ...
    public function receive($id)
    {
      ...
      $s_name =PurchaseSerialList::where('status',0)->where('added_by',auth()->user()->added_by)->get();   
       ...
       $serial=$id;
       $type="";
       return view('pharmacy.pos.sales.invoice',compact('name','s_name','client','currency','data','serial','s_items','type','edit'));
    }
