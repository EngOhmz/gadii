                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td><a href="<?php echo e(route('invoice.details',$invoice->id)); ?>"><?php echo e($invoice->pacel_number); ?>

                                            </a></td>
                                    <td><?php echo e(number_format($invoice->due_amount,2)); ?> <?php echo e($invoice->currency_code); ?> </td>
                                    <td> 
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                <?php if(isset($id)): ?>
                                <?php echo e(Form::model($id, array('route' => array('pacel_payment.update', $id), 'method' => 'PUT'))); ?>

                                <?php else: ?>
                                <?php echo e(Form::open(['route' => 'pacel_payment.store'])); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="number" name="amount"
                                            value="<?php echo e($data->amount); ?>" class="form-control">

                                            <input type="hidden" name="pacel_id"
                                            value="<?php echo e($data->pacel_id); ?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row"><label class="col-lg-2 col-form-label">Notes</label>
                                    ...
                                    <div class="col-lg-10">
                                        <textarea name="notes" 
                                            class="form-control"><?php echo e($data->notes); ?></textarea>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/pacel/pacel_edit_payment.blade.php ENDPATH**/ ?>