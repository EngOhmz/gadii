                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                ?>
                                                <?php if(!empty($a)): ?>
                                                <td> <a href="#view<?php echo e($row->id); ?>" data-toggle="modal"><?php echo e($row->fuel_used); ?> Litres</a></td>
                                                <?php else: ?>
                                                <td><?php echo e($row->fuel_used); ?> Litres</td>
                                                <?php endif; ?>
                                               

                                                <td>
                                                    <?php if($row->due_fuel != 0 && $row->status_approve != 1 ): ?>
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        title="Edit" onclick="return confirm('Are you sure?')"
                                                        href="<?php echo e(route('fuel.edit', $row->id)); ?>"><i
                                                            class="fa fa-edit"></i></a>
                                                            <?php endif; ?>

                                                    <?php echo Form::open(['route' => ['fuel.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <?php if($row->due_fuel != 0 ): ?>
                                                            <li class="nav-item"><a class="nav-link"
                                                                    title="Refill Fuel"
                                                                    data-toggle="modal"  href="#" data-target="#appFormModal"
                                            data-id="<?php echo e($row->id); ?>" data-type="refill"
                                            onclick="model(<?php echo e($row->id); ?>,'refill')">Refill Fuel
                                                                  </a></li>
                                                                  <?php endif; ?>
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Adjustment Fuel"
                                                                ...
                                                                onclick="model(<?php echo e($row->id); ?>,'adjustment')">Adjustment Fuel
                                                                    </a></li>                          
                                                                    <?php endif; ?>

                                                                    <?php if($row->fuel_adjustment != '' && $row->status_approve != 1 ): ?>
                                                                    <li class="nav-item"><a class="nav-link" id="profile-tab2"
                                                                        href="<?php echo e(route('fuel.approve',$row->id)); ?>"
                                                                        role="tab"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="number" step="0.001" name="fuel_used"
                                                            placeholder=""
                                                            value="<?php echo e(isset($data) ? $data->fuel_used : ''); ?>"
                                                            class="form-control">
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/fuel/fuel.blade.php ENDPATH**/ ?>