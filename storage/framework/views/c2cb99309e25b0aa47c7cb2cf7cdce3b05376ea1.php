        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-12">
                ...
                <table class="table table-sm table-bordered w-100" id="datatable">
                    ...
                    <?php $m = $module->slug  ?>
                   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($m)): ?>
                        <tr>
                            <td><?php echo e($i++); ?></td>
                            ...
                            <td>
                               <div class="row">
                                   ...
                                   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($p)): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/manage/role/assign.blade.php ENDPATH**/ ?>