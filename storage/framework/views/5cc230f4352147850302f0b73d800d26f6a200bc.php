                                ...
                                <div class="table-responsive">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                         ...
                                         <tbody>
                                           ...
                                           <td><?php echo e($row->driver->reg_no); ?></td>                                    
                                            ...
                                            <div class="badge badge-success badge-shadow">Approved</span>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
<a class="btn btn-icon btn-info" title="Edit" onclick="return confirm('Are you sure?')"   href="<?php echo e(route("assign_driver.edit", $row->id)); ?>"><i class="fa fa-edit"></i></a>
                                                        </div>
                                                     
                                                        <div class="col-lg-4">
                                                            <?php echo Form::open(['route' => ['assign_driver.destroy',$row->id], 'method' => 'delete']); ?>
...
<br>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <a  class="nav-link" title="Confirm Payment" onclick="return confirm('Are you sure? you want to confirm')"  href="<?php echo e(route('assign_driver.approve', $row->id)); ?>">Confirm Assignment</a></li>
                                                                          </ul></div>
...
<br>
 ...
 <?php if($row->reversed == 0): ?>
                   <li class="nav-item"><a  class="nav-link" title="Edit" data-toggle="modal" class="discount"  href="" onclick="model(<?php echo e($row->id); ?>,'driver')" value="<?php echo e($row->id); ?>" data-target="#appFormModal" >Reverse</a></li>
<?php endif; ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('assign_driver.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'assign_driver.store'])); ?>
                                                   ...
                                                   <div class="form-group row">
                                                    ...
                                                    <option value="">Select Truck</option> 
                                                          <?php $__currentLoopData = $driver; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                             
                                                            <option value="<?php echo e($drive->id); ?>" <?php if(isset($data)): ?><?php if($data->driver_id == $drive->id): ?> selected <?php endif; ?> <?php endif; ?> ><?php echo e($drive->reg_no); ?></option>
                                                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                              </select>
                                                    </div>
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/assign_driver.blade.php ENDPATH**/ ?>