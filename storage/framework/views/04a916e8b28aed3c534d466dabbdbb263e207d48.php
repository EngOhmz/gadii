                            ...
                            <div class="tab-pane fade <?php if(empty($id)): ?> active show <?php endif; ?>" id="home2" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                 ...
                                 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                        ...
                                        <tbody>
                                            <?php if(!@empty($pacel)): ?>
                                            <?php $__currentLoopData = $pacel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="gradeA even" role="row">
                                               
                                                <td><a href="<?php echo e(route('pacel_quotation.show', $row->id)); ?>"><?php echo e($row->pacel_number); ?></a></li></td>
                                                <td><?php echo e($row->pacel_name); ?></td>
                                                <td><?php echo e($row->supplier->name); ?></td>
                                              
                                                
                                                <td><?php echo e($row->receiver_name); ?></td>
                                                <td><?php echo e(number_format($row->due_amount,2)); ?> <?php echo e($row->currency_code); ?></td>
                                                


                                                <td>
                                                    <?php if($row->status == 0 && $row->collected == 0): ?>
                                                    <div class="badge badge-danger badge-shadow">Not Approved</div>                                                   
                                              <?php elseif($row->collected == 1): ?>
                                            <div class="badge badge-success badge-shadow">Approved</div>
                                                  <?php elseif($row->status == 7 &&$row->collected == 0): ?>
                                            <div class="badge badge-danger badge-shadow">Cancelled</div>
                                                    <?php endif; ?>
                                                </td>
                                             
                                   <?php if($row->collected == 0 && $row->status == 0): ?>
                                            <td>
 <a  class="btn btn-xs btn-outline-info text-uppercase px-2 rounded" title="Edit" onclick="return confirm('Are you sure?')" href="<?php echo e(route('pacel_quotation.edit', $row->id)); ?>"><i class="fa fa-edit"></i></a>

 <?php echo Form::open(['route' => ['pacel_quotation.destroy',$row->id], 'method' => 'delete']); ?>
...
<?php echo e(Form::close()); ?>
        ...
        <ul class="dropdown-menu animated zoomIn">
          ...
          <li class="nav-item"><a  class="nav-link" title="Collect" onclick="return confirm('Are you sure? you want to transport package')"  href="<?php echo e(route('pacel.approve', $row->id)); ?>">Transport Package</a></li>        
          <li class="nav-item"><a  class="nav-link" title="Cancel" onclick="return confirm('Are you sure?')"   href="<?php echo e(route('pacel.cancel', $row->id)); ?>">Cancel Quotation</a></li>                                       
                          </ul></div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('pacel_quotation.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'pacel_quotation.store'])); ?>
                                                ...
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" name="pacel_name"
                                                            value="<?php echo e(isset($data) ? $data->pacel_name : ''); ?>"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="number" name="docs"
                                                            ...
                                                            value="<?php echo e(isset($data) ? $data->docs : ''); ?>"
                                                            class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="number" name="non_docs"
                                                            placeholder="0 if does not exist"
                                                            value="<?php echo e(isset($data) ? $data->non_docs : ''); ?>"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="number" name="bags"
                                                            placeholder="0 if does not exist"
                                                            value="<?php echo e(isset($data) ? $data->bags : ''); ?>"
                                                            class="form-control">
                                                    </div>
                                                    <label
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <select class="form-control supplier" name="owner_id" required id="supplier">
                                                <option value="">Select</option>
                                                          ...
                                                          <?php echo e($data->owner_id == $row->id  ? 'selected' : ''); ?>
...
<?php $a=1;?>
                                                  ...
                                                  <button class="btn btn-primary" type="button" data-toggle="modal" onclick="model(<?php echo e($a); ?>,'supplier')" value="<?php echo e($a); ?>" data-target="#appFormModal"><i class="fa fa-plus-circle"></i></button>
                                                  </div>
                                                 </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" name="receiver_name"
                                                            value="<?php echo e(isset($data) ? $data->receiver_name : ''); ?>"
                                                            class="form-control" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" name="mobile"
                                                            value="<?php echo e(isset($data) ? $data->mobile : ''); ?>"
                                                ...
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <textarea name="instructions" class="form-control"><?php echo e(isset($data) ? $data->instructions : ''); ?></textarea>
                                     ...
                                     <br>
                                            ...
                                            <hr>
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                 <?php if(!empty($data->currency_code)): ?>
                            ...
                            <option  <?php if(isset($data)): ?> <?php echo e($data->currency_code == $row->code ? 'selected' : 'TZS'); ?> <?php endif; ?>  value="<?php echo e($row->code); ?>"><?php echo e($row->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
...
<?php if(!empty($id)): ?>
 ...
 <tr class="line_items">
<td><select name="item_name[]" class="form-control item_name" required  data-sub_category_id=<?php echo e($i->order_no); ?>><option value="">Select Item</option><?php $__currentLoopData = $route; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>" <?php if(isset($i)): ?><?php if($n->id == $i->item_name): ?> selected <?php endif; ?> <?php endif; ?> >From <?php echo e($n->from); ?> to <?php echo e($n->to); ?> (<?php echo e($n->distance); ?> km)</option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>
 <td><input type="text" name="quantity[]" class="form-control item_quantity<?php echo e($i->order_no); ?>"  placeholder ="quantity" id ="quantity"  value="<?php echo e(isset($i) ? $i->quantity : ''); ?>" required /></td>
<td><input type="text" name="price[]" class="form-control item_price<?php echo e($i->order_no); ?>" placeholder ="price" required  value="<?php echo e(isset($i) ? $i->price : ''); ?>"/></td>
<td><input type="text" name="unit[]" class="form-control item_unit<?php echo e($i->order_no); ?>" placeholder ="unit" required value="<?php echo e(isset($i) ? $i->unit : ''); ?>"/>
<td><select name="charge[]" class="form-control item_charge'+count<?php echo e($i->order_no); ?>" required >
<option value="0">Select Charge Type</option>
<option value="1" <?php if(isset($i)): ?><?php if('Flat' == $i->charge_type): ?> selected <?php endif; ?> <?php endif; ?>>Flat</option>
<option value="<?php echo e($i->distance); ?>"  name="one" <?php if(isset($i)): ?><?php if('Distance' == $i->charge_type): ?> selected <?php endif; ?> <?php endif; ?>>Distance per ton</option></select>
</td>
<td><select name="tax_rate[]" class="form-control item_tax'+count<?php echo e($i->order_no); ?>" required >
<option value="0">Select Tax Rate</option>
<option value="0" <?php if(isset($i)): ?><?php if($i->tax_rate): ?> selected <?php endif; ?> <?php endif; ?>>No tax</option>
<option value="0.18" <?php if(isset($i)): ?><?php if('0.18' == $i->tax_rate): ?> selected <?php endif; ?> <?php endif; ?>>18%</option></select>
</td>
<input type="hidden" name="total_tax[]" class="form-control item_total_tax<?php echo e($i->order_no); ?>'" placeholder ="total" required value="<?php echo e(isset($i) ? $i->total_tax : ''); ?>" readonly jAutoCalc="{quantity} * {price} * {charge} * {tax_rate}"   />
<input type="hidden" name="items_id[]" class="form-control item_saved<?php echo e($i->order_no); ?>"   value="<?php echo e(isset($i) ? $i->items_id : ''); ?>" required   />
<input type="hidden"  name="distance[]" class="form-control item_distance<?php echo e($i->order_no); ?>"  required   value="<?php echo e(isset($i) ? $i->distance : ''); ?>" />
<td><input type="text" name="total_cost[]" class="form-control item_total<?php echo e($i->order_no); ?>" placeholder ="total" required value="<?php echo e(isset($i) ? $i->total_cost : ''); ?>" readonly jAutoCalc="{quantity} * {price} * {charge} " /></td>
 <input type="hidden" name="pacel_item_id[]"  class="form-control name_list"  value= "<?php echo e(isset($i) ? $i->id : ''); ?>" />  
<td><button type="button" name="remove" class="btn btn-danger btn-xs rem" value= "<?php echo e(isset($i) ? $i->id : ''); ?>"><i class="fas fa-trash"></i></button></td>
</tr>
...
<tr class="line_items">
<td colspan="5"></td>
<td><span class="bold">Discount</span>: </td><td><input type="text" name="discount[]" class="form-control item_discount" placeholder ="total" required  value="<?php echo e(isset($data) ? $data->discount : ''); ?>" readonly></td>   
</tr>
<?php endif; ?>
                                                    ...
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        <?php if(!@empty($id)): ?>
                                                              ...
                                                              <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                                ...
                                                                href="<?php echo e(route('pacel_quotation.index')); ?>">
                                                                 cancel
                                                            </a>
...
<script>
 ...
 $(document).on('change', '.item_name', function(){
        ...
        $.ajax({
            url: '<?php echo e(url("findPacelPrice")); ?>',
                    type: "GET",
          data:{id:id},
             dataType: "json",
...
<script>
    ...
    $('.add').on("click", function(e) {
        ...
        html += '<td><select name="item_name[]" class="form-control item_name" required  data-sub_category_id="'+count+'"><option value="">Select Route</option><?php $__currentLoopData = $route; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>">From <?php echo e($n->from); ?> to <?php echo e($n->to); ?>  (<?php echo e($n->distance); ?> km)</option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
...
console.log(price);
   ...
   var TIN= $('#TIN').val();
          ...
          $.ajax({
            type: 'GET',
            url: '<?php echo e(url("addSupplier")); ?>',
             data: {
                 'name':name,
                 'phone':phone,
                 'email':email,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/pacel/quotation.blade.php ENDPATH**/ ?>