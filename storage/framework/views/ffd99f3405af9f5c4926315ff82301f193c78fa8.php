                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-sales')): ?>
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add-sales')): ?>
                            <li class="nav-item">
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <li><a
                                                            href="<?php echo e(route('sales.show', $row->id)); ?>"><b><?php echo e($loop->iteration); ?>.</b><?php echo e($row->reference_no); ?></a>
                                                    </li>
                                                </td>
                                                <td><?php echo e($row->farmer->firstname); ?></td>
                                                <td><?php echo e($row->invoice_date); ?></td>

                                                <td><?php echo e($row->due_date); ?></td>
                                                <td><?php echo e($row->invoice_amount); ?>Tsh</td>
                                                <td><?php echo e($row->invoice_amount-$row->due_amount); ?>Tsh</td>
                                                <td><?php echo e($row->due_amount); ?>TSh</td>
                                                ...
                                                <td> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-sales')): ?>
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        title="Edit" onclick="return confirm('Are you sure?')"
                                                        href="<?php echo e(route('sales.edit', $row->id)); ?>"><i
                                                            class="fa fa-edit"></i></a>
                                                            <?php endif; ?>
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-sales')): ?>
                                                    <?php echo Form::open(['route' => ['sales.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <li class="nav-item"><a class="nav-link" title="Edit"
                                                                    ...
                                                                    onclick="model(<?php echo e($row->id); ?>,'discount')"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="<?php echo e(route('sales.show', $row->id)); ?>">Cancel
                                                                    Quotation</a></li>
                                                        </ul>
                                                    </div>
                                                    <?php endif; ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('sales.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'sales.store'])); ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="reference_no"
                                                            ...
                                                            value="<?php echo e(isset($data) ? $data->rererence_no : ''); ?>"
                                                            class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="input-group">
                                                            <select class="form-control" name="client_id" required
                                                                id="client">
                                                                <?php if(!empty($farmer)): ?>
                                                                <?php $__currentLoopData = $farmer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                
                                                                <option <?php if(isset($data)): ?>
                                                                    <?php echo e($data->client_id == $row->id  ? 'selected' : ''); ?>

                                                                    <?php endif; ?> value="<?php echo e($row->id); ?>"><?php echo e($row->firstname); ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="date" name="invoice_date"
                                                            placeholder="0 if does not exist"
                                                            value="<?php echo e(isset($data) ? $data->invoice_date : ''); ?>"
                                                            class="form-control">
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="<?php echo e(route('pacel.index')); ?>">
                                                            cancel
                                                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/sales/manage_sales.blade.php ENDPATH**/ ?>