                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $courier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="gradeA even" role="row">
                                               
                                                <td><a href="<?php echo e(route('courier_quotation.show', $row->id)); ?>"><?php echo e($row->pacel_number); ?></a></li></td>
                                            ...
                                            <div class="badge badge-danger badge-shadow">Cancelled</span>
                                                ...
                                                <?php if($row->status != 7): ?>
                                        <td>
 <a  class="btn btn-xs btn-outline-info text-uppercase px-2 rounded" title="Edit" onclick="return confirm('Are you sure?')" href="<?php echo e(route('courier_quotation.edit', $row->id)); ?>"><i class="fa fa-edit"></i></a>

 <?php echo Form::open(['route' => ['courier_quotation.destroy',$row->id], 'method' => 'delete']); ?>
...
<?php echo e(Form::close()); ?>
        ...
        <ul class="dropdown-menu animated zoomIn">
         <li class="nav-item"><a  class="nav-link" title="Edit" data-toggle="modal" class="discount"  href="" onclick="model(<?php echo e($row->id); ?>,'discount')" value="<?php echo e($row->id); ?>" data-target="#appFormModal" >Discount Quotation</a></li>
          <li class="nav-item"><a  class="nav-link" title="Convert to Invoice" onclick="return confirm('Are you sure? you want to convert Quotation To Invoice')"  href="<?php echo e(route('courier.approve', $row->id)); ?>">Convert to Invoice</a></li>
          <li class="nav-item"><a  class="nav-link" title="Cancel" onclick="return confirm('Are you sure?')"   href="<?php echo e(route('courier.cancel', $row->id)); ?>">Cancel Quotation</a></li>                                       
                          </ul></div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('courier_quotation.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'courier_quotation.store'])); ?>
                                       ...
                                       <div class="form-group row">
                                         ...
                                         <select class="form-control supplier" name="owner_id" required id="supplier">
                                                <option value="">Select</option>
                                                  ...
                                                  <button class="btn btn-primary" type="button" data-toggle="modal" onclick="model(<?php echo e($row->id); ?>,'supplier')" value="<?php echo e($row->id); ?>" data-target="#appFormModal"><i class="fa fa-plus-circle"></i></button>
                                                  </div>
                                                 </div>
                                                    </div>
                                                </div>
                           ...
                           <select class="form-control route" name="route_id" id="route" required>
                            <option value="">Select</option>
                                                            ...
                                                            <option value="<?php echo e($row->id); ?>" <?php if(isset($data)): ?><?php if($data->
                                                                route_id == $row->id): ?> selected <?php endif; ?> <?php endif; ?> >From
                                                                <?php echo e($row->from); ?> to <?php echo e($row->to); ?>
                                                  ...
                                                  <div class="input-group-append">
                                                  <button class="btn btn-primary" type="button" data-toggle="modal" onclick="model(<?php echo e($row->id); ?>,'route')" value="<?php echo e($row->id); ?>" data-target="#appFormModal"><i class="fa fa-plus-circle"></i></button>
                                                  </div>
                                                 </div>
                                                    </div>
                                                </div>
...
<?php if(!empty($id)): ?>
 ...
 <tr class="line_items">
<td><select name="item_name[]" class="form-control item_name" required  data-sub_category_id=<?php echo e($i->order_no); ?>><option value="">Select Item</option><?php $__currentLoopData = $name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>" <?php if(isset($i)): ?><?php if($n->id == $i->item_name): ?> selected <?php endif; ?> <?php endif; ?> ><?php echo e($n->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>
...
<td><select name="tax_rate[]" class="form-control item_tax'+count<?php echo e($i->order_no); ?>" required ><option value="0">Select Tax Rate</option>
<option value="0" <?php if(isset($i)): ?><?php if('0' == $i->tax_rate): ?> selected <?php endif; ?> <?php endif; ?>>No tax</option>
<option value="0.18" <?php if(isset($i)): ?><?php if('0.18' == $i->tax_rate): ?> selected <?php endif; ?> <?php endif; ?>>18%</option></select></td>
<input type="hidden" name="total_tax[]" class="form-control item_total_tax<?php echo e($i->order_no); ?>'" placeholder ="total" required value="<?php echo e(isset($i) ? $i->total_tax : ''); ?>" readonly jAutoCalc="{quantity} * {price} * {tax_rate}"   />
...
<td><input type="text" name="total_cost[]" class="form-control item_total<?php echo e($i->order_no); ?>" placeholder ="total" required value="<?php echo e(isset($i) ? $i->total_cost : ''); ?>" readonly jAutoCalc="{quantity} * {price}" /></td>
                                                    ...
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        <?php if(!@empty($id)): ?>
                                                              ...
                                                              <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                                ...
                                                                href="<?php echo e(route('courier_quotation.index')); ?>">
                                                                 cancel
                                                            </a>
...
<script>
 ...
 $(document).on('change', '.item_name', function(){
        ...
        $.ajax({
            url: '<?php echo e(url("findCourierPrice")); ?>',
                    type: "GET",
          data:{id:id},
             dataType: "json",
 ...
 console.log(data);
    ...
    $('.add').on("click", function(e) {
        ...
        html += '<td><select name="item_name[]" class="form-control item_name" required  data-sub_category_id="'+count+'"><option value="">Select Item</option><?php $__currentLoopData = $name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"><?php echo e($n->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
...
<script type="text/javascript">
    function model(id,type) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?php echo e(url("courierModal")); ?>',
            data: {
                'id': id,
                'type':type,
            },
...
console.log(price);
   ...
   var TIN= $('#TIN').val();
          ...
          $.ajax({
            type: 'GET',
            url: '<?php echo e(url("addCourierSupplier")); ?>',
             data: {
                 'name':name,
                 'phone':phone,
                 'email':email,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/courier/quotation.blade.php ENDPATH**/ ?>