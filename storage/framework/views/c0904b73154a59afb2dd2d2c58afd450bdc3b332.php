...
?>
        ...
        <ul class="sidebar-menu active show">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-orders1')): ?>
            <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="<?php echo e(url('wb')); ?>">Create WB</a></li>
                    <?php endif; ?>                   
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-supplier')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('supplier')); ?>"><i data-feather="command"></i>Suppliers</a></li>
                    <?php endif; ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="<?php echo e(url('tyre_return')); ?>">Tire Return</a></li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-tyre_reallocation')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('tyre_reallocation')); ?>">Tire Reallocation</a></li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-tyre_disposal')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('tyre_disposal')); ?>">Tire Disposal</a></li>
                    <?php endif; ?>
                </ul>
            </li>
            <?php endif; ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-inventory_list')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('service_type')); ?>">Service Type</a></li>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-service')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('good_issue')); ?>">Good Issue</a></li>
                    <?php endif; ?>
      ...
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-cotton')): ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <?php endif; ?>
           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-connect')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('connect_driver')); ?>">Assign & Remove Driver</a></li>
                    <?php endif; ?>
                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-connect')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('truck_report')); ?>">Truck Report</a></li>
                    <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-connect')): ?>
...
</div><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/layouts/aside.blade.php ENDPATH**/ ?>