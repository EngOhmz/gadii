                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                            ...
                            <div class="tab-pane fade <?php if(!empty($id)): ?> active show <?php endif; ?>" id="profile2" role="tabpanel"
                                ...
                                <div class="col-lg-4">
                                  ...
                                  ?>
                                <input type="text" class="form-control tyre"  id="tyre" required  value="<?php echo e(isset($ty) ? $ty->serial_no : ''); ?>" readonly />
                                   <?php else: ?>                              
                                   <input type="text" class="form-control tyre"  id="tyre" required  value="" readonly /> 
                                   <?php endif; ?> 
                            <input type="hidden" name="tyre_id" id="tyre_id" class="form-control tyre_id" value="<?php echo e(isset($data) ? $data->tyre_id : ''); ?>" required />
                            <input type="hidden" name="location"  id="location" class="form-control location" value="<?php echo e(isset($data) ? $data->location : ''); ?>" required />                        
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/tyre/good_return.blade.php ENDPATH**/ ?>