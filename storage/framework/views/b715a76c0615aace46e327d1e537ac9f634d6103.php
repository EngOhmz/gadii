    ...
    <div class="section-body">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
             ...
             <a class="btn btn-xs btn-success" href="<?php echo e(route('invoice_pdfview',['download'=>'pdf','id'=>$purchases->id])); ?>"  title="" > Download PDF </a>         
                  ...
                  <th style="color:white;">Charge Type</th>
                        ...
                        <th style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <td class=""><strong class="block">From <?php echo e($item_name->from); ?>  to  <?php echo e($item_name->to); ?> (<?php echo e($row->distance); ?> km)</strong>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/pacel/invoice_details.blade.php ENDPATH**/ ?>