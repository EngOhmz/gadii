                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td><?php echo e($row->item->serial_no); ?></td>
                                                <td>
                                                    <?php    
                                                ...
                                                <td>
                                                 ...
                                                 <?php if($row->status == 0): ?>
                                                    ...
                                                    href="<?php echo e(route("return.approve", $row->id)); ?>" title="Approve" onclick="return confirm('Are you sure?')">
                                                    <i class="fa fa-check"></i>
                                                </a>

                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        href="<?php echo e(route("good_return.edit", $row->id)); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                   
                                                    <?php echo Form::open(['route' => ['good_return.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('good_return.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'good_return.store'])); ?>
                                  ...
                                  <option value="<?php echo e($l->id); ?>" <?php if(isset($data)): ?><?php if($data->item_id == $l->id): ?> selected <?php endif; ?> <?php endif; ?> ><?php echo e($l->serial_no); ?> </option>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                   <?php else: ?>                              
                                 <select id="item" name="item_id" class="form-control item">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.add').on("click", function(e) {
            ...
            count +
            '"><option value="">Select Item</option><?php $__currentLoopData = $inventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"><?php echo e($n->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
        html +=
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/inventory/good_return.blade.php ENDPATH**/ ?>