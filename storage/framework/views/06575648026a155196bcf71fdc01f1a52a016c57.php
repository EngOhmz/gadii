...
<section class="section">
  ...
  selectDistrictElement = document.getElementById("selectDistrictid");
    ...
    function getWarehouseDetails(){
      let url = '<?php echo e(route("manipulation.index")); ?>';
      ...
      $(document).on('click','#submit_order_id',function(e){
          ...
          $.ajax({
            type:"POST",
            url:'<?php echo e(route("manipulation.store")); ?>',
            data:ordersData,
            dataType:"json",
            success:function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/orders/client_order.blade.php ENDPATH**/ ?>