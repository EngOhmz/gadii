        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                 ...
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"   href="<?php echo e(route('purchase_cotton.edit', $purchases->id)); ?>"  title="" > Edit </a>          
            
                           
              <a class="btn btn-xs btn-info" data-placement="top"  href="<?php echo e(route('cotton.receive',$purchases->id)); ?>"  title="Good Receive"> Good Receive </a>   
           <?php endif; ?>  
             
             <a class="btn btn-xs btn-success"  href="<?php echo e(route('cotton_pdfview',['download'=>'pdf','id'=>$purchases->id])); ?>"  title="" > Download PDF </a>         
                        ...
                        <th class="col-sm-1" style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class=""><?php echo e($purchases->quantity); ?> </td>
                                        <td class=""><?php echo e(number_format($purchases->price ,2)); ?>  </td>                                         
                                         <td class="">
...
<?php endif; ?>
                                            ...
                                            <td class=""><?php echo e(number_format($purchases->due_amount ,2)); ?> </td>
 ...
 <div class="clearfix">
  ...
  <?php if(!@empty($purchases->due_amount < $purchases->purchase_amount )): ?>
        <div class="clearfix">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/purchase_cotton_details.blade.php ENDPATH**/ ?>