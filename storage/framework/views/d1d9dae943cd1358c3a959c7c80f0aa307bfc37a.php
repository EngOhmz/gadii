                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                <?php if(isset($id)): ?>
                                <?php echo e(Form::model($id, array('route' => array('mileage_payment.update', $id), 'method' => 'PUT'))); ?>

                                <?php else: ?>
                                <?php echo e(Form::open(['route' => 'mileage_payment.store'])); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="number" name="amount"
                                            value="<?php echo e($invoice->due_mileage); ?>" class="form-control">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/mileage/mileage_payment.blade.php ENDPATH**/ ?>