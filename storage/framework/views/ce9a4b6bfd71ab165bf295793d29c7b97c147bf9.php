                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('purchase_inventory.show',$invoice->id)); ?>"><?php echo e($invoice->reference_no); ?>

                                            </a></td>
                                    <td><?php echo e($invoice->due_amount); ?>Tsh </td>
                                    <td> 
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                <?php if(isset($id)): ?>
                                <?php echo e(Form::model($id, array('route' => array('inventory_payment.update', $id), 'method' => 'PUT'))); ?>

                                <?php else: ?>
                                <?php echo e(Form::open(['route' => 'inventory_payment.store'])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/inventory/inventory_payment.blade.php ENDPATH**/ ?>