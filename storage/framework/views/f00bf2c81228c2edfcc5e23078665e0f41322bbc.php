                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(url('quotationDetails', $quotation->id)); ?>"><?php echo e($quotation->id); ?>

                                            </a></td>
                                    <td><?php echo e($quotation->due_amount); ?>Tsh </td>
                                    <td> 
                                        <?php if($quotation->status == 0): ?>
                                        <div class="badge badge-warning badge-shadow">Not Paid</div>
                                        <?php elseif($quotation->status == 1): ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                <?php if(isset($id)): ?>
                                <?php echo e(Form::model($id, array('route' => array('order_payment.update', $id), 'method' => 'PUT'))); ?>

                                <?php else: ?>
                                <?php echo e(Form::open(['route' => 'order_payment.store'])); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="number" name="amount"
                                            value="<?php echo e($quotation->due_amount); ?>" class="form-control">

                                            <input type="hidden" name="transport_id"
                                            value="<?php echo e($quotation->id); ?>" class="form-control">
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/orders/order_payment.blade.php ENDPATH**/ ?>