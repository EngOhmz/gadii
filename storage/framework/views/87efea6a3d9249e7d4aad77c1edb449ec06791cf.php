...
<?php $__currentLoopData = $group->accountCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account_code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
  ...
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           ...
                           <td colspan="" ><b><?php echo e(number_format(abs($total_incomes),2)); ?></b></td>
...
<?php $__currentLoopData = $group->accountCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account_code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <?php endif; ?>
  ...
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <td colspan="" ><b><?php echo e(number_format(abs($total_cost),2)); ?></b></td>
...
<!--
                  <td></td> <td></td><td></td>   
                <td colspan="7"><b><?php echo e(number_format($gross,2)); ?></b></td>
                    </tr> 
...
<?php $__currentLoopData = $group->accountCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account_code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <?php endif; ?>
  ...
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           ...
                           <td colspan="" style=""><b><?php echo e(number_format($total_expense,2)); ?></b></td>
                    </tr> 
                    </tbody>
                    <tfoot>
                    <tr>
...
?>
<td></td>
                         <td colspan="4"><b><?php echo e(number_format($profit,2)); ?></b></td>
                    </tr>
                     <tr>
                        <td>
...
?>
                        <td colspan="4" ><b><?php echo e(number_format($tax,2)); ?></b></td>
                    </tr>
                     <tr>
                        <td>
                            <b>Net Profit</b></td><td></td><td></td><td></td>
                        <td colspan="4" ><b><?php echo e(number_format($profit-$tax,2)); ?></b></td>
                    </tr>
                    </tfoot>
                </table>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/financial_report/income_statement_summary.blade.php ENDPATH**/ ?>