                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                             ...
                                             <a class="btn btn-xs btn-outline-primary text-uppercase px-2 rounded"
                                                    href="<?php echo e(route("movement.approve", $row->id)); ?>" title="Approve" onclick="return confirm('Are you sure?')">
                                                    <i class="fa fa-check"></i>
                                                </a>
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        href="<?php echo e(route("good_movement.edit", $row->id)); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                   
                                                    <?php echo Form::open(['route' => ['good_movement.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('good_movement.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'good_movement.store'])); ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <option <?php if(isset($data)): ?>
                                                            <?php echo e($data->source_location == $row->id  ? 'selected' : ''); ?>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <option <?php if(isset($data)): ?>
                                                        <?php echo e($data->destination_location == $row->id  ? 'selected' : ''); ?>
                                                    ...
                                                    <div class="col-lg-4">
                                                         ...
                                                         <select name="item_id"
                                                            ...
                                                            <option value="">Select Item</option><?php $__currentLoopData = $inventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"
                                                                <?php if(isset($data)): ?><?php if($n->id == $data->item_id): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/inventory/good_movement.blade.php ENDPATH**/ ?>