                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="<?php echo e(route('purchase_tyre.show',$row->id)); ?>" role="tab"
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        ...
                                                        href="<?php echo e(route('purchase_tyre.edit', $row->id)); ?>"><i
                                                            class="fa fa-edit"></i></a>
                                                            <?php endif; ?>

                                                    <?php echo Form::open(['route' => ['purchase_tyre.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('purchase_tyre.approve',$row->id)); ?>"
                                                                    role="tab"
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('purchase_tyre.receive',$row->id)); ?>"
                                                                    role="tab"
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('purchase_tyre.pay',$row->id)); ?>"
                                                                    role="tab"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="<?php echo e(route('purchase_tyre.cancel', $row->id)); ?>">Cancel
                                                                   Purchase</a></li>
   <?php endif; ?>
                                                        </ul>
                                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('purchase_tyre.update', $id), 'method' => 'PUT'))); ?>

                                              
                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'purchase_tyre.store'])); ?>
                                                        ...
                                                        <tr class="line_items">
                                                            <td><select name="item_name[]"
                                                                    ...
                                                                    <option value="">Select Item</option><?php $__currentLoopData = $name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"
                                                                        ...
                                                                        selected <?php endif; ?> <?php endif; ?> ><?php echo e($n->brand); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select></td>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="<?php echo e(route('purchase_tyre.index')); ?>">
                                                            cancel
                                                        </a>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '<?php echo e(url("findTyrePrice")); ?>',
            type: "GET",
            data: {
                id: id
            },
...
$(document).ready(function() {
    ...
    $('.add').on("click", function(e) {
        ...
        html +=
            ...
            count +
            '"><option value="">Select Item</option><?php $__currentLoopData = $name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"><?php echo e($n->brand); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
        html +=
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/tyre/manage_purchase_tyre.blade.php ENDPATH**/ ?>