...
<section class="section">
    <div class="section-body">
        ...
        <div class="panel-body hidden-print">
                                      <?php if(!empty($edit)): ?>
                                               <form name="form"  action="<?php echo e(url('payroll/manage_salary')); ?>" method="post" class="form-horizontal">
                                                    <?php else: ?>
 ...
 <div class="col-sm-12 ">
   ...
   <div class="col-md-4">
                      <br><button type="submit" class="btn btn-success" value="1" name="flag">Go</button>
                           <?php if(!empty($edit)): ?>
                                                  <a href="<?php echo e(url('payroll/manage_salary')); ?>"class="btn btn-danger">Reset</a>
                                                    <?php else: ?>
        ...
        <div class="panel panel-white">
            <div class="panel-body ">
                      <form id="form_validation" role="form" enctype="multipart/form-data"
                            action="<?php echo e(url('payroll/save_salary_details')); ?>" method="post"
                            ...
                            <?php echo csrf_field(); ?>
                             ...
                             <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $employee_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                               <?php
                                $a++;
                            ...
                            <tr>
                                         ...
                                         <td><?php echo $v_employee->designation->name ?></td>        
                                          ...
                                          <div class = "input-group"> 
                                               <input name="monthly_status[]"    id="<?php echo $v_employee->id ?>"  type="checkbox"  value="<?php echo $v_employee->id ?>"   class="child_absent"
                                                    ...
                                                    <?php $__currentLoopData = $salary_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_gsalary_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                            <?php if($v_employee->id == $v_gsalary_info->user_id): ?> 
                                                              <?php echo e($v_gsalary_info->salary_template_id ? 'checked ' : ''); ?>
                                                ...
                                                <div class = "input-group"> 
                                                 <select name="salary_template_id[]" class="form-control template" id="template_id_<?php echo e($a); ?>"  data-sub_category_id="<?php echo e($a); ?>">
                                        ...
                                        <div class="input-group-append">
                                                  <button class="btn btn-primary" type="button" data-toggle="modal" onclick="model(<?php echo e($a); ?>,'addtemplate')" value="<?php echo e($a); ?>" data-target="#appFormModal"><i class="fa fa-plus-circle"></i></button>
                                                  </div>
                                          </div>&nbsp
  ...
  function saveTemplate(e){
   var form = $('#addClientForm').serialize();
       var sub_category_id =  $('#category').val();;
          $.ajax({
            type: 'GET',
            url: '<?php echo e(url("payroll/addTemplate")); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/payroll/manage_salary_details.blade.php ENDPATH**/ ?>