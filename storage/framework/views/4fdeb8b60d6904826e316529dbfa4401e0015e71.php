...
<a class="btn btn-icon btn-info" title="Edit" onclick="return confirm('Are you sure?')"   href="<?php echo e(route("class_account.edit", $row->id)); ?>"><i class="fa fa-edit"></i></a>
                           ...
                           <label class="col-lg-2 col-form-label">Class ID</label>
                                                    <div class="col-lg-8">
                                                        <input type="text" name="class_id" required
                                                            value="<?php echo e(isset($data) ? $data->class_id : ''); ?>"
                                                            class="form-control">
                                                    </div>
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/class_account/data.blade.php ENDPATH**/ ?>