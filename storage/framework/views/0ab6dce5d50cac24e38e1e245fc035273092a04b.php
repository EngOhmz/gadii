...
?>
                          <tr>
                        <td ><?php echo e($c); ?> . </td>
                        <td ><b><?php echo e($account_class->class_name); ?></b></td>
                  <td ></td>
                  <?php   if($c == 1){ ?>
                   <?php  } else{ ?>
                     <td ></td>
...
​<td><a href="#view<?php echo e($account_code->account_id); ?>" data-toggle="modal""><?php echo e($account_code->account_codes); ?></a>
 ...
 <?php
                        ...
                        $dr1 = \App\Models\JournalEntry::where('account_id', $account_code->account_id)->where('date', '<=',
                         ...
                         $unit_total1  +=($dr1-$cr1);
                        ?>                           
                            <td><?php echo e(number_format($dr1-$cr1,2)); ?></td>
                        </tr>
  ...
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr>
                        <td colspan="3" style="text-align: center">
                            <b>Total <?php echo e($account_class->class_name); ?></b></td>
...
<?php
  ...
  ?>
                                        ...
                                        <td><?php echo e(number_format($total_vat,2)); ?>  </td>
                      ...
                      if($account_code->account_name == 'Deffered Tax'){
                       $total_credit_liability  =    $total_credit_liability + $net_profit['tax_for_second_date'];
                        ...
                        ?>                           
                            ...
                            <td><?php echo e(number_format($cr1-$dr1,2)); ?></td>
                         </tr>
                       
                         <?php else: ?>
                             
                            <td><?php echo e(number_format($net_profit['tax_for_second_date'],2)); ?></td>
                        </tr>
                         <?php endif; ?>
...
<td><?php echo e($account_code_modal->account_codes); ?></td>
  <td><?php echo e(number_format(abs($income_balance_start),2)); ?></td>
</tr>                
  <?php  
...
<tr>
                        <td >
                            <b>Total Income</b></td>
                       <td></td>
                            <td><?php echo e(number_format(abs($total_incomes_start),2)); ?></td>                           
                    </tr> 
<!--
...
<tr>
  <td><?php echo e($account_code_modal->account_name); ?></td>
<td><?php echo e($account_code_modal->account_codes); ?></td>
  <td><?php echo e(number_format(abs($cost_balance_start),2)); ?></td>
</tr>                
  <?php  
...
<tr>
                       ...
                       <td></td>
      <td><?php echo e(number_format(abs($total_cost_start),2)); ?></td>
                    </tr> 
-->
...
<!--
  <tr>
                        <td >
                            <b>Gross Profit</b></td>
                    <td></td>
                            <td><b><?php echo e(number_format($gross_start ,2)); ?></b></td>
                    </tr> 
-->
...
foreach($group_modal->accountCodes as $account_code_modal){
  ...
  <td><?php echo e($account_code_modal->account_name); ?></td>
<td><?php echo e($account_code_modal->account_codes); ?></td>
  <td><?php echo e(number_format(abs($expense_balance_start ),2)); ?></td>
       </tr>             
  <?php  
...
<tr>
                       ...
                       <td></td>
                               <td><?php echo e(number_format($total_expense_start ,2)); ?></td>
                    </tr> 
...
<tr>
                        <td>
                           <b>Profit Before Tax</b></td>
                            <td></td>
                                 <td><b><?php echo e(number_format($profit_start ,2)); ?></b></td>
                    </tr>
                     <tr>
                        <td>
                            <b>Tax</b></td>
                         <td></td>
                              <td><b><?php echo e(number_format($tax_start ,2)); ?></b></td>
                    </tr>
                   
<tr>
                      <td colspan=2>
                           <b><?php echo e($account_code->account_name); ?> Total Balance</b></td>
                        <td colspan=2><b><?php echo e(number_format($profit_start-$tax_start,2)); ?></b></td>
                    </tr>
...
<tr>
  <td><?php echo e($account_code_modal->account_name); ?></td>
<td><?php echo e($account_code_modal->account_codes); ?></td>
  <td><?php echo e(number_format(abs($income_balance_deff),2)); ?></td>
</tr>                
  <?php  
...
<tr>
                        <td >
                            <b>Total Income</b></td>
                       <td></td>
                            <td><?php echo e(number_format(abs($total_incomes_deff),2)); ?></td>                           
                    </tr> 
...
<tr>
  <td><?php echo e($account_code_modal->account_name); ?></td>
<td><?php echo e($account_code_modal->account_codes); ?></td>
  <td><?php echo e(number_format(abs($cost_balance_deff),2)); ?></td>
</tr>                
  <?php  
...
<tr>
                        <td >
                             <b>Total Financial Cost</b></td>
                       <td></td>
      <td><?php echo e(number_format(abs($total_cost_deff),2)); ?></td>
                    </tr> 
-->
  <?php  
...
<!--
  <tr>
                        <td >
                            <b>Gross Profit</b></td>
                    <td></td>
                            <td><b><?php echo e(number_format($gross_deff ,2)); ?></b></td>
                    </tr> 
-->
<tr>
                        <td colspan="3" style="text-align: left"><b>Expenses</b></td>
...
foreach($group_modal->accountCodes as $account_code_modal){
  ...
  <td><?php echo e($account_code_modal->account_name); ?></td>
<td><?php echo e($account_code_modal->account_codes); ?></td>
  <td><?php echo e(number_format(abs($expense_balance_deff ),2)); ?></td>
       </tr>             
  <?php  
...
<tr>
                        <td >
                             <b>Total Expenses</b></td>
                       <td></td>
                               <td><?php echo e(number_format($total_expense_deff ,2)); ?></td>
                    </tr> 
...
<tr>
                        <td>
                           <b>Profit Before Tax</b></td>
                            <td></td>
                                 <td><b><?php echo e(number_format($profit_deff ,2)); ?></b></td>
                    </tr>
                     <tr>
                       <td colspan=2>
                           <b><?php echo e($account_code->account_name); ?> Total Balance</b></td>
                               <td colspan=2><b><?php echo e(number_format($tax_deff ,2)); ?></b></td>
                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/financial_report/balance_sheet.blade.php ENDPATH**/ ?>