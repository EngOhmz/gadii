            ...
            <div class="col-12 col-sm-6 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4><?php echo e(__('ordering.orders')); ?> </h4>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if(empty($id)): ?> active show <?php endif; ?>" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true"><?php echo e(__('ordering.order_list')); ?></a>
                            </li>
                            <?php else: ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add-order_list')): ?>
                           <li class="nav-item">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 141.219px;"><?php echo e(__('ordering.client')); ?></th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 141.219px;"><?php echo e(__('ordering.wherehouse')); ?></th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 98.1094px;"><?php echo e(__('ordering.actions')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php if(!@empty($orders)): ?>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td><?php echo e($row->warehouse->warehouse_name); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-order_list')): ?>
                                                            <li class="nav-item"><a class="nav-link" title="quotation"
                                                                    
                                                                    href="<?php echo e(route('orders.show', $row->id)); ?>">
                                                                    <?php echo e(__('ordering.create_quotation')); ?></a></li>
                                                                    <?php endif; ?>
                                                        </ul>
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/orders/orders_list.blade.php ENDPATH**/ ?>