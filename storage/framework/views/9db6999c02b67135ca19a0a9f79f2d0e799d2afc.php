                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add-top-up-operator')): ?>
                            <li class="nav-item">
                                            ...
                                            <div class="badge badge-success badge-shadow">Approved</span>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-top-up-operator')): ?>
<a class="btn btn-icon btn-info" title="Edit" onclick="return confirm('Are you sure?')"   href="<?php echo e(route("top_up_operator.edit", $row->id)); ?>"><i class="fa fa-edit"></i></a>
<?php endif; ?>
                                                        </div>
                                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-top-up-operator')): ?>
                                                        <div class="col-lg-4">
                                                        
                                                            <?php echo Form::open(['route' => ['top_up_operator.destroy',$row->id], 'method' => 'delete']); ?>
                                                    ...
                                                    <div class="btn-group">
                                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-top-up-operator')): ?>
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <a  class="nav-link" title="Confirm Payment" onclick="return confirm('Are you sure? you want to confirm')"  href="<?php echo e(route('operator.approve', $row->id)); ?>">Confirm Payment</a></li>
                                                                          </ul></div>
                                                <?php endif; ?>
 ...
 <?php if($row->reversed == 0): ?>
                   <li class="nav-item"><a  class="nav-link" title="Edit" data-toggle="modal" class="discount"  href="" onclick="model(<?php echo e($row->id); ?>,'operator')" value="<?php echo e($row->id); ?>" data-target="#appFormModal" >Reverse Top Up</a></li>
<?php endif; ?>
          <li class="nav-item"><a  class="nav-link"  onclick="return confirm('Are you sure? you want to  mark as complete ')"  href="<?php echo e(route('operator.complete', $row->id)); ?>">Mark as Complete</a></li>
                                                                          </ul></div>
                      <?php endif; ?>
<?php endif; ?>
                                                </td>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('top_up_operator.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'top_up_operator.store'])); ?>
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="m-b" name="from_account_id" id="select-account" required>
                                                        ...
                                                        <option value="<?php echo e($row->id); ?>" <?php if(isset($data)): ?><?php if($data->
                                                            from_account_id == $row->id): ?> selected <?php endif; ?> <?php endif; ?> >From
...
$(document).ready(function() {
    ...
    $(document).on('change', '.reverse_amount', function() {
        ...
        $.ajax({
            url: '<?php echo e(url("findOperator")); ?>',
            type: "GET",
            data: {
                id: id,
                  user: user,
...
<script type="text/javascript">
    function model(id,type) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?php echo e(url("reverseOperatorModal")); ?>',
            data: {
                'id': id,
                'type':type,
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/top_up_operator.blade.php ENDPATH**/ ?>