    ...
    <tr style="margin-top: 0px">
        ...
        <td style="width: 50%">
            <div style="padding-left: 5px">
                 ...
                 <div class="address"> Weight Note No :</b><?php echo e($data->weight_note); ?>  </div>
                <div class="address"> Location/Ginnery :</b> <?php echo e($data->location); ?></div>
                <div class="address">Client : </b><?php echo e(App\Models\Cotton\CottonClient::find($data->client)->name); ?>       </div>
         ...
         <td style="width: 50%;">
            <div class="right" style="">
                ...
                <div class="date"><span style="text-align: right"> Date :</b> <?php echo e($data->date); ?></span></div>             
                <div class="date"><span style="text-align: right">Lot No :</b> <?php echo e($data->lot_no); ?> </span></div>
               <div class="date"> <span style="text-align: right"><b> Total balance Weight :</b><?php echo e($data->bale_weight); ?> </span></div>
...
<?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/productionDetails_pdf.blade.php ENDPATH**/ ?>