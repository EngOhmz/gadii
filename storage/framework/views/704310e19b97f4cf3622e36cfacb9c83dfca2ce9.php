                            ...
                            <div class="tab-pane fade <?php if(empty($id)): ?> active show <?php endif; ?>" id="home2" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            <?php if(!@empty($billofmaterial)): ?>
                                            <?php $__currentLoopData = $billofmaterial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="gradeA even" role="row">

                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="<?php echo e(route('bill_of_material.show',$row->id)); ?>" role="tab"
                                                ...
                                                ?>
                                                      <?php echo e(!empty($data) ? $data->name : ""); ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        ...
                                                        href="<?php echo e(route('bill_of_material.edit', $row->id)); ?>"><i
                                                            class="fa fa-edit"></i></a>
                                                            <?php endif; ?>

                                                    <?php echo Form::open(['route' => ['bill_of_material.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('inventory.approve',$row->id)); ?>"
                                                                    role="tab"
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('inventory.receive',$row->id)); ?>"
                                                                    role="tab"
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('inventory.pay',$row->id)); ?>"
                                                                    role="tab"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="<?php echo e(route('inventory.cancel', $row->id)); ?>">Cancel
                                                                   Bill</a></li>
                                        <?php endif; ?>
                                                        </ul>
                                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('bill_of_material.update', $id), 'method' => 'PUT'))); ?>

                                              
                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'bill_of_material.store'])); ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <option <?php if(isset($data)): ?>
                                                            <?php echo e($data->manfactured_item == $row->id  ? 'selected' : ''); ?>
                                                    ...
                                                    <div class="col-lg-4">
                                                      ...
                                                      <select class="form-control" name="work_centre1" required
                                                        ...
                                                        <?php if(!empty($work_centre)): ?>
                                                        <?php $__currentLoopData = $work_centre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                        <option <?php if(isset($data)): ?>
                                                            <?php echo e($data->work_centre == $row->id  ? 'selected' : ''); ?>
                                                        ...
                                                        <tr class="line_items">
                                                            <td><select name="item_name[]"
                                                                  ...
                                                                  <td><input type="text" name="description[]"
                                                                    ...
                                                                    value="<?php echo e(isset($i) ? $i->description : ''); ?>"
                                                                    required /></td>
                                                                      <td><select name="location[]"
                                                                    class="form-control location" required
                                                                    data-sub_category_id=<?php echo e($i->order_no); ?>>
                                                                    <option value="">Select Location</option><?php $__currentLoopData = $location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"
                                                                        <?php if(isset($i)): ?><?php if($n->id == $i->location): ?>
                                                                        selected <?php endif; ?> <?php endif; ?> ><?php echo e($n->name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select></td>
                                                                 <td><select name="work_centre[]"
                                                                    class="form-control location" required
                                                                    data-sub_category_id=<?php echo e($i->order_no); ?>>
                                                                    <option value="">Select Work Centre</option><?php $__currentLoopData = $work_centre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"
                                                                        <?php if(isset($i)): ?><?php if($n->id == $i->location): ?>
                                                                        selected <?php endif; ?> <?php endif; ?> ><?php echo e($n->name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select></td>
                                                            <td><input type="number" name="quantity[]"
                                                                    class="form-control item_quantity<?php echo e($i->id); ?>"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="<?php echo e(route('purchase_inventory.index')); ?>">
                                                            cancel
                                                        </a>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '<?php echo e(url("findInvPrice")); ?>',
            type: "GET",
            data: {
                id: id
            },
...
$(document).ready(function() {
    ...
    $('.add').on("click", function(e) {
        ...
        html +=
            '<td><select name="location[]" class="form-control item_name" required  data-sub_category_id="' +
            count +
            '"><option value="">Select Location</option><?php $__currentLoopData = $location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"><?php echo e($n->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
        html +=
            '<td><select name="work_centre[]" class="form-control item_name" required  data-sub_category_id="' +
            count +
            '"><option value="">Select Item</option><?php $__currentLoopData = $work_centre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"><?php echo e($n->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/manufacturing/bill_of_material.blade.php ENDPATH**/ ?>