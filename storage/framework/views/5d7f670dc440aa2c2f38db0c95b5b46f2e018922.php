...
<?php endif; ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                 ...
                 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-items')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('cotton_list')); ?>">Item List</a></li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-cotton-purchase')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('purchase_cotton')); ?>">Purchase</a></li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-cotton-movement')): ?>
                    <li><a class="nav-link" href="<?php echo e(url('cotton_movement')); ?>">Item Movement</a></li>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                   <!--
                    <li><a class="nav-link" href="<?php echo e(url('good_return')); ?>">Transactions</a></li>
                  -->
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class=" "><a class="nav-link" href="<?php echo e(url('expenses')); ?>">Expenses</a></li>
                    <?php endif; ?>
                   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-deposit')): ?>
                 <li class=""><a class="nav-link" href="<?php echo e(url('transfer')); ?>">Transfer</a></li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-expenses')): ?>
...
</div><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/layouts/aside.blade.php ENDPATH**/ ?>