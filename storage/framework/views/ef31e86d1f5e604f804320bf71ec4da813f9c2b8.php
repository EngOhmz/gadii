        ...
        <div class="panel-body hidden-print">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <?php echo Form::select('account_id',$chart_of_accounts,$account_id, array('class' => 'select2','id'=>'account_id','style'=>'width:100%','placeholder'=>'Select')); ?>
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($key->reference); ?></td>
                                   <td><?php echo e($key->location_id->name); ?></td>
                                <td><?php echo e(Carbon\Carbon::parse($key->purchase_date)->format('d/m/Y')); ?> </td>
                                <td><?php echo e(number_format($key->quantity,2)); ?></td>
                                 <td><?php echo e(number_format($key->price,2)); ?></td>
                             <td><?php echo e(number_format($key->purchase_amount,2)); ?></td>
                   ...
                   ?>
                        ...
                        <tfoot>
                            <tr class="custom-color-with-td">
                                <td colspan="3"></td>  
                                <td ><b>Total</b></td>
                                <td><b><?php echo e(number_format($qty,2)); ?></b></td>
                                <td colspan="1"></td>
                                     <td><b><?php echo e(number_format($balance,2)); ?></b></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/cotton_movement_report.blade.php ENDPATH**/ ?>