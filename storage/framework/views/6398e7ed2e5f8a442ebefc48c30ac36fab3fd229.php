                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add-top-up-center')): ?>
                            <li class="nav-item">
                                           ...
                                           <td><?php echo e($row->chart_from->name); ?></td> 
                                            ...
                                            <div class="badge badge-success badge-shadow">Approved</span>
                                                ...
                                                <td>
                                                    <?php if($row->status == 0): ?>
                                                    <div class="row">
                                                       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-top-up-center')): ?>
                                                        <div class="col-lg-4">
                                                        
<a class="btn btn-icon btn-info" title="Edit" onclick="return confirm('Are you sure?')"   href="<?php echo e(route("top_up_center.edit", $row->id)); ?>"><i class="fa fa-edit"></i></a>
                                                        </div>
                                                        <?php endif; ?>
                                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-top-up-center')): ?>
                                                        <div class="col-lg-4">
                                                            <?php echo Form::open(['route' => ['top_up_center.destroy',$row->id], 'method' => 'delete']); ?>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <a  class="nav-link" title="Confirm Payment" onclick="return confirm('Are you sure? you want to confirm')"  href="<?php echo e(route('center.approve', $row->id)); ?>">Confirm Payment</a></li>
                                                                          </ul></div>
                                                <?php endif; ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-top-up-center')): ?>
 ...
 <?php if($row->reversed == 0): ?>
                   <li class="nav-item"><a  class="nav-link" title="Edit" data-toggle="modal" class="discount"  href="" onclick="model(<?php echo e($row->id); ?>,'center')" value="<?php echo e($row->id); ?>" data-target="#appFormModal" >Reverse Top Up</a></li>
<?php endif; ?>
          <li class="nav-item"><a  class="nav-link"  onclick="return confirm('Are you sure? you want to  mark as complete ')"  href="<?php echo e(route('center.complete', $row->id)); ?>">Mark as Complete</a></li>
                                                                          </ul></div>
                      <?php endif; ?>
<?php endif; ?>
                                                </td>
                      ...
                      <label
                                                    ...
                                                    <option value="">Select Top Up Reference</option> 
                                                        <?php $__currentLoopData = $top; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                             
                                                            <option value="<?php echo e($t->id); ?>" <?php if(isset($data)): ?><?php if($data->top_up_id == $t->id): ?> selected <?php endif; ?> <?php endif; ?> ><?php echo e($t->reference_no); ?></option>
                                                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                              </select>
                                                    </div>
                 <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/top_up_center.blade.php ENDPATH**/ ?>