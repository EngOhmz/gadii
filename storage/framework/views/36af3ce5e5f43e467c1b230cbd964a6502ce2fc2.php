                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                <th><?php echo e($loop->iteration); ?></th>
                                                  <?php if($row->assign_reference == '0'): ?>
                                                <td><?php echo e($row->serial_no); ?>  </td>                                                                                                     
                                                <?php else: ?>
                                                <td><?php echo e($row->reference); ?> </td>
                                                <?php endif; ?>
                                                <td><?php echo e($row->brand->brand); ?></td>
                                                <td><?php echo e($row->tyre_location->name); ?></td>
                                                <?php if(!@empty($row->truck_id)): ?>
                                                <td><?php echo e($row->truck->truck_name); ?> - <?php echo e($row->truck->reg_no); ?></td>
                                                <?php else: ?>
                                                <td></td>
                                                <?php endif; ?>
                                                <td>
                                                    ...
                                                    <div class="badge badge-success badge-shadow">Assigned in the <?php echo e($row->position); ?> postion.</div>
                                               ...
                                               <?php if($row->assign_reference == '0'): ?>
                                                <td> <a class="nav-link" title="Assign"
                                                    ...
                                                    onclick="model(<?php echo e($row->id); ?>,'reference')">Assign Serial No </a>                                                        
                                                </td>
                                                <?php else: ?>
                                                <td></td>
                                                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/tyre/tyre.blade.php ENDPATH**/ ?>