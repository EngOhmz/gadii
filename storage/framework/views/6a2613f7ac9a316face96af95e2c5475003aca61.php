...
?>
            <form id="form" role="form" enctype="multipart/form-data" action="<?php echo e(route('make_payment.store')); ?>"
...
?>
        ...
        <?php if (!empty($salary_info) && $salary_info->user_id == $v_employee->user_id) { ?>
                                <a class="btn btn-success btn-xs" target="_blank"
                                    href="<?php echo e(route('payslip.generate',$salary_info->id)); ?>">Generate
                                    Payslip</a>
                                <?php } else {
                                        if (!empty($set_salary)) {
                                            ?>
                                ...
                                <a class="btn btn-danger btn-xs"
                                    href="<?php echo e(route('payment',['user_id'=>$v_employee->user_id,'departments_id'=>$departments_id,'payment_month'=>$payment_month])); ?>">Make
                                    Payment</a>
                                <?php }
                                    } ?>
                              </a>   
        ...
        <?php if (!empty($salary_info) && $salary_info->user_id == $v_employee->user_id) { ?>
                ...
                <?php if(empty($salary_info)): ?> 
                                <a href="#" class="btn btn-info btn-xs" title="View" data-toggle="modal" data-target="#appFormModal"  data-id="<?php echo e($v_employee->payroll_id); ?>" data-type="template"   onclick="model(<?php echo e($v_employee->payroll_id); ?>,'salary')">View Payment Details</a>
                      <?php else: ?>          
<a href="#" class="btn btn-info btn-xs" title="View" data-toggle="modal" data-target="#appFormModal"  data-id="<?php echo e($salary_info->id); ?>" data-type="template"   onclick="model(<?php echo e($salary_info->id); ?>,'payment')">View Payment Details</a>  
<?php endif; ?>                
                    </div>&nbsp
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/payroll/make_payment.blade.php ENDPATH**/ ?>