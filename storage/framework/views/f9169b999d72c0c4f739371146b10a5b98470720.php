...
unset($__errorArgs, $__bag); ?> 
                                       ...
                                       <div class="form-group col-md-6">
                                         ...
                                         <!-- <?php $__errorArgs = ['managercontact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
function getPageData(){
  ...
  $.ajax({
        ...
        success: function(response) {
          ...
          $.ajax({
            type:"POST",
            url:'<?php echo e(route("warehouse_backend.store")); ?>',
            data:insuranceData,
            dataType:"json",
            success:function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/warehouses/manage-warehouse.blade.php ENDPATH**/ ?>