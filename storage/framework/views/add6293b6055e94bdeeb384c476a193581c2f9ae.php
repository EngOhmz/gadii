                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        href="<?php echo e(route("tyre_brand.edit", $row->id)); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                   

                                                    <?php echo Form::open(['route' => ['tyre_brand.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('tyre_brand.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'tyre_brand.store'])); ?>
                                                ...
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Manufacturer</label>
                                                   <div class="col-lg-10">
                                                           <input type="text" name="manufacturer"
                                                            value="<?php echo e(isset($data) ? $data->manufacturer : ''); ?>"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" name="brand"
                                                        value="<?php echo e(isset($data) ? $data->brand : ''); ?>"
                                                        class="form-control">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" name="size"
                                                        value="<?php echo e(isset($data) ? $data->size : ''); ?>"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row"><label
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/tyre/tyre_brand.blade.php ENDPATH**/ ?>