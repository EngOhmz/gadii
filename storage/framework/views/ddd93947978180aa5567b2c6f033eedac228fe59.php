                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $production; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="gradeA even" role="row">
                                               
                                                <td><a href="<?php echo e(route('production.show', $row->id)); ?>"><?php echo e($row->lot_no); ?></a></li></td>
                                                <td><?php echo e($row->weight_note); ?></td>
                                                <td><?php echo e($row->location); ?></td>
                                                <td>From <?php echo e(App\Models\ChartOfAccount::find($row->client)->name); ?></td>
                                                
                                                <td><?php echo e($row->net_weight); ?></td>
                                        ...
                                        <td>
 <a  class="btn btn-xs btn-outline-info text-uppercase px-2 rounded" title="Edit" href="<?php echo e(route('production.edit', $row->id)); ?>"><i class="fa fa-edit"></i></a>
...
<?php echo e(Form::close()); ?>
        ...
        <ul class="dropdown-menu animated zoomIn">
         <li class="nav-item"><a  class="nav-link" title="Edit" class="discount"  href="<?php echo e(route('production.show', $row->id)); ?>"  >View Details</a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('production.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'production.store'])); ?>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                       <input type="text" name="weight_note"
                                                            placeholder=""
                                                            value="<?php echo e(isset($data) ? $data->weight_note : ''); ?>"
                                                ...
                                                <label class="col-lg-2 col-form-label">Location/Ginnery</label>
                                                    <div class="col-lg-4">
                                                       <input type="text" name="location"
                                                            placeholder=""
                                                            value="<?php echo e(isset($data) ? $data->location : ''); ?>"
                                                            class="form-control" required>
                                                    </div> 
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="lot_no"
                                                            ...
                                                            value="<?php echo e(isset($data) ? $data->lot_no : ''); ?>"  
                                                            class="form-control">
                                                    </div> 
                                              ...
                                              <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Client</label>
                                                  ...
                                                  <option value="">Select </option>
                                                    ...
                                                    <option value="<?php echo e($row->id); ?>" <?php echo e(!empty($data->client) ? ($data->client == $row->id)? 'selected' : '' : ''); ?>><?php echo e($row->account_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                    </select>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="number" name="balance_weight" id="balance_weight" readonly
                                                            ...
                                                            value="<?php echo e(isset($data) ? $data->bale_weight : ''); ?>"  
                                                            class="form-control">
                                                    </div>
                                                    <?php else: ?>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="tale" id="tale"
                                                            ...
                                                            value="<?php echo e(isset($data) ? $data->tale : ''); ?>"  
                                                            class="form-control">
                                                    </div> 
                                                    <?php endif; ?>
                                                </div>
...
<tfoot>
<?php if(!empty($id)): ?>
   <?php if(!empty($data->productionList)): ?>
   <?php $x=0; ?>
    <tr class="line_items">
    <?php $__currentLoopData = $data->productionList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php $x++; ?>
<td><label class="col-form-label">bale<?php echo e($x); ?></label><input type="hidden"name="id<?php echo e($x); ?>" value="<?php echo e($x); ?>"><input type="text" name="bale[]" value="<?php echo e($i->bale); ?>" class="form-control item_unit<?php echo e($x); ?>" placeholder ="<?php echo e($x); ?>" required /></td>
  <?php if(fmod($x,5) == 0): ?>
  <td><button type="button" name="remove" class="btn btn-danger btn-xs rem" value= "<?php echo e(isset($i) ? $i->id : ''); ?>"><i class="fas fa-trash"></i></button></td>
     ...
     <tr>
  <?php elseif($x == count($data->productionList)): ?>
     </tr>
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/production.blade.php ENDPATH**/ ?>