            ...
            <h6 class="panel-title">
             Truck Report
                <?php if(!empty($start_date)): ?>
                    for the period: <b><?php echo e($start_date); ?> to <?php echo e($end_date); ?> for <?php echo e($center->truck_name); ?> - <?php echo e($center->reg_no); ?></b>
                <?php endif; ?>
            </h6>
        </div>
                        ...
                        ?>
                            <tr>
                                <td><?php echo e($loop->iteration); ?></td>
                                  <td><?php echo e(Carbon\Carbon::parse($key->date)->format('d/m/Y')); ?> </td>
                                    <td><?php echo e($key->chart->name); ?></td>
                                    <td><?php echo e(number_format($key->debit,2)); ?></td>
                                <td><?php echo e(number_format($key->credit,2)); ?></td>  
                    <td><?php echo e(number_format($key->debit - $key->credit,2)); ?></td>                                
                        ...
                        <tfoot>
                            <tr class="custom-color-with-td">
                                ...
                                <td><b><?php echo e(number_format($dr,2)); ?></b></td>
                                    ...
                                    <td><b><?php echo e(number_format($dr-$cr,2)); ?></b></td>
                            </tr>
                        </tfoot>
                    </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/truck/truck_report.blade.php ENDPATH**/ ?>