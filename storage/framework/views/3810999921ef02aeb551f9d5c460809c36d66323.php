...
<?php echo e(Form::close()); ?>
        ...
        <ul class="dropdown-menu animated zoomIn">
         <li class="nav-item"><a  class="nav-link" title="Edit" data-toggle="modal" class="discount"  href="" onclick="model(<?php echo e($row->id); ?>,'discount')" value="<?php echo e($row->id); ?>" data-target="#appFormModal" >Discount Quotation</a></li>
          <li class="nav-item"><a  class="nav-link" title="Convert to Invoice" onclick="return confirm('Are you sure? you want to convert Quotation To Invoice')"  href="<?php echo e(route('pacel.approve', $row->id)); ?>">Convert to Invoice</a></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/pacel/quotation.blade.php ENDPATH**/ ?>