                                        ...
                                        <td>
                                         ...
                                         <?php endif; ?>
                                                <td>
                                                    ...
                                                    <?php echo e($row->region->name); ?>

                                                
                                                </td>
                                                <td><?php echo e($row->capacity); ?> KG </td>
                                                <td><?php echo e($row->truck_status); ?></td>
                                                <td>
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                    href="<?php echo e(route('truck.insurance', $row->id)); ?>">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                    ...
                                                    <?php echo Form::open(['route' => ['truck.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                                  ...
                                                  <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" name="total_diff"
                                                            value="<?php echo e(isset($tyre) ? $tyre->total_diff : ''); ?>"
                                                            class="form-control"   required>
                                                    </div>
                                                </div>
                            ...
                            <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" name="total_rear"
                                                            value="<?php echo e(isset($tyre) ? $tyre->total_rear : ''); ?>"
                                                            class="form-control"   required>
                                                    </div>
                                                </div>
                                              ...
                                              <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" name="total_trailer"
                                                            value="<?php echo e(isset($tyre) ? $tyre->total_trailer : ''); ?>"
                                                            class="form-control"   required>
                                                    </div>
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/truck/truck.blade.php ENDPATH**/ ?>