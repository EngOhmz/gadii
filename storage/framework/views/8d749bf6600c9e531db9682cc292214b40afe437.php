                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <li> <a class="nav-link" id="profile-tab2"
                                                            ...
                                                            aria-selected="false"><?php echo e($row->reference_no); ?></a></li>
                                                </td>
                                                <td><?php echo e($row->supplier->name); ?></td>
                                                <td><?php echo e($row->purchae_date); ?></td>
                                                ...
                                                <td><?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-purchase')): ?>
                                                   ...
                                                   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-purchase')): ?>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('payments.show',$row->id)); ?>"
                                                                    role="tab"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link"
                                                                    ...
                                                                    href="<?php echo e(url('convertInvoice', $row->id)); ?>">Convert
                                                                    to Invoice</a></li>
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    onclick="return confirm('Are you sure?')"
                                                                    href="<?php echo e(route('purchase.show', $row->id)); ?>">Cancel
                                                                    Quotation</a></li>
                                                        </ul>
                                                    </div>
                                                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/purchase/manage_purchase.blade.php ENDPATH**/ ?>