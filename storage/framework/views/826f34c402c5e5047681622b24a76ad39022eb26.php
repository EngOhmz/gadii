        ...
        <div class="modal-body">
            ...
            <p><strong>Make sure the delivered order is the same as the order confirmed</strong> .</p>
             ...
             <ul>
              ...
              <li>Route Name: From <?php echo e($data->route->from); ?> to  <?php echo e($data->route->to); ?> 
                <?php if(!empty($data->end)): ?>
                 - <?php echo e($data->end); ?>
...
</div><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/order_movement/adddelivering.blade.php ENDPATH**/ ?>