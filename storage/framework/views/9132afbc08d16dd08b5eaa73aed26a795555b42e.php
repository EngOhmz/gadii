                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link <?php if(empty($id)): ?> active show <?php endif; ?>" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Expenses
                                    List</a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
<a class="btn btn-icon btn-info" title="Edit" onclick="return confirm('Are you sure?')"   href="<?php echo e(route("expenses.edit", $row->id)); ?>"><i class="fa fa-edit"></i></a>
                                                        </div>
                                                     
                                                        <div class="col-lg-6">
                                                            <?php echo Form::open(['route' => ['expenses.destroy',$row->id], 'method' => 'delete']); ?>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            <a  class="nav-link" title="Convert to Invoice" onclick="return confirm('Are you sure? you want to confirm')"  href="<?php echo e(route('expenses.approve', $row->id)); ?>">Confirm Payment</a></li>
                                                                          </ul></div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('expenses.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'expenses.store'])); ?>
                           ...
                           <label class="col-lg-2 col-form-label">Expense Name/Title</label>
                                                    <div class="col-lg-8">
...
unset($__errorArgs, $__bag); ?>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <textarea name="notes"
                                                            placeholder=""
                                                            class="form-control" rows="2"><?php echo e(isset($data) ? $data->notes : ''); ?></textarea>
                                                    </div>
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/expenses/data.blade.php ENDPATH**/ ?>