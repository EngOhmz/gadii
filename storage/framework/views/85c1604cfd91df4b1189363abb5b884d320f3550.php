        ...
        <div class="panel-body hidden-print">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <?php echo Form::select('account_id',$chart_of_accounts,$account_id, array('class' => 'select2','id'=>'account_id','style'=>'width:100%', 'placeholder'=>'Select','required'=>'required')); ?>
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($key->reference); ?></td>
                                   <td><?php echo e($key->supplier->name); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/stock_report.blade.php ENDPATH**/ ?>