...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('name')); ?>" name="name" autofocus>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control <?php $__errorArgs = ['register_as'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php if($row->id ==13 || ($row->id > 32 && $row->id < 36)): ?>
...
<?php echo $__env->make('layouts.main2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>