        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                 ...
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"  href="<?php echo e(route('purchase_tyre.edit', $purchases->id)); ?>"  title="" > Edit </a>          
            
                <?php endif; ?>

                   <?php if($purchases->status == 0 ): ?>        
              <a class="btn btn-xs btn-info"  title="Convert to Invoice" onclick="return confirm('Are you sure?')"   href="<?php echo e(route('purchase_tyre.approve',$purchases->id)); ?>"  title="" >Approve Purchase </a>
                <?php endif; ?>

               <?php if($purchases->status != 0 && $purchases->status != 4 && $purchases->status != 3 && $purchases->good_receive == 1): ?>                      
                <a class="btn btn-xs btn-danger " data-placement="top" href="<?php echo e(route('purchase_tyre.pay',$purchases->id)); ?>" title="Add Payment"> Pay Purchase  </a>    
           <?php endif; ?>  

      <?php if($purchases->status != 0 && $purchases->status != 4 && $purchases->status != 3 && $purchases->good_receive == 0): ?>                        
              <a class="btn btn-xs btn-info" data-placement="top"  href="<?php echo e(route('purchase_tyre.receive',$purchases->id)); ?>"  title="Good Receive"> Good Receive </a>   
           <?php endif; ?>  
             
             <a class="btn btn-xs btn-success"  href="<?php echo e(route('tyre_pdfview',['download'=>'pdf','id'=>$purchases->id])); ?>"  title="" > Download PDF </a>         
                    ...
                    <tr>
                        ...
                        <th class="col-sm-1" style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <td class=""><strong class="block"><?php echo e($item_name->brand); ?></strong></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/tyre/purchase_tyre_details.blade.php ENDPATH**/ ?>