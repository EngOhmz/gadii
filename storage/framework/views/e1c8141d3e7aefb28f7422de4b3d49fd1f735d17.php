<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
           ...
           <?php echo e(Form::open(['url' => url('newdiscount')])); ?>
       ...
       <?php echo method_field('POST'); ?>
        ...
        <p><strong>Make sure you enter valid information</strong> .</p>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-12">
                    <input type="text"   value="<?php echo e(isset($old) ? $old->amount : ''); ?>" required class="form-control" readonly id="old">
                </div>
            </div>
            <div class="form-group">
...
<?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/pacel/addLoading.blade.php ENDPATH**/ ?>