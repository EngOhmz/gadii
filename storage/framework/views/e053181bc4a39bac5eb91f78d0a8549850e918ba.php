                    ...
                    <div class="card-body">
                     ...
                     <?php if(!empty($data)): ?>
                      <div class="form-group col-md-6">
                                    ...
                                    <?php if(!empty($from_district)): ?>
                                                        <?php $__currentLoopData = $from_district; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                        <option <?php if(isset($data)): ?>
                                                            <?php echo e($data->from_district_id == $row->id  ? 'selected' : ''); ?>
  ...
  <?php endif; ?>
                     ...
                     <?php if(!empty($data)): ?>
                      <div class="form-group col-md-6">
                                    ...
                                    <?php if(!empty($to_district)): ?>
                                                        <?php $__currentLoopData = $to_district; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                        <option <?php if(isset($data)): ?>
                                                            <?php echo e($data->to_district_id == $row->id  ? 'selected' : ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/route/route.blade.php ENDPATH**/ ?>