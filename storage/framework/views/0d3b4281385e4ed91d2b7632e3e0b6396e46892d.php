                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        href="<?php echo e(route("manufacturing_inventory.edit", $row->id)); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                   

                                                    <?php echo Form::open(['route' => ['manufacturing_inventory.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('manufacturing_inventory.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'manufacturing_inventory.store'])); ?>
                                                ...
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Item Name</label>
                                                   ...
                                                   <select class="form-control" name="product_type">
                                                    <option value="1" <?php echo e(isset($data) ? ($data->product_type == 1 ? "selected":'') : ''); ?>>Manufacturing</option>
                                                     <option value="2" <?php echo e(isset($data) ? ($data->product_type == 2 ? "selected":'') : ''); ?>>Inventory</option>
                                                   </select>
                                                ...
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="number" name="price"
                                                            value="<?php echo e(isset($data) ? $data->price : ''); ?>"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="number" name="quantity"
                                                        value="<?php echo e(isset($data) ? $data->quantity : ''); ?>"
                                                        class="form-control">
                                                </div>
                                            </div>
                                                   <div class="form-group row"><label
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/manufacturing/work_order.blade.php ENDPATH**/ ?>