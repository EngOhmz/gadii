            ...
            <div class="ibox-content p-0 px-3 pt-2">
                <div class="row">
                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="text" class="form-control" name="name" id="nname" value="<?php echo e(old('name')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/manage/users/add.blade.php ENDPATH**/ ?>