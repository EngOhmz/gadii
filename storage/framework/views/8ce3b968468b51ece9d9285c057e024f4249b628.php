...
<?php $a=0; ?>
                                        ...
                                        <label class="col-lg-2 col-form-label">Truck</label>
                                                 ...
                                                 <option value="">Select 
                                                    <?php if(!empty($truck)): ?>
                                                    <?php $__currentLoopData = $truck; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                    <option  value="<?php echo e($c->id); ?>"><?php echo e($c->reg_no); ?> - <?php echo e($c->truck_name); ?></option>
...
<div class="form-group row">
  ...
  <label class="col-lg-2 col-form-label">Transport Cost</label>
   ...
   <?php if(!@empty($reqlevy)): ?>
<?php $__currentLoopData = $reqlevy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<input type="hidden" name="levy_req_id[]"   value="<?php echo e($req->id); ?>" class="form-control" required>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                                        
<?php endif; ?>
    ...
    let quantity = document.getElementById("qty").value; 
        let source = document.getElementById("source").value; 
            let date = document.getElementById("date").value; 
             ...
             $.ajax({
            type: 'GET',
            url: '<?php echo e(route("movement.chekBalance")); ?>',
            data: {
                'quantity': quantity,
                'date': date,
                'source': source,
...
$(document).ready(function() {
  ...
  new TomSelect(".select_truck",{
    ...
    $('.add').on("click", function(e) {
        ...
        html +=
            '<td><select name="levy_id[]" class="form-control item_levy" required "><option value="">Select Item</option><?php $__currentLoopData = $levy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"><?php echo e($n->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';      
...
<?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/addreport.blade.php ENDPATH**/ ?>