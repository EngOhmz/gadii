...
<section class="section">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-1">
                                        <thead>
                                            ...
                                            <?php if(!@empty($maintain)): ?>
                                            <?php $__currentLoopData = $maintain; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="gradeA even" role="row">
                                               ...
                                               $st=App\Models\FieldStaff::where('id', $row->mechanical)->get(); 
                                                ...
                                                <td>
                                                    ...
                                                    href="<?php echo e(route("maintainance.approve", $row->id)); ?>" onclick="return confirm('Are you sure?')" title="Change Status">
                                                    <i class="fa fa-check"></i>
                                                </a>
                                              
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        href="<?php echo e(route("maintainance.edit", $row->id)); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                   

                                                    <?php echo Form::open(['route' => ['maintainance.destroy',$row->id],
                                                    'method' => 'delete']); ?>
    ...
    <?php if($row->report == 0): ?>
                         <a class="nav-link" title="Assign"
                                                    ...
                                                    onclick="model(<?php echo e($row->id); ?>,'maintainance')">Create Mechanical Report </a> 
  <?php elseif($row->report == 1): ?>
                         <a class="nav-link" title="View"
                                                    ...
                                                    onclick="model(<?php echo e($row->id); ?>,'mechanical_maintainance')">View Mechanical Report </a>  
  <?php endif; ?>
<?php endif; ?>
                                                </td>
                                            </tr>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('maintainance.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'maintainance.store'])); ?>
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-lg-4">
                                                    ...
                                                    <option <?php if(isset($data)): ?>
                                                        <?php echo e($data->type == 'Minor'  ? 'selected' : ''); ?>

                                                        <?php endif; ?> value="Minor">Minor</option>
                                                        <option <?php if(isset($data)): ?>
                                                        <?php echo e($data->type == 'Major'  ? 'selected' : ''); ?>

                                                        <?php endif; ?> value="Major">Major</option>
                                            ...
                                            class="form-control" required><?php if(isset($data)): ?><?php echo e($data->reason); ?> <?php endif; ?></textarea>
                                                </div>
                                            </div>
...
<div class="modal-content">
   <div class="modal-header">
      ...
      ?>
         <?php $__currentLoopData = $tr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         Maintainance History For <?php echo e($t->truck_name); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/inventory/maintainance.blade.php ENDPATH**/ ?>