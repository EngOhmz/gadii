                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                <?php if($row->store_type == 1): ?>
                                                <p>Work Centre</p>
                                                <?php elseif($row->store_type == 2): ?>
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        href="<?php echo e(route("manufacturing_location.edit", $row->id)); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                   

                                                    <?php echo Form::open(['route' => ['manufacturing_location.destroy',$row->id],
                                                    'method' => 'delete']); ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('manufacturing_location.update', $id), 'method' => 'PUT'))); ?>

                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'manufacturing_location.store'])); ?>
                                                ...
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Name</label>
                                                   ...
                                                   <option value="1" <?php echo e(isset($data) ? ($data->store_type == 1 ? "selected":'') : ''); ?>>Work Centre</option>
                                                   <option value="2" <?php echo e(isset($data) ? ($data->store_type == 2 ? "selected":'') : ''); ?>>Finished Products</option>
                                                   <option value="3" <?php echo e(isset($data) ? ($data->store_type == 3 ? "selected":'') : ''); ?>>Inventory Store</option>
                                                   </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/manufacturing/location.blade.php ENDPATH**/ ?>