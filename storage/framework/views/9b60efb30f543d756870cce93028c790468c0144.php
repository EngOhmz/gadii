                    ...
                    <table class="table table-striped table-condensed table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><button class="btn desplay_district_report" value='<?php echo e($row->id); ?>' data-toggle="modal"  data-target="#createOrder" href="#" style=" border: none,background-color: inherit,padding: 14px 28px,font-size: 16px,cursor: pointer,display: inline-block"><a href="#"><?php echo e($row->name); ?></a></button></td>
                                  <td><?php echo e(number_format(  $total_dr,2)); ?></td>
                                    <td><?php echo e($total_stock_kijijini); ?></td>
                                <td><?php echo e($total_value_of_stock_kijijini); ?></td>                                
                             <td><?php echo e($total_kg_received); ?></td>
                             <td><?php echo e(number_format( $total_value_kg_received,2)); ?></td>
                             <td><?php echo e(number_format( $total_cr,2)); ?></td>
                             <td><?php echo e(number_format( $total_dr-$total_value_kg_received-$total_cr,2)); ?></td>
...
function getPopUpTableData(){
      let url = '<?php echo e(route("general_report_table.show", ":id")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/general_report2.blade.php ENDPATH**/ ?>