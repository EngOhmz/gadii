                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('payments.show', $row->id)); ?>"><?php echo e($row->farmer->firstname); ?>

                                            </a></td>
                                    <td><a href="<?php echo e(route('payments.show', $row->id)); ?>"><?php echo e($row->due_amount); ?>Tsh </a></td>
                                    <td> <a href="<?php echo e(route('payments.show', $row->id)); ?>">
                                            <?php if($row->status == 1): ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                <?php if(isset($id)): ?>
                                <?php echo e(Form::model($id, array('route' => array('invoice_payment.update', $id), 'method' => 'PUT'))); ?>

                                <?php else: ?>
                                <?php echo e(Form::open(['route' => 'invoice_payment.store'])); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="number" name="amount"
                                            value="<?php echo e(isset($data) ? $data->due_amount : ''); ?>" class="form-control">
                                            <input type="hidden" name="id"
                                            value="<?php echo e(isset($data) ? $data->id : ''); ?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row"><label class="col-lg-2 col-form-label">Payment
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control m-b" name="payment_methode_id">
                                            <?php if(!empty($payment_methode)): ?>
                                            <?php $__currentLoopData = $payment_methode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group row"><label class="col-lg-2 col-form-label">Notes</label>
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="notes" value="<?php echo e(isset($data) ? $data->amount-$data->due_amount : ''); ?>"
                                            class="form-control" <?php if(empty($data)): ?> disabled <?php endif; ?>>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/payment/invoice_payment.blade.php ENDPATH**/ ?>