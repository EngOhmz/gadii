...
<table id="details" class="clearfix">
    ...
    <tr style="margin-top: 0px">
        ...
        <h3 style="margin-bottom: 0;margin-top: 0">REF NO : <span style="text-align: right"><?php echo e($purchases->reference_no); ?></span></h3>
    ...
    <tbody>
     <?php if(!empty($purchase_items)): ?>
            ...
            <tr>
                ...
                <td class="unit" style="text-align: right"><?php echo e($row->quantity); ?></td>
                <td class="unit" style="text-align: right"><?php echo e(number_format($row->price ,2)); ?></td>
...
<?php endif; ?>
                ...
                <td class="unit" style="text-align: right"><?php echo e(number_format($row->total_cost ,2)); ?></td>
...
<?php /**PATH /home/admin/web/app.ema.co.tz/public_html/resources/views/cotton/purchase_cotton_pdf.blade.php ENDPATH**/ ?>