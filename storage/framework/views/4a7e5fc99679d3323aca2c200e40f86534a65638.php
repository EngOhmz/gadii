    ...
    <div class="section-body">
            ...
            <div class="col-12 col-md-12 col-lg-12">
              ...
              <a class="btn btn-xs btn-info"  title="Convert to Invoice" onclick="return confirm('Are you sure?')"    href="<?php echo e(route('inventory.approve',$purchases->id)); ?>"  title="" >Approve Purchase </a>
               ...
               <?php if($purchases->status != 0 && $purchases->status != 4 && $purchases->status != 3 && $purchases->good_receive == 1): ?>                      
                <a class="btn btn-xs btn-danger " data-placement="top"  href="<?php echo e(route('seed.pay',$purchases->id)); ?>"  title="Add Payment"> Pay Purchase  </a>    
           <?php endif; ?>  
      ...
      <?php if($purchases->status != 0 && $purchases->status != 4 && $purchases->status != 3 && $purchases->good_receive == 0): ?>                        
           ...
           <?php endif; ?>  
             ...
             <a class="btn btn-xs btn-success"  href="<?php echo e(route('seed_pdfview',['download'=>'pdf','id'=>$purchases->id])); ?>"  title="" > Download PDF </a>         
...
?>
                                            ...
                                            href="<?php echo e(route('seed_sales_payment.edit', $row->id)); ?>"><i
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/invoice_seed_details.blade.php ENDPATH**/ ?>