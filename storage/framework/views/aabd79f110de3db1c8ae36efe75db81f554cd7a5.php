                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="<?php echo e(route('seed_sales.show',$row->id)); ?>" role="tab"
                                                ...
                                                <td>
                                                    <?php if($row->status != 0): ?>
                                                        ...
                                                        <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('seed.pay',$row->id)); ?>"
                                                                    role="tab"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('seed_sales.update', $id), 'method' => 'PUT'))); ?>

                                              
                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'seed_sales.store'])); ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="<?php echo e(route('seed_sales.index')); ?>">
                                                            cancel
                                                        </a>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '<?php echo e(url("findSeedPrice")); ?>',
            type: "GET",
            data: {
                id: id
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/gaki.ema.co.tz/public_html/resources/views/cotton/manage_invoice_seed.blade.php ENDPATH**/ ?>