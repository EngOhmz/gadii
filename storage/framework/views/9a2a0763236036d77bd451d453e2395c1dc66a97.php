                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                            <div class="tab-pane fade <?php if(empty($id)): ?> active show <?php endif; ?>" id="home2" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <?php echo e(Form::open(['route' => 'save.wb'])); ?>                    
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                               ...
                                               <td><?php echo e($row->quantity); ?> </td>
                                                ...
                                                <td>
                  <input name="item_id[]" type="checkbox"  class="checks" value="<?php echo e($row->item_id); ?>">
                                                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/del.co.tz/public_html/resources/views/order_movement/wb.blade.php ENDPATH**/ ?>