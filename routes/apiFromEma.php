...
Route::group(['prefix' => 'ema'], function () {
    ...
    Route::get('get_sales/{id}/index','Api_controllers\Pms\Outlet\OrderController@index');

    Route::post('sales/save','Api_controllers\Pms\Outlet\OrderController@store');
    ...
    Route::post('purchase_items/save','Api_controllers\Pms\Outlet\PurchaseController@item_purchase_store');
