...
<div class="add-detail ">
 ...
 <tfoot>
         ...
         <tr>
             ...
             <td class="w-50">
                 <div class="box-text">
                  <p> <strong> Property : @if (!empty($invoices->store->name)){{ $invoices->store->name }}@endif</strong></p>
...
<thead>
        <tr>
            ...
            <th class="col-sm-2 w-50" >Date</th>
            <th class="w-50">Room Type</th>
            <th class="w-50">Room</th>
