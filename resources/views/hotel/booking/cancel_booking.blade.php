            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Cancel Booking </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                {!! Form::open(array('route' => 'booking.cancel_booking',"enctype"=>"multipart/form-data", 'id' => 'adjform')) !!}
                                                        @method('POST')
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <div class="form-group row"><label class="col-lg-3 col-form-label">Reason For Cancellation</label>
                                                        ...
                                                        <div class="col-lg-8">
                                                            <textarea name="cancel_reason" class="form-control desc" rows="3" placeholder=""  required></textarea>
                                                        </div>
                                                    </div>
