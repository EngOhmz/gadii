                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <!--    <td>
                                                   {{number_format($row->quantity - $row->due_quantity)}} 
                                                    ...
                                                    <td>
                                                    <a  class="nav-link" title="View" data-toggle="modal" class="discount"  href="" onclick="modelProduce({{ $row->id }},'view')" value="{{ $row->id}}" data-target="#appFormModal" >{{number_format($row->quantity - $row->due_quantity)}} </a>
