                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Package
                                    List</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(!empty($id)) active show @endif" id="profile-tab2"
                                    data-toggle="tab" href="#profile2" role="tab" aria-controls="profile"
                                    aria-selected="false">New Package</a>
                            </li>
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                   ...
                                                   <!-- <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 186.484px;">Description</th>
                                              ...
                                              <td>{{$row->description }}</td>
                                                ...
                                                <div class="form-inline">
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        href="{{ route("manufacturing_package.edit", $row->id)}}">
                                                        <i class="icon-pencil7"></i>
                                                    </a>&nbsp
                                                   

                                                    {!! Form::open(['route' => ['manufacturing_package.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     @if(isset($id))
                                                {{ Form::model($id, array('route' => array('manufacturing_package.update', $id), 'method' => 'PUT')) }}
                                                @else
                                                {{ Form::open(['route' => 'manufacturing_package.store']) }}
                                                @method('POST')
                                                @endif
