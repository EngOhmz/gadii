...
@if(!empty($start_date))
                       <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="nav-item"><a class="nav-link"  href="{{url('financial_report/balance_sheet/pdf?start_date='.$start_date)}}"
                                       target="_blank"><i
                                                class="icon-file-pdf"></i>  Download PDF
                                    </a></li>
                                
                                    <li class="nav-item"><a class="nav-link"  href="{{url('financial_report/balance_sheet/excel?start_date='.$start_date)}}"
                                       target="_blank"><i
