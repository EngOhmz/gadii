    <div class="modal-content">
        <div class="modal-header">
            ...
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form id="form" role="form" enctype="multipart/form-data" action="{{route('project.purchase_grn')}}"  method="post" >
                                                        ...
                                                        <tr class="line_items">
                                                            ...
                                                            <td><input type="number" name="quantity[]"
                                                                   ...
                                                                   <div class=""> <p class="form-control-static errors{{$i->order_no}}" id="errors" style="text-align:center;color:red;"></p>   </div> 
                                                                            ...
                                                                            <td>
                                                                         <input type="month" name="date[]"  class="form-control monthyear">
                                                                           </td>
