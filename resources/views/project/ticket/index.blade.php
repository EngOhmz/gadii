                                                ...
                                                @if (!@empty($tickets))
                                                    @foreach ($tickets as $row)
                                                        <tr class="gradeA even" role="row">
                                                            ...
                                                            <td><a href="{{ route('ticket.ticketDet', $row->id) }}">{{ $row->ticket_code }}</a></td>
                                                                    ...
                                                                    <div class="dropdown">&nbsp;
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $row->id }}"
                                                                                href="{{ route('ticket.change_status', ['id' => $row->id, 'status' => 'Open']) }}">Open</a>
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $row->id }}"
                                                                                href="{{ route('ticket.change_status', ['id' => $row->id, 'status' => 'In Progress']) }}">In Progress</a>
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $row->id }}"
                                                                                href="{{ route('ticket.change_status', ['id' => $row->id, 'status' => 'Closed']) }}">Closed</a>
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $row->id }}"
                                                                                href="{{ route('ticket.change_status', ['id' => $row->id, 'status' => 'Answered']) }}">Answered</a>
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $row->id }}"
                                                                                href="{{ route('ticket.change_status', ['id' => $row->id, 'status' => 'Completed']) }}">Completed</a>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="form-inline">
                                                                    <a class="list-icons-item text-primary" title="Edit"
                                                                        href="{{ route('ticket.edit', $row->id) }}"><i
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12 ">
                                                    @if (isset($id))
                                                        {{ Form::model($id, ['route' => ['ticket.update', $id], 'method' => 'PUT']) }}
                                                    @else
                                                    ...
                                                    <div class="form-group row"><label
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="m-b account_id" id="reporter" name="reporter"
                                                                required>
                                                                <option value="">Select Reporter</option>
                                                                @foreach ($users as $row)
                                                                    <option value="{{ $row->id }}"
                                                                        @if (isset($data)) @if ($data->reporter == $row->id) selected @endif
                                                                        @endif >{{ $row->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                     ...
                                                     <div class="form-group row"><label
                                                            class="col-lg-2 col-form-label">Satus</label>
                                                        <div class="col-lg-8">
                                                            <select class="m-b account_id"  name="status"
                                                                required>
                                                    ...
                                                    <div class="form-group row"><label
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="m-b account_id" id="project_id"
                                                                name="project_id">
                                                                <option value="">Select Project</option>
                                                                @foreach ($project as $row)
                                                                    <option value="{{ $row->id }}"
                                                                        @if (isset($data)) @if ($data->project_id == $row->id) selected @endif
                                                    ...
                                                    <div class="form-group row"><label
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="m-b account_id" id="priority" name="priority"
                                                                required>
                                                                <option value="">Select Priority</option>
                                                                <option value="Ok"
                                                                    @if (isset($data)) @if ($data->priority == 'Ok') selected @endif
                                                                    @endif >Ok</option>
                                                                <option value="Low"
                                                                    @if (isset($data)) @if ($data->priority == 'Low') selected @endif
                                                                    @endif >Low</option>
                                                                <option value="Medium"
                                                                    @if (isset($data)) @if ($data->priority == 'Medium') selected @endif
                                                                    @endif >Medium</option>
                                                                <option value="High"
                                                                    @if (isset($data)) @if ($data->priority == 'High') selected @endif
                                                                    @endif >High</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row"><label
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="m-b account_id" id="departments_id"
                                                                name="departments_id" required>
                                                                <option value="">Select Department</option>
                                                                @foreach ($departments as $row)
                                                                    <option value="{{ $row->id }}"
                                                                        @if (isset($data)) @if ($data->departments_id == $row->id) selected @endif
                                                                        @endif >{{ $row->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="tags" required placeholder=""
