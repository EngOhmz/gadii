                           ...
                           <label class="col-lg-2 col-form-label">Task Name</label>
                                                ...
                                                <select class="m-b account_id related_class" id="goal_tracking_id" name="goal_tracking_id" required>
                                                            ...
                                                            <option value="Leads" @if(isset($data))@if($data->goal_tracking_id == 'Leads') selected @endif @endif >Leads</option>
                                                             <option value="Goals" @if(isset($data))@if($data->goal_tracking_id == 'Goals') selected @endif @endif >Goal Tracking</option>
                                                             </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="goalsDiv" style="display:none">
                                                
                                                 <div class="form-group row"><label
                                                        class="col-lg-2 col-form-label">Goal Tracking</label>
                                                    <div class="col-lg-8">
                                                <select class="m-b account_id" id="goal_id" name="goal_tracking_id">
                                                    <option value="">Select Goal Tracking</option>                                                    
                                                            @foreach ($goal_tracking as $row)                                                             
                                                            <option value="{{$row->id}}" @if(isset($data))@if($data->leads_id == $row->id) selected @endif @endif >{{$row->goal_type}}</option>
                                                               @endforeach
                                                             </select>
                                                    </div>
                                                </div>
