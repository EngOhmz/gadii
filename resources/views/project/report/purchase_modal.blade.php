...
<?php $total=0;?>
            ...
            <div class="table-responsive">
                        ...
                        <?php  $crd=App\Models\JournalEntry::where('project_id', $data->id)->where('transaction_type','pos_purchase')->where('account_id', $payable->id)->where('income_id', $row->id)->whereNotNull('credit')->sum('credit');   ?>
                                                <td>{{number_format($crd - $row->discount,2)}} TZS</td>
     
                                                                    </tr>
                                                                
                                                   <?php $total +=$crd - $row->discount;?>
                                                                                @endforeach                                   
                                                                                @endif
                                            </tbody>
