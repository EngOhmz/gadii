               ...
               <table class="table datatable-basic table-striped" id="table-1">
                                    ...
                                    if (!empty($v_nssf_salary)): foreach ($v_nssf_salary as $nssf_salary) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo number_format($nssf_salary->debit +$nssf_salary->debit, 2);
                                                $total_amount += $nssf_salary->debit +$nssf_salary->debit ;
                                                ?></td>
  ...
  <div class="card-body">  
                ...
                <table class="table datatable-basic table-striped" id="table-1">
                                    ...
                                    if (!empty($v_user_nssf_salary)): foreach ($v_user_nssf_salary as $user_nssf_salary) : ?>
                                            ...
                                            <td><?php echo number_format($user_nssf_salary->debit + $user_nssf_salary->debit, 2);
                                                $user_total_amount += $user_nssf_salary->debit + $user_nssf_salary->debit;
                                                ?></td>
