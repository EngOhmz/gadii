...
-->
                             ...
                             <div class="">
                                    ...
                                    <input type="number"  name="bank_charges" class="form-control charge" value="<?php
                                       if (!empty($check_salary_payment->bank_charges)) {
                                           echo $check_salary_payment->bank_charges;
                                       }
                                       ?>" class="form-control">
                                </div>
<br>
