                                                                ...
                                                                <div class="form-inline">
                                                                    @if ($data->task_status == 'Deferred')
                                                                        <div class="badge badge-danger badge-shadow">
                                                                            {{ $data->task_status }}</div>
                                                                    @elseif($data->task_status == 'In Progress')
                                                                        <div class="badge badge-info badge-shadow">
                                                                            {{ $data->task_status }}</div>
                                                                    @elseif($data->task_status == 'Completed')
                                                                        <span
                                                                            class="badge badge-success badge-shadow">{{ $data->task_status }}</span>
                                                                    @elseif($data->task_status == 'Started')
                                                                        <span
                                                                            class="badge badge-primary badge-shadow">{{ $data->task_status }}</span>
                                                                    @else
                                                                    ...
                                                                    <div class="dropdown">&nbsp;
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $data->id }}"
                                                                                href="{{ route('task.change_status', ['id' => $data->id, 'status' => 'Started']) }}">Started</a>
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $data->id }}"
                                                                                href="{{ route('task.change_status', ['id' => $data->id, 'status' => 'In Progress']) }}">In
                                                                                Progress</a>
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $data->id }}"
                                                                                href="{{ route('task.change_status', ['id' => $data->id, 'status' => 'Deferred']) }}">Deferred</a>
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $data->id }}"
                                                                                href="{{ route('task.change_status', ['id' => $data->id, 'status' => 'Waiting For Someone']) }}">Waiting
                                                                                For Someone</a>
                                                                            <a class="nav-link change_status"
                                                                                data-id="{{ $data->id }}"
                                                                                href="{{ route('task.change_status', ['id' => $data->id, 'status' => 'Completed']) }}">Completed</a>
                                                            ...
                                                            <td>
                                                                <div class="form-inline">
                                                                    <a class="nav-link" href="" data-toggle="modal"
                                                                        value="{{ $data->id }}" data-type="view"
                                                                        data-target="#app2FormModal"
                                                                        onclick="model2({{ $data->id }},'view')">View</a>
                                                                    <a class="nav-link" href="" data-toggle="modal"
                                                                        value="{{ $data->id }}" data-type="assign"
                                                                        data-target="#app2FormModal"
                                                                        onclick="model2({{ $data->id }},'assign')"><i
...
@section('scripts')
    ...
    <script type="text/javascript">
        function model2(id, type) {
            ...
            $.ajax({
                type: 'GET',
                url: '{{ url('goalTracking/taskModal') }}',
                data: {
                    'id': id,
                    'type': type,
                },
