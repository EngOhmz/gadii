                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Supplier Reference No</label>
                                                    <div class="col-lg-4">
                                                        <input type="text" name="supplier_reference_no"
                                                            placeholder="Enter supplier reference number"
                                                            value="{{ isset($data) ? $data->supplier_reference_no : ''}}"
                                                            class="form-control">
                                                    </div>
                                                </div>
...
$(document).ready(function() {
    ...
    $('.add').on("click", function(e) {
        ...
        html += '<td><select name="tax_rate[]" class="form-control m-b item_tax' + count +
            '"><option value="0">Select Tax Rate</option><option value="0">No tax</option><option value="0.18">18%</option></select></td>';
