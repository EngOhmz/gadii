            ...
            <div class="panel-body ">
               ...
               <table class="table datatable-button-html5-basic">
                        ...
                        <tr>
                            ...
                            <th>Name</th>
                            <th>Opening Balance (Bottles) </th>
                              <th>Purchase Balance (Bottles) </th>
                               <th>Sales Balance (Bottles)</th>
...
<script>
 ...
 $(function() {
    let urlcontract = "{{ route('restaurant.balance_report') }}";
      ...
      $('.datatable-button-html5-basic').DataTable({
        ...
        buttons: [
          {extend: 'copyHtml5',title: 'DRINKS REPORT FOR THE PERIOD {{Carbon\Carbon::parse($start_date)->format('d-m-Y')}} TO {{Carbon\Carbon::parse($end_date)->format('d-m-Y')}} ', footer: true},
           {extend: 'excelHtml5',title: 'DRINKS REPORT FOR THE PERIOD {{Carbon\Carbon::parse($start_date)->format('d-m-Y')}} TO {{Carbon\Carbon::parse($end_date)->format('d-m-Y')}}' , footer: true},
           {extend: 'csvHtml5',title: 'DRINKS REPORT FOR THE PERIOD {{Carbon\Carbon::parse($start_date)->format('d-m-Y')}} TO {{Carbon\Carbon::parse($end_date)->format('d-m-Y')}}' , footer: true},
            {extend: 'pdfHtml5',title: 'DRINKS REPORT FOR THE PERIOD {{Carbon\Carbon::parse($start_date)->format('d-m-Y')}} TO {{Carbon\Carbon::parse($end_date)->format('d-m-Y')}}', footer: true},
            {extend: 'print',title: 'DRINKS REPORT FOR THE PERIOD {{Carbon\Carbon::parse($start_date)->format('d-m-Y')}} TO {{Carbon\Carbon::parse($end_date)->format('d-m-Y')}}' , footer: true}
     ...
     <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.item', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{ url('reports/restaurant/viewModal') }}',
                    data: {
                    'id': id,
                    'type': type,
