 ...
 <tbody>
                    <?php     
                        ...
                        $account =App\Models\Restaurant\POS\OrderHistory::where('item_id', $key->id)->where('item_type', 'Kitchen')->whereIn('location',$loc_id)->whereBetween('invoice_date',[$start_date,$end_date])->orderBy('invoice_date','desc')->get();
                        ?>  
 ...
 <?php
                    ...
                    $q = App\Models\Restaurant\POS\OrderHistory::where('item_id', $key->id)->where('item_type', 'Kitchen')->where('type', 'Sales')->whereIn('location',$loc_id)->whereBetween('invoice_date',[$start_date,$end_date])->sum('quantity');
                   $tqty=App\Models\Restaurant\POS\OrderHistory::where('item_id', $key->id)->where('item_type', 'Kitchen')->where('type', 'Sales')->whereIn('location',$loc_id)->whereBetween('invoice_date',[$start_date,$end_date])->sum(\DB::raw('quantity * price'));
