                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" data-toggle="tab" href="#list">School Years List</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(!empty($id)) active show @endif" data-toggle="tab" href="#tab2">Add/Edit School Year</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content pt-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                        <a class="list-icons-item text-primary" href="{{ route('schoolyears.edit', $schoolyear->id) }}">
                            ...
                            <div class="tab-pane fade @if(!empty($id)) active show @endif" id="tab2">
                                <div class="card-body">
                                    @if(isset($id))
                                        {!! Form::model($data, ['route' => ['schoolyears.update', $id], 'method' => 'PUT']) !!}
                                    @else
                                        {!! Form::open(['route' => 'schoolyears.store', 'method' => 'POST']) !!}
                                    @endif
