                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link @if(!isset($id)) active @endif" data-toggle="tab" href="#list">Student Subjects List</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(isset($id)) active @endif" data-toggle="tab" href="#tab2">Add/Edit Student Subject</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content pt-3">
                                    ...
                                    <table class="table datatable-basic table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $studentsubject->level->name ?? 'N/A' }}</td>
                                                <td>{{ $studentsubject->status }}</td>
                                                <td>
                                                    <div class="form-inline">
                                                        <a class="list-icons-item text-primary" href="{{ route('studentsubject.edit', $studentsubject->id) }}">
                                                            <i class="icon-pencil7"></i>
                                                        </a>
                                                        &nbsp;
                                                        {!! Form::open(['route' => ['studentsubject.destroy', $studentsubject->id], 'method' => 'delete']) !!}
                            ...
                            <div class="tab-pane fade @if(isset($id)) active show @endif" id="tab2">
                                <div class="card-body">
                                    @if(isset($id))
                                        {!! Form::model($data, ['route' => ['studentsubject.update', $id], 'method' => 'PUT']) !!}
                                    @else
                                    ...
                                    <div class="form-group text-right">
                                        ...
                                        <a href="{{ route('studentsubject.index') }}" class="btn btn-secondary">Cancel</a>
                                    </div>
