...
@if(!empty($students))
{!! Form::open(array('route' => 'student.save_disable','method'=>'POST', 'id' => 'frm-example' , 'name' => 'frm-example')) !!}
                                            ...
                                            @if(!@empty($students))
                                              @foreach ($students as $row)
                                                  <tr class="gradeA even" role="row">
                                                   ...
                                                   <td>{{$row->level}}</td>
                                                   <td>{{$row->class}}</td>
                                                   <td><input name="trans_id[]" type="checkbox"  class="checks" value="{{$row->id}}" ></td>      
