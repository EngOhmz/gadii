...
<div class="card-body">
    <ul class="nav nav-tabs" id="myTab2" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link @if ($type == 'edit-attachment') active @endif" id="profile-tab2" data-toggle="tab"
                href="#profile2" role="tab" aria-controls="profile" aria-selected="false">New Attachment</a>
        </li>
    ...
    <div class="tab-content tab-bordered" id="myTab3Content">
        <div class="tab-pane fade @if (
            $type == 'credit' ||
                ...
                $type == 'cargo' ||
                $type == 'storage' ||
                $type == ' charge') active show @endif " id="home2" role="tabpanel"
                            ...
                            @foreach ($attach as $row)
                                <tr class="gradeA even" role="row">
                                    ...
                                    <td><a href="#" class="" data-toggle="modal"
                                            data-target="#attachFormModal" data-id="{{ $row->id }}" data-type="view"
                                            onclick="attach_model({{ $row->id }},'view-attachment')">View Attachment</a>
                                    </td>
                                    <td>
                                        <div class="form-inline">
                                            <a class="list-icons-item text-primary" title="Edit"
                                                href="{{ route('edit.project_details', ['type' => 'edit-attachment', 'type_id' => $row->id]) }}"><i
                                                    class="icon-pencil7"></i></a>&nbsp
                                            <a class="list-icons-item text-danger" title="Edit"
                                                href="{{ route('delete.cf_details', ['type' => 'delete-attachment', 'type_id' => $row->id]) }}"
        ...
        <div class="tab-pane fade  @if ($type == 'edit-attachment') active show @endif" id="profile2" role="tabpanel"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" name="title"
                                        value="{{ isset($edit_data) ? $edit_data->title : '' }}" class="form-control"
                                        required>
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">Attachment <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="file" class="file-input" data-show-upload="false"
                                        name="attachment"
                                        value="{{ isset($edit_data) ? $edit_data->attachment : '' }}">
                                </div>
                            </div>
                            <div class="form-group row">
