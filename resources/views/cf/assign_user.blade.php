<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="formModal">Assign User for Project {{ $data->project_name }} - {{ $data->project_no }}
        </h5>
                ...
                <thead>
                    <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                            ...
                            style="width: 98.1094px;"><input type="checkbox" name="select_all" id="example-select-all">
                            Select All</th>
                    </tr>
                </thead>
                <tbody>
