                    ...
                    $type == 'cargo' ||
                    $type == 'storage' ||
                    $type == 'charge') active @endif "
                    id="home-tab2" data-toggle="tab" href="#exp-home2" role="tab" aria-controls="home" aria-selected="true">Expenses
                                                            List</a>
                                                    </li>
                                                    <li class="nav-item">
                ...
                $type == 'credit' ||
                    ...
                    $type == 'cargo' ||
                    $type == 'storage' ||
                    $type == 'charge') active show @endif" id="exp-home2" role="tabpanel"
                        ...
                        <a  class="nav-link" title="View" data-toggle="modal" class="discount"  href="" onclick="model({{ $row->id }},'expenses')" value="{{ $row->id}}" data-target="#app2FormModal" >View </a>
                    <a class="nav-link" id="profile-tab2" href="{{ route('multiple_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download PDF</a>
                                            <div>
                                            </div>
                           ...
                           <label class="col-lg-2 col-form-label">Reference  <span class="text-danger">*</span></label>
                                                 ...
                                                 <label class="col-lg-2 col-form-label">Agent <span class="text-danger">*</span></label>
                                                    <div class="col-lg-4">    
                                ...
                                <option  @if(isset($edit_data)) {{$edit_data->user_id== $row->id ? 'selected' : '' }} @endif  value="{{ $row->id }}">{{ $row->name }}</option>
                                @endforeach
                                @endif
                            </select>
                            </div></div>
                                               ...
                                               <div class="form-group row">
                                               <label class="col-lg-2 col-form-label">Expense Account  <span class="text-danger">*</span></label>
                                                    <div class="col-lg-4">
                                                <select class="m-b exp_account_id" id="account_id" name="account_id" required>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="amount" required
                                                            placeholder=""
                                                            value="{{ isset($edit_data) ?  number_format($edit_data->amount) : ''}}"
                                                            class="form-control exp_amount">
                                                    </div>
                                                 ...
                                                 @if(!empty($edit_data->supplier_id))
                                  <div class="form-group row" id="exp_supplier" ><label
                                                        class="col-lg-2 col-form-label">Supplier</label>
                                                    <div class="col-lg-4">
                                                <select class="m-b exp_supplier_id" id="exp_supplier_id" name="supplier_id" >
                                                    <option value="">Select Supplier</option>                                                    
                                                            @foreach ($supplier as $m)                                                             
                                                            <option value="{{$m->id}}" @if(isset($edit_data))@if($edit_data->supplier_id == $m->id) selected @endif @endif >{{$m->name}}</option>
                                                               @endforeach
                                                             </select>
                                                    </div>
                                                </div>
                                      @else
                                      <div class="form-group row" id="exp_supplier" style="display:none;"><label
                                                        class="col-lg-2 col-form-label">Supplier</label>
                                                    <div class="col-lg-4">
                                                <select class="m-b exp_supplier_id" id="exp_supplier_id" name="supplier_id" >
                                                    <option value="">Select Supplier</option>                                                    
                                            ...
                                            @endif
                                                   ...
                                                   <div class="form-group row">
                                                    ...
                                                    <select  class="form-control m-b" name="branch_id">
                                                        ...
                                                        <option value="{{ $row->id }}" @if(isset($edit_data))@if($edit_data->branch_id == $row->id ) selected @endif @endif>{{ $row->name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                    ...
                                    <br>
                                        ...
                                        @endif
                                                ...
                                                <label class="col-lg-2 col-form-label">Reference <span class="text-danger">*</span></label>
                                               <div class="col-lg-4">
                                            <input type="text" name="name" value="{{ isset($edit_data) ? $edit_data->name : ''}}"
                                        class="form-control" required>
                                    ...
                                    <option value="">Select Payment Account</option> 
                                        ...
                                        <div class=""> <p class="form-control-static exp_errors" id="errors" style="text-align:center;color:red;"></p>   </div>
                                                <br>
                                                <div class="table-responsive">
                ...
                <th>Action</th>
                             ...
                             <br>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-lg-offset-2 col-lg-12">
                                                                            @if($type == 'edit-expenses')
                                                                            <button class="btn btn-sm btn-primary float-right m-t-n-xs exp_save"
                                                                                data-toggle="modal" data-target="#myModal"
                                                                                type="submit">Update</button>
                                                                            @else
                                                                            <button class="btn btn-sm btn-primary float-right m-t-n-xs exp_save"
