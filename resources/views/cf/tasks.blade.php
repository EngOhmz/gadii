                         ...
                         <a class="nav-link  @if($type == 'credit' || $type == 'details' || $type == 'calendar' || $type == 'purchase' || $type == 'debit' || $type == 'invoice' || $type == 'comments' || $type == 'attachment' || $type == 'milestone' || $type == 'tasks' || $type == 'expenses' || $type == 'estimate' || $type == 'notes'  || $type =='logistic'  || $type =='cargo' || $type =='storage' || $type =='charge' || $type == 'activities' )  active  @endif" id="home-tab2" data-toggle="tab"
                                                ...
                                                <td>{{$category->name}}</td>
                                                <td>{{ Carbon\Carbon::parse($row->task_start_date)->format('d/m/Y') }}</td>
                                    <td>{{ Carbon\Carbon::parse($row->due_date)->format('d/m/Y') }}</td>
                                     ...
                                     <a class="list-icons-item text-primary" title="Edit"  href="{{route('edit.cf_details',['id' => $id,'type'=>'edit-tasks','type_id'=>$row->id])}}"><i class="icon-pencil7"></i></a>&nbsp
                                        ...
                                        @endif
                                               ...
                                               <div class="col-lg-5">
                                                <div class="input-group">
                                                  <select class="form-control append-button-single-field category_id" id="category_id" name="category_id" required style="width:10%;">
                                            <option value="">Select Category</option>  
                                                 ...
                                                 <label class="col-lg-2 col-form-label">End Date<span class="text-danger">*</span></label>                                                                                                        
                                                    ...
                                                    <div class="col-lg-4">
                                                       <select class="m-b" id="task_status" name="task_status" required>  
                                                    ...
                                                    <input type="checkbox" name="select_all"  id="example-select-all"> Select All<br> 
                                                            ...
                                                            @if (!empty($edit_data)) <?php if (in_array("$row->id", $list)) { echo 'checked'; } ?> @endif> {{$row->name}} &nbsp;
