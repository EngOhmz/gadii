...
<div class="card-body">
    <ul class="nav nav-tabs" id="myTab2" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link @if ($type == 'edit-milestone') active @endif" id="profile-tab2" data-toggle="tab"
                href="#milestone-profile2" role="tab" aria-controls="profile" aria-selected="false">New
                Milestone</a>
        </li>
    ...
    <div class="tab-content tab-bordered" id="myTab3Content">
        <div class="tab-pane fade @if (
            $type == 'credit' ||
                ...
                $type == 'cargo' ||
                $type == 'storage' ||
                $type == 'charge') active show @endif " id="milestone-home2"
                                    ...
                                    <td>
                                        <div class="form-inline">
                                            ...
                                            <a class="list-icons-item text-primary" title="Edit"
                                                href="{{ route('edit.cf_details', ['id' => $id,'type' => 'edit-milestone', 'type_id' => $row->id]) }}"><i
                                                    class="icon-pencil7"></i></a>&nbsp
                                            <a class="list-icons-item text-danger" title="Edit"
                                                href="{{ route('delete.cf_details', ['type' => 'delete-milestone', 'type_id' => $row->id]) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="name"
                                        value="{{ isset($edit_data) ? $edit_data->name : '' }}" class="form-control"
                                        required>
                                </div>
                            </div>
                           
                            <div class="form-group row"><label class="col-lg-2 col-form-label">Responsible <span class="text-danger">*</span></label>
                                <div class="col-lg-8">
                                    <select class="form-control m-b responsible_id" id="responsible_id" name="responsible_id" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="date" name="start_date" required 
                                        value="{{ isset($edit_data) ? $edit_data->start_date : date('Y-m-d') }}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="date" name="end_date" required 
                                        value="{{ isset($edit_data) ? $edit_data->end_date : date('Y-m-d') }}" class="form-control">
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <textarea name="description"  class="form-control">
                                        {{ isset($edit_data) ? $edit_data->description : '' }}</textarea>
