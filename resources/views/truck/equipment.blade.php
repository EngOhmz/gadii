    ...
    <div class="section-body">
        <div class="row">
                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Equipment
                                    List</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(!empty($id)) active show @endif" id="profile-tab2"
                                    data-toggle="tab" href="#profile2" role="tab" aria-controls="profile"
                                    aria-selected="false">New Equipment</a>
                            </li>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                              ...
                                              <a class="list-icons-item text-primary"
                                                        href="{{ route("equipment.edit", $row->id)}}"><i
         ...
         {!! Form::open(['route' => ['equipment.destroy',$row->id], 'method' => 'delete']) !!}
                            ...
                            <a class="nav-link" data-toggle="modal" href=""  value="{{ $row->id}}" data-type="update" data-target="#appFormModal" onclick="model({{ $row->id }},'update')">
                               Update Quantity
                            </a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                            @if(isset($id))
                                                    {{ Form::model($id, array('route' => array('equipment.update', $id), 'method' => 'PUT')) }}
                                                    @else
