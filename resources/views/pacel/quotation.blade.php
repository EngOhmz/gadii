                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td><a
                                                        href="{{ route('pacel_quotation.show', $row->id)}}">{{$row->pacel_number}}</a>
                                                    </li>
                                                </td>
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-outline-info text-uppercase px-2 rounded"
                                                        ...
                                                        href="{{ route('pacel_quotation.edit', $row->id)}}"><i
                                                            class="fa fa-edit"></i></a>

                                                    {!! Form::open(['route' => ['pacel_quotation.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu animated zoomIn">
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to transport package')"
                                                                    href="{{ route('pacel.approve', $row->id)}}">Transport
                                                                    Package</a></li>
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    onclick="return confirm('Are you sure?')"
                                                                    href="{{ route('pacel.cancel', $row->id)}}">Cancel
                                                                    Quotation</a></li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-lg-2 col-form-label">Weight (KG)</label>
                                                ...
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="input-group">
                                                            <select class="form-control supplier" name="owner_id"
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="btn btn-primary" type="button"
                                                                    data-toggle="modal"
                                                                    onclick="model({{ $a }},'supplier')" value="{{ $a}}"
                                                ...
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-10">
                                                        <textarea name="instructions"
                                                            class="form-control">{{ isset($data) ? $data->instructions : ''}}</textarea>

                                                    </div>
                                                </div>

                                                <br>
                                                <h4 align="center">Enter Route Details</h4>
                                                <hr>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <select class="form-control" name="currency_code"
                                                            ...
                                                            <option @if(isset($data))
                                                                {{$data->currency_code == $row->code ? 'selected' : 'TZS' }}
                                                                @endif value="{{ $row->code }}">{{ $row->name }}
                                                            </option>
                                                            @endforeach
                                                            @endif
                                                        </select>
                                                        ...
                                                        <select class="form-control" name="currency_code"
                                                            id="currency_code" required>
                                                            <option value="{{ old('currency_code')}}" disabled>Choose
                                                                option</option>
                                                            @if(isset($currency))
                                                            @foreach($currency as $row)
                                                ...
                                                <button type="button" name="add" class="btn btn-success btn-xs add"><i
                                                        class="fas fa-plus"> Add Routes</i></button><br>
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <tr class="line_items">
                                                                <td><select name="item_name[]"
                                                                        ...
                                                                        @foreach($route as $n) <option
                                                                            value="{{ $n->id}}" @if(isset($i))@if($n->id
                                                                            == $i->item_name) selected @endif @endif
                                                                            >From {{$n->from}} to {{$n->to}}
                                                                            ({{$n->distance}} km)</option>@endforeach
                                                                    </select></td>
                                                                ...
                                                                <td><select name="charge[]"
                                                                        class="form-control item_charge'+count{{$i->order_no}}"
                                                                        required>
                                                                        <option value="0">Select Charge Type</option>
                                                                        <option value="1" @if(isset($i))@if('Flat'==$i->
                                                                            charge_type) selected @endif @endif>Flat
                                                                        </option>
                                                                        <option value="{{$i->distance}}" name="one"
                                                                            @if(isset($i))@if('Distance'==$i->
                                                                            charge_type) selected @endif @endif>Distance
                                                                            per ton</option>
                                                                    </select>
                                                                </td>
                                                                <td><select name="tax_rate[]"
                                                                        ...
                                                                        <option value="0" @if(isset($i))@if($i->
                                                                            tax_rate) selected @endif @endif>No tax
                                                                        </option>
                                                                        <option value="0.18"
                                                                            @if(isset($i))@if('0.18'==$i->tax_rate)
                                                                            selected @endif @endif>18%</option>
                                                                    </select>
                                                                </td>
                                                            ...
                                                            <tr class="line_items">
                                                                ...
                                                                <td><input type="text" name="subtotal[]"
                                                                        ...
                                                                        jAutoCalc="SUM({total_cost})" readonly>
                                                                </td>
                                                            </tr>
                                                            <tr class="line_items">
                                                                <td colspan="5"></td>
                                                                ...
                                                                <td><input type="text" name="tax[]"
                                                                        class="form-control tax_total" placeholder="tax"
                                                            ...
                                                            <tr class="line_items">
                                                                ...
                                                                <td><span class="bold">Total</span>: </td>
                                                                <td><input type="text" name="amount[]"
                                                                        class="form-control t_total" placeholder="total"
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.item_charge' + sub_category_id).find('option[name="one"]').val(data[0][
                    "distance"
                ]);
...
$(document).ready(function() {
    ...
    $('.add').on("click", function(e) {
        ...
        html +=
            ...
            count +
            '"><option value="">Select Route</option>@foreach($route as $n) <option value="{{ $n->id}}">From {{$n->from}} to {{$n->to}}  ({{$n->distance}} km)</option>@endforeach</select></td>';
        html +=
        ...
        html += '<td><select name="charge[]" class="form-control item_charge' + count +
            '" required   data-sub_category_id="' + count +
            '" ><option value="0">Select Charge Type</option><option value="1">Flat</option><option value="" name="one">Distance per ton</option></select></td>';
        ...
        html += '<input type="hidden" name="items_id[]" class="form-control item_saved' + count +
            '"  required   />';
        html += '<input type="hidden"  name="distance[]" class="form-control item_distance' + count +
            '"  required  value="" />';
        ...
        html += '<td><input type="text" name="total_cost[]" width="20%" class="form-control item_total' + count +
