                                     ...
                                     <table class="table" id="example" class="display">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 131.219px;">Payment Status</th>

                                               <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 131.219px;">GRN Status</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($purchases as $row)
                                              ...
                                              <?php
                                        $due=App\Models\InventoryHistory::where('purchase_id',$row->id)->where('type', 'Purchases')->sum('quantity');
                                         $return=App\Models\InventoryHistory::where('purchase_id',$row->id)->where('type', 'Debit Note')->sum('quantity');
                                         $total_qty=App\Models\PurchaseItemInventory::where('purchase_id',$row->id)->sum('quantity');
                                         $rem_qty=$total_qty-($due-$return);
                                         
                                                              ?>
                                                   
                                            <tr class="gradeA even" role="row">

                                                <td><a href="{{ route('purchase_inventory.show',$row->id)}}">{{$row->reference_no}}</a></td>
                                                ...
                                                <td>
                                                    ...
                                                    @if($rem_qty == $total_qty)
                                                    <div class="badge badge-danger badge-shadow">Not Received</div>
                                                    @elseif(0 < $rem_qty && $rem_qty < $total_qty)
                                                    <div class="badge badge-info badge-shadow">Partially Received</div>
                                                    @elseif($rem_qty == 0)
                                                    <span class="badge badge-success badge-shadow">Fully Received </span>
                                                    @endif
                                                </td>
...
&nbsp
                                                  ...
                                                  @endif
                                                   ...
                                                   @php
                                                                $due = App\Models\InventoryHistory::where('purchase_id', $row->id)
                                  ...
                                  <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            @endif
                                                            @if($row->status != 0 && $row->status != 4 && $row->good_receive == 0)
                                                            <a class="nav-link" data-id="{{ $row->id }}" onclick="model({{ $row->id }},'receive')"
                                                             ...
                                                             @if (!empty($due))
                                                                <a class="nav-link" href="{{ route('inventory.issue', $row->id) }}"
                                                        ...
                                                        <a class="nav-link" href="{{ route('inv_pdfview', ['download' => 'pdf', 'id' => $row->id]) }}">Download PDF</a>

                                                        @if ($row->good_receive == 1)
                                                    <a class="nav-link" href="{{ route('inv_issue_pdfview', ['download' => 'pdf', 'id' => $row->id]) }}">Download Supplier Issue</a>
                                                            @endif
