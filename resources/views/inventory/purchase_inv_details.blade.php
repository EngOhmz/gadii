    ...
    <div class="section-body">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
              ...
              <a class="btn btn-xs btn-info"  title="Convert to Invoice" onclick="return confirm('Are you sure?')"    href="{{ route('inventory.receive',$purchases->id)}}"  title="" >Approve Purchase </a>
                @endif
                        ...
                        <th style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                         ...
                                         $due=App\Models\InventoryHistory::where('purchase_id',$purchases->id)->where('item_id',$row->item_name)->where('type', 'Purchases')->sum('quantity');
                                      $return=App\Models\InventoryHistory::where('purchase_id',$purchases->id)->where('item_id',$row->item_name)->where('type', 'Debit Note')->sum('quantity');
                                                          $qty=$due-$return;
                                         ?>
                                        <tr>
                                            <td class="">{{$i++}}</td>
...
?>
                                            ...
                                            <td> <a href="{{ route('inventory_payment_pdfview',['download'=>'pdf','id'=>$row->id]) }}"  title="" > Download Receipt </a> </td> 
                                        </tr>
                                        @endforeach
