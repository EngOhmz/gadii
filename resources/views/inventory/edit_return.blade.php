        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-12">
                                  ...
                                  <table class="table datatable-basic table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td><a href="{{ route('inventory_debit_note.show',$row->id)}}">{{$row->reference_no}}</a></td>
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                            ...
                                                            <a class="list-icons-item text-primary"
                                                                ...
                                                                href="{{ route('inventory_debit_note.edit', $row->id)}}"><i
                                                                    class="icon-pencil7"></i></a>&nbsp
                                                                    
        
                                                            {!! Form::open(['route' => ['inventory_debit_note.destroy',$row->id],
                                                            'method' => 'delete']) !!}
                                         ...
                                         @endif
                                               ...
                                               <div class="dropdown-menu">
                                                                    ...
                                                                    <li> <a class="nav-link" id="profile-tab2"
                                                                            href="{{ route('inventory_debit_note.receive',$row->id)}}"
                                                                            role="tab"
                                                                    ...
                                                                    <li> <a class="nav-link" id="profile-tab2"
                                                                            href="{{ route('inventory_debit_note.pay',$row->id)}}"
                                                                            role="tab"
                                                                    ...
                                                                    <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                            ...
                                                                            href="{{ route('inventory_debit_note.cancel', $row->id)}}">Cancel
                                                                          Credit Note</a></li>
                                                @endif
                                                <a class="nav-link" id="profile-tab2" href="{{ route('inventory_debit_note_pdfview',['download'=>'pdf','id'=>$row->id]) }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('inventory_debit_note.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'inventory_debit_note.store']) }}
                                                @method('POST')
                                                @endif
              ...
              <div class=""><p class="form-control-static item_errors" id="errors" style="text-align:center;color:red;"></p>   </div>
                                    ...
                                    @foreach($name as $n) 
                                    <option value="{{ $n->id}}"
                            @if(isset($i))@if($n->id == $i->item_name) selected @endif @endif >{{$n->name}}</option>
                                        @endforeach
                                                                    </select>
                                    <br> </div>
                         ...
                         Quantity 
                    <input type="number" name="quantity[]" class="form-control item_quantity"  min="1" placeholder="quantity" id="quantity" data-sub_category_id="{{$i->id}}_qty" value="{{ isset($i) ? $i->quantity : ''}}" required="">
...
console.log(id);
        $.ajax({
            url: '{{url("inventory/editshowInvoice")}}',
            type: "GET",
            data: {
                id: id,
            },
