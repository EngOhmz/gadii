                                  ...
                                  <table class="table datatable-basic table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a href="{{ route('inventory_credit_note.show',$row->id)}}" role="tab"
                                 ...
                                 @endif
                                       ...
                                       <div class="dropdown-menu">
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                  ...
                                                                  Credit Note</a></li>
                                        @endif
                               <a class="nav-link" id="profile-tab2" href="{{ route('inventory_credit_note_pdfview',['download'=>'pdf','id'=>$row->id]) }}"
...
console.log(id);
        $.ajax({
            url: '{{url("inventory/inventory_showInvoice")}}',
            type: "GET",
            data: {
                id: id,
            },
