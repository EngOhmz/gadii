  ...
  <div class="table-responsive">
                         ...
                         <?php
                                                ...
                                                $q = App\Models\InvoiceHistory::where('brand_id', $key->id)->where('type', 'Sales')->whereIn('location',$loc_id)->whereBetween('invoice_date',[$start_date,$end_date])->sum(\DB::raw('quantity * price'));
                                                 $r = App\Models\InvoiceHistory::where('brand_id', $key->id)->where('type', 'Credit Note')->whereIn('location',$loc_id)->whereBetween('invoice_date',[$start_date,$end_date])->sum(\DB::raw('quantity * price'));
                                                ?>  
                        <tfoot>
                                            <tr>     
                                                <td ></td> <td ></td>
