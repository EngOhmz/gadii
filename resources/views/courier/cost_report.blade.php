                ...
                <div class="table-responsive">
                    ...
                    <table class="table datatable-basic table-striped" id="tableExport" style="width:100%;">
                       ...
                       ?>
                        ...
                        $pickup=\App\Models\Courier\CourierActivity::where('loading_id',$key->id)->where('activity','Confirm Collection')->first();
                       $loading=\App\Models\Courier\CourierActivity::where('loading_id',$key->id)->where('activity','Confirm Loading')->first();
                   $off=\App\Models\Courier\CourierActivity::where('loading_id',$key->id)->where('activity','Confirm Offloading')->first();
