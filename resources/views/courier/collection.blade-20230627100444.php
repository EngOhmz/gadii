                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                {{$row->pacel_number}}
                                                {{--
                                                 <a href="#" target="_blank" class="nav-link" onclick="printDiv({{$row->id}})" > Bar Code</a>
                                                 --}}
                                                 </div>
                                                </td>   
                                               <td>{{$row->wbn_no}}</td> 
...
<label  class="col-lg-2 col-form-label">Bank/Cash Account</label>
 ...
 {!! Form::close() !!}
                          ...
                          <div style="display:none"> 
                            @foreach($quotation as $product)
                            <div class="panel-body" id="{{$product->id}}" >
          
            <div class="col-12" align="center">
                <?php echo '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG($product->pacel_number, "UPCA",1,33,array(1,1,1), true) . '"   />'; ?>
