        ...
        <div class="modal-body">
            ...
            <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                   ...
                                   <div class="col-lg-4">
                                    <select name="to_region_id" class="form-control m-m to_region" id="to_region_id" required>
            ...
            @if(!empty($old))
                                 ...
                                 <div class="col-lg-4 dist">
                                    <select name="to_district_id" class="form-control m-m to_district_id" id="to_district_id">
