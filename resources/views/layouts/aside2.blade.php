        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu">
                    <a href="#" class="nav-link {{ (request()->is('farmer_management/*')) ? 'active' : ''  }} "><i
                            class="icon-copy"></i> <span>{{__('farmer.farmer')}}</span></a>
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="{{__('farmer.farmer')}}">
                        ...
                        @can('view-farmer')
                        <li class="nav-item"><a
                                class="nav-link {{ (request()->is('farmer_management/farmer*')) ? 'active' : ''  }} "
                                href="{{url('farmer_management/farmer/')}}">{{__('farmer.manage_farmer')}}</a></li>
                        @endcan
                        @can('view-group')
                        <li class="nav-item"><a
                                class="nav-link {{ (request()->is('farmer_management/manage-group*')) ? 'active' : ''  }}"
                                href="{{url('farmer_management/manage-group')}}">{{__('farmer.manage_group')}}</a></li>
                        @endcan
                        @can('view-farmer')
                        <li class="nav-item"><a
                                class="nav-link {{ (request()->is('farmer_management/assign_farmer*')) ? 'active' : ''  }}"
                                href="{{url('farmer_management/assign_farmer/')}}">{{__('farmer.assign_farmer')}}</a>
                        </li>
                        @endcan
                    </ul>
                </li>
