...
<div class="head-title">
 ...
 <h3 class="text-center m-0 p-0">Radio Quotation</h3><br>
</div>
...
<tbody>
      ...
      <p> <strong>Invoice Date : {{Carbon\Carbon::parse($purchases->request_date)->format('d/m/Y')}}</strong></p>
                </div>
            </td>
        </tr>
</tbody>
...
<div class="end">
<div class="head-title">
    <p class="text-center head "><strong>Mashujaa FM is owned by MASHUJAA GROUP LIMITED.</strong></p>
