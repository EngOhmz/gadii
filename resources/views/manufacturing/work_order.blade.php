                                    ...
                                    <table class="table datatable-basic table-striped">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 141.219px;">Work Order Type</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                 ...
                                                 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 98.1094px;">Responsible User</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <!--    <td>
                                                   {{number_format($row->quantity - $row->due_quantity)}} 
                                                    
                                                    </td> -->
                                                    <td>
                                                    <a  class="nav-link" title="View" data-toggle="modal" class="discount"  href="" onclick="modelProduce({{ $row->id }},'view')" value="{{ $row->id}}" data-target="#appFormModal" >{{number_format(($row->quantity - $row->due_quantity),3)}} </a>
													...
													<div class="dropdown-menu">
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                               ...
                                                               @elseif($row->status == 1)
                                                                  ...
                                                                  <li>
                                                                  <a class="nav-link" href=""  data-toggle="modal" href=""  value="{{ $row->id}}" data-type="produce" data-target="#appFormModal"  onclick="model({{ $row->id 
                                                                     }},'finish')">Finish Production</a>
                                                                </li>
                                                                   @elseif($row->status == 3)
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <label class="col-lg-2 col-form-label">Bill Of Material</label>
                                                   <div class="col-lg-10">
                                                   <select class="form-control m-b material_bill" name="product" required
                                                                id="product">
                                                                ...
                                                                <option @if(isset($data))
                                                                    ...
                                                                    @endif value="{{ $row->id}}">{{$row->reference_no}} - {{$row->description}}</option>
                                                 ...
                                                 <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Work Order Type</label>
                                                   <div class="col-lg-10">
                                                   <select class="form-control m-b related_class" name="work_type" required
                                                                id="work_type">
                                                                <option >Select Type </option>
                                                                <option value="Finish Goods" @if(isset($data))@if($data->work_type == 'Finish Goods') selected @endif @endif >Finish Goods</option>
                                                                <option value="Bottle" @if(isset($data))@if($data->work_type == 'Bottle') selected @endif @endif >Bottle</option>
                                                             </select>
                                                    </div>
                                                </div>
                                              ...
                                              <!--  <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="number" name="quantity"
                                                        ...
                                                        class="form-control material_quantity">  
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row"> <div class="col-lg-10"> <p class="form-control-static errors" id="errors" style="text-align:center;color:red;"></p> </div>  </div>
                                                ...
                                                <div class="form-group row">
                                                <label class="col-lg-2 col-form-label">Responsible By</label>
                                                   <div class="col-lg-10">
                            ...
                            @endif
                                              ...
                                              <!--  <div class="form-group row">
                                                ...
                                                <label class="col-lg-2 col-form-label">Finished Store</label>
                                                   <div class="col-lg-10">
                                                   <select class="form-control m-b" name="finished_store" 
                                                                id="finished_store">
                                                ...
                                                <label class="col-lg-2 col-form-label">Finished Store</label>
                                                   <div class="col-lg-10">
                                                   <select class="form-control m-b" name="finished_store22" 
                                                                id="finished_store22">
                                                                <option value="">Select Finished Product Store </option>
                                                                @if(!empty($locations))
                                                                @foreach($locations as $row)
...
<script>
    $(document).ready(function() {
       ...
       $(document).on('change', '.material_quantity', function() {
            var id = $(this).val();
           var material_bill= $('.material_bill').val();

    console.log(material_bill);
            $.ajax({
                url: '{{url("manufacturing/findInvQuantity")}}',
                type: "GET",
                data: {
                    id: id,
...
function modelProduce(id, type) {
    ...
    $.ajax({
        type: 'GET',
      url: '{{url("manufacturing/findProduceModal")}}',
        data: {
            'id': id,
            'type': type,
        },
