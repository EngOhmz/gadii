                            ...
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link @if (empty($id)) active show @endif"
                                        ...
                                        aria-controls="home" aria-selected="true">Invoice
                                        List</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link @if (!empty($id)) active show @endif"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12 ">
                                                    @if (isset($id))
                                                        {{ Form::model($id, ['route' => ['invoice.update', $id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'invform']) }}
                                                    @else
                                                        {!! Form::open(['route' => 'invoice.store', 'enctype' => 'multipart/form-data', 'id' => 'invform']) !!}
                                                        @method('POST')
                                                    @endif
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            {{-- <select class="form-control m-b sales" name="sales_type"
                                                                ...
                                                                <option value="Cash Sales"
                                                                    @if (isset($data)) {{ $data->sales_type == 'Cash Sales' ? 'selected' : '' }}
                                                                @else selected @endif>
                                                                    Cash Sales</option>
            ...
            buttons: [
                {
                    ...
                    customize: function(win) {
                        $(win.document.body).find('table th').eq(0).text('Invoice No');
                ...
                },
                {
                    ...
                    customize: function(doc) {
                        if (doc.content && doc.content.length > 1 && doc.content[1].table && doc.content[1].table.body.length) {
                            doc.content[1].table.body[0][0].text = 'Invoice No';
                        }
                    }
                }
            ],
