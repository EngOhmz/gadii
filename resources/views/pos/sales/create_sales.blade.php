                ...
                <div class="card card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill text-center">
                            ...
                            <span class="text-primary m0">Total Sales Amount</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill text-center">
                            ...
                            <span class="text-success m0">Paid Sales</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill text-center">
                            ...
                            <span class="text-warning m0">Total Outstanding Sales</span>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            @if (!@empty($invoices))
                                                                                    @foreach ($invoices as $row)
                                                                                                                            ...
                                                                                                                            <tr class="gradeA even" role="row">
                                                                                                                                ...
                                                                                                                                <td>
                                                                                                                                    {{ $row->branch_id ? App\Models\Branch::find($row->branch_id)->name ?? 'No Branch selected' : 'No Branch selected' }}
                                                                                                                                </td>
                                                                                                                                <td>
                                                                                                                                    @if ($row->status == 0)
                                                                                                                                        ...
                                                                                                                                        <div class="dropdown">
                                                                                                                                            ...
                                                                                                                                            <div class="dropdown-menu">
                                                                                                                                                ...
                                                                                                                                                <a class="nav-link" id="profile-tab2"
                                                                                                                                                    href="{{ route('show_delivery', ['id' => $row->id]) }}"
                                            ...
                                            <div class="col-sm-12 ">
                                                ...
                                                {{-- <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Currency <span
                                                            class="required"> * </span></label>
                                                    <div class="col-lg-4">
                                                        @php $def = App\Models\System::where('added_by',
                                                        auth()->user()->added_by)->first(); @endphp
                                                        ...
                                                        <select class="form-control m-b" name="exchange_code"
                                                            ...
                                                            <option @if (isset($data)) {{ $data->exchange_code ==
                                                                $row->code ? 'selected' : 'TZS' }}
        ...
        $(document).ready(function () {
            ...
            $('.add').on("click", function (e) {
                ...
                html += '<div class="col-lg-3 line_items" id="td' + count +
                    ...
                    count + '" placeholder="Description"  ></textarea><br></div>';
                ...
                html += '<div class="col-lg-6 line_items" id="td' + count +
                    ...
                    count +
                    '" required><option value="">Select Tax</option><option value="0">No Tax</option><option value="0.18">Exclusive</option></select><br><br>Total Cost <input type="text" name="checked_total_cost[]" class="form-control item_total' +
