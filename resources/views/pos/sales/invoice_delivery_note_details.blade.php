            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    ...
                    <div class="col-lg-10">
                        ...
                        <a class="btn btn-xs btn-success" href="{{ route('invoice_delivery_note', ['download' => 'pdf', 'id' => $invoices->id]) }}" title=""> Download Delivery Note </a> 
                                ...
                                <div class="tab-pane fade show active" id="about" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-xs-3">
                                            ...
                                            <br>Status:
                                            <span class="badge badge-success badge-shadow" style="background-color: #28a745; color: #ffffff;">DN</span>
