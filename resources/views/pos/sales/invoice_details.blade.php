...
@endif
                ...
                <div class="clearfix">
                    ...
                    <p class="pull-right mr">{{number_format($sub_total,2)}}  {{$invoices->exchange_code}}</p>
                </div>

          @if(!@empty($tax > 0))
        <div class="clearfix">
                    <p class="pull-left">Total Tax</p>
                    <p class="pull-right mr">{{number_format($tax,2)}}  {{$invoices->exchange_code}}</p>
                </div>
  @endif

 <div class="clearfix">
                    <p class="pull-left">Total Amount</p>
                    <p class="pull-right mr">{{number_format($gland_total ,2)}} {{$invoices->exchange_code}}</p>
                </div>
  ...
  @if(!@empty($invoices->due_amount < $invoices->invoice_amount + $invoices->invoice_tax))
        <div class="clearfix">
                    ...
                    <p class="pull-right mr">{{number_format(($invoices->invoice_amount + $invoices->invoice_tax) - $invoices->due_amount,2)}}  {{$invoices->exchange_code}}</p>
                </div>

      <div class="clearfix">
                    <p class="pull-left h3 text-danger">Total Due</p>
                    <p class="pull-right mr">{{number_format($invoices->due_amount,2)}}  {{$invoices->exchange_code}}</p>
                </div>
@endif

<br>
 @if($invoices->exchange_code != 'TZS')
 <b>Exchange Rate 1 {{$invoices->exchange_code}} = {{$invoices->exchange_rate}} TZS</b>
<p></p>
<br>
                <div class="clearfix">
                    <p class="pull-left">Sub Total</p>
                    <p class="pull-right mr">{{number_format($sub_total * $invoices->exchange_rate,2)}}  TZS</p>
                </div>

          @if(!@empty($tax > 0))
        <div class="clearfix">
                    <p class="pull-left">Total Tax</p>
                    <p class="pull-right mr">{{number_format($tax * $invoices->exchange_rate,2)}}   TZS</p>
                </div>
  @endif
 ...
 <div class="clearfix">
                    <p class="pull-left">Total Amount</p>
                    <p class="pull-right mr">{{number_format($invoices->exchange_rate * $gland_total ,2)}}   TZS</p>
                </div>
  ...
  @if(!@empty($invoices->due_amount < $invoices->invoice_amount + $invoices->invoice_tax))
        <div class="clearfix">
                    <p class="pull-left">Paid Amount</p>
                    <p class="pull-right mr">{{number_format($invoices->exchange_rate * (($invoices->invoice_amount + $invoices->invoice_tax) - $invoices->due_amount),2)}}  TZS</p>
                </div>

      <div class="clearfix">
                    <p class="pull-left h3 text-danger">Total Due</p>
                    <p class="pull-right mr">{{number_format($invoices->due_amount * $invoices->exchange_rate,2)}}  TZS</p>
                </div>
@endif
