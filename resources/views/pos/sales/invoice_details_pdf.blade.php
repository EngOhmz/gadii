            ...
            <tr>
                ...
                <td class="w-50">
                    <div class="box-text">
                        ...
                        <p style="font-size: 12px;"><strong>Invoice No:</strong> {{ $invoices->reference_no }}</p>
    ...
    @if ($bank_curr)
        <table class="table w-100 mt-20">
            <tfoot>
                <tr>
                    <td style="width: 50%;">
                        <div><u><h3><b>Account Details.</b></h3></u></div>
                        ...
                        <div><b>Branch:</b> {{ $bank_curr->branch_name }}</div>
                         @if ($invoices->branch_id == 62)
                            <div><b>BRANCH CODE:</b> 001</div>
                            <div><b>PAYBILL NO:</b> 529901</div>
                         @else   
                         @endif
