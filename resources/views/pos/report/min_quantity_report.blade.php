    ...
    <div class="card">
        <div class="card-body text-primary">
            <h2 class="h3 mb-0 text-gray-800">
                <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/40C057/total-sales-1.png" /> Minimum Quantity Alert
            </h2>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Minimum Quantity Alert Report</h4>
                    </div>
                    <div class="card-body">
                        <div class="tab-content tab-bordered">
                            <div class="tab-pane fade show active" id="home2" role="tabpanel" aria-labelledby="home-tab2">
                                ...
                                <div class="panel-body hidden-print">
                                    {!! Form::open(array('url' => route('pos.min_quantity_report'), 'method' => 'get', 'class'=>'form-horizontal', 'name' => 'form')) !!}
                                    <div class="row">
                                        <div class="col-md-4">
                                                    ...
                                                    <tbody>
                                                        @foreach($items as $item)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($item['item_type'] == 6)
                                                                        <?php
                                                                            ...
                                                                            $crate_size = $item['crate_size'] ?? 1.00; 
                                                                            if ($crate_size == 0) {
                                                                                $crate_size = 1.00; 
                                                                            }
                                                                ...
                                                                <td>
                                                                    @if($item['quantity'] <= $item['minimum_balance'])
                                                                        <span class="badge badge-danger">Out of Stock</span>
                                                                    @elseif($item['quantity'] <= $item['minimum_balance_alert'])
                                                                        <span class="badge badge-warning">Almost Out of Stock</span>
                                                                    @else
