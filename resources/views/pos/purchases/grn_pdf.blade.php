...
<div class="head-title">
    <h1 class="text-center m-0 p-0">Good Receive</h1>
</div>
...
<div class="add-detail ">
 ...
 <tfoot>
         ...
         <tr>
             ...
             <td class="w-50">
                 <div class="box-text">
                    <p> <strong>Reference: {{$purchases->purchase->reference_no}}</strong></p>
                    <p> <strong>Purchase Date : {{Carbon\Carbon::parse($purchases->purchase_date)->format('d/m/Y')}}</strong></p>
                    <p> <strong>Location : @if(!empty($purchases->location)){{$purchases->store->name }}@endif</strong></p>
                 </div>
             </td>
         </tr>
 </tfoot>
...
<tbody>
        ...
        <tr>
            ...
            <td>
                <div class="box-text">
                @if(!empty($purchases->supplier->name))
...
<thead>
        ...
        <tbody>
            ...
            <tr align="center">
                <td>{{$i++}}</td>
                 <?php
                $item_name = App\Models\POS\Items::find($purchases->item_id);
                                        ?>
                <td>@if(!empty($item_name->name)) {{$item_name->name}} @else {$row->item_name}} @endif   </td>             
                <td >{{ number_format($purchases->quantity,2) }}</td>   
