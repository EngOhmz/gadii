                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Item
                                                        Type <span class="required"> * </span></label>
                                                    <div class="col-lg-10">
                                                        <select class="form-control m-b type" name="type" required>
                                                            <option value="">Select</option>
                                                            <option value="1" {{ isset($data) ? ($data->type == 1 ? 'selected' : '') : '' }}>
                                                                Retail</option>
                                                            <option value="6" {{ isset($data) ? ($data->type == 6 ? 'selected' : '') : '' }}>
                                                                    Wholesale</option>
                                                            <option value="4" {{ isset($data) ? ($data->type == 4 ? 'selected' : '') : '' }}>
                                                                Service</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                @if(!empty($data) && !empty($data->type == '1'))
                                                    <div class="form-group row" id="product">
                                                        <label class="col-lg-2 col-form-label">Does Product have
                                                            barcode?</label>
                                                        <div class="col-lg-10">
                                                            <select class="form-control m-b product" id="product"
                                                ...
                                                @if(!empty($data) && !empty($data->barcode_type != ''))
                                                    ...
                                                    <div class="form-group row" id="symbol"><label
                                                        ...
                                                        <div class="col-lg-10">
                                                            <select class="form-control m-b barcode_type"
                                                                name="barcode_type" id="barcode_type">
                                                                <option value="">Select</option>
                                                                <option value="UPCA" {{ isset($data) ? ($data->barcode_type == 'UPCA' ? 'selected' : '') : '' }}>
                                                                    Bar Code</option>
                                                    ...
                                                    <div class="form-group row" id="bar">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <button class="btn btn-outline-secondary scan"
                                                                    type="button"><i class="icon-barcode2"> </i>
                                                                    Scan</button>
                                                ...
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">
                                                        Minimum Quantity Balance <span class="required"> *
                                                        </span></label>

                                                    <div class="col-lg-10">
                                                        <input type="number" name="minimum_balance" id="minimum_balance"
                                                            value="{{ isset($data) ? $data->minimum_balance : '' }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="date" name="expire_date" id="expire_date"
                                                            value="{{ isset($data) ? $data->expire_date : '' }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-10">
                                                        <select class="form-control m-b" name="category_id"
                                                            ...
                                                            @foreach ($category as $loc)
                                                                        <option @if (isset($data)) {{ $data->category_id == $loc->id ? 'selected' : '' }} @endif value="{{ $loc->id }}">
                                                                                {{ $loc->name }}
                                                                            </option>
                                                                            @endforeach
                                                                        @endif
                                                ...
                                                <div class="form-group row" id="size">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <select class="form-control m-b" name="size" id="size1">
                                                            <option value="">Select Size</option>
                                                            @if (!empty($size))
                                                            @foreach ($size as $s)
                                                                                        <option @if (isset($data)) {{ $data->size == $s->id ? 'selected' : '' }} @endif value="{{ $s->id }}">
                                                                                                {{ $s->name }}
                                                                                            </option>
                                                                                            @endforeach
                                                                                        @endif
                                                ...
                                                <div class="form-group row" id="size" style=" display:none ">
                                                    <label class="col-lg-2 col-form-label">Size</label>
                                                    <div class="col-lg-10">
                                                        <select class="form-control m-b" name="size" id="size1">
                                                            <option value="">Select Size</option>
                                                ...
                                                <div class="form-group row" id="color">
                                                    <label class="col-lg-2 col-form-label">Color</label>
                                                    <div class="col-lg-10">
                                                        <select class="form-control m-b" name="color" id="color1">
                                                            <option value="">Select Color</option>
                                                            @if (!empty($color))
                                                            @foreach ($color as $c)
                                                                                        <option @if (isset($data)) {{ $data->color == $c->id ? 'selected' : '' }} @endif value="{{ $c->id }}">
                                                                                                {{ $c->name }}
                                                                                            </option>
                                                                                            @endforeach
                                                                                        @endif
                                                ...
                                                <div class="form-group row"><label class="col-lg-2 col-form-label"> Tax
                                                    ...
                                                    <div class="col-lg-10">
                                                        <select name="tax_rate" class="form-control m-b item_tax"
                                                            ...
                                                            <option value="0" @if (isset($data)) @if ('0' == $data->tax_rate) selected @endif @endif>No tax
                                                            </option>
                                                            <option value="0.18" @if (isset($data)) @if ('0.18' == $data->tax_rate) selected @endif @endif>18%
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                {{-- <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <!-- Input field for normal cases -->
                                                        <input type="text" name="unit" id="unit_input" 
                                                            value="{{ isset($data) ? $data->unit : '' }}" 
                                                            class="form-control">
                                                        
                                                        <!-- Dropdown for type 6 (initially hidden) -->
                                                        <select name="unit" id="unit_select" class="form-control" style="display: none;">
                                                            <option value="">Select Unit For Items In Wholesale</option>
                                                ...
                                                <div class="form-group row" id="crate_size_container" style="display: none;">
                                                    <label class="col-lg-2 col-form-label">Wholesale Qty</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" name="crate_size"
                                                            value="{{ isset($data) ? $data->crate_size : '' }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
    ...
    <script>
        $(document).ready(function () {
            $(document).on('change', '.type', function () {
                ...
                // Show crate_size_container only when type is 6
                if (id == '6') {
                    $("#crate_size_container").show();
                } else {
                    $("#crate_size_container").hide();
                }
            });
...
<script>
    $(document).ready(function () {
        $(document).on('change', '.type', function () {
            ...
            if (id == '6') {
                $("#unit_input").hide();  // Hide the input field
                $("#unit_select").show(); // Show the dropdown
            } else {
                $("#unit_input").show();  // Show the input field
                $("#unit_select").hide(); // Hide the dropdown
            }
        });
