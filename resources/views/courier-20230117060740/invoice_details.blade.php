            ...
            <table class="table items invoice-items-preview" >
                <thead class="bg-items">
                    <tr>
                      ...
                      <th style="color:white;">Storage Costs</th>
...
@endif
                                             ...
                                             <td class="">
                                  @if(!@empty($row->storage_costs > 0))
                             {{number_format($row->storage_costs ,2)}} 
                                @else
                           {{number_format(0 ,2)}} 
@endif
</td>
...
<td colspan="5"></td>
<td>Add :Total Storage Costs </td>
<td>{{number_format($storage_total * $purchases->exchange_rate,2)}}   TZS<</td>
</tr>
<tr>
<td colspan="5"></td>
<td>Total Amount</td>
