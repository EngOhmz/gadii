...
<!-- /.admin side -->
                   ...
                   $off=\App\Models\Courier\CourierActivity::where('loading_id',$key->id)->where('activity','Confirm Commission')->first();
                ...
                if(!empty($delivery->costs)){
                        ...
                        ?>
                            <tr>
                             ...
                             <td>{{$key->confirmation_number}} </td> 
                                    <td>{{$key->route->from}} - {{$key->route->to}}</td>
                       ...
                       <td>{{ number_format(($key->amount)-($total_p+ $total_l + $total_o + $total_d),2) }}</td>   
                            </tr>
                        ...
                        <tfoot>
                         ...
                         <td>{{!empty($l)? number_format($l,2) : number_format(0,2)}} </td> 
                          <td>{{!empty($o)? number_format($o,2) : number_format(0,2)}} </td> 
                           ...
                           <td>{{ number_format(($invoice)-($p+ $l + $o + $d),2) }}</td>
