                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Request
                                    List</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(!empty($id)) active show @endif" id="profile-tab2"
                                    data-toggle="tab" href="#profile2" role="tab" aria-controls="profile"
                                    aria-selected="false">Report Pickup</a>
                            </li>
                                        ...
                                        <thead>
                                            <tr>                                              
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 91.219px;">Weight</th>
...
@if(auth()->user()->client_id != null)
<?php 
   $tariff= App\Models\Tariff::where('client_id',auth()->user()->client_id)->get();
?>
<td><select name="item_name[]" class="form-control m-b item_name" id="name"  required ><option value="">Select Tariff</option>
  @if(!empty($tariff))
                                                        @foreach($tariff as $trow)

                                                        <option value="{{$trow->id}}">From {{$trow->from}} to {{$trow->to}}</option>
