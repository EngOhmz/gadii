        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                   ...
                   @if($purchases->good_receive == 0 && $purchases->by_client == 'No' && $purchases->status != 7)
              ...
              <a   href="#" class="btn btn-xs btn-info" title="Collect" data-toggle="modal"  onclick="model({{ $purchases->id }},'assign')" value="{{ $purchases->id}}" data-target="#appFormModal">Approve Pickup</a> 
                @endif
           @endif
                  ...
                  <!--Client Actions -->
                               ...
                               @if(auth()->user()->client_id != null)
               @if($purchases->good_receive == 0 && $purchases->approval_2 == '' )
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"  href="{{ route('courier_quotation.edit', $purchases->id)}}"  title="" > Edit </a>       
                @endif

                   @if($purchases->approval_1 == '' && $purchases->good_receive == 0)
                         <a  class="btn btn-xs btn-info"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('courier.first_approval', $purchases->id)}}">First Approval</a>
                           @elseif($purchases->approval_1 != '' && $purchases->approval_2 == '')
                            <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('courier.second_approval', $purchases->id)}}">Second Approval</a>
                          @endif
 ...
 <div class="col-lg-3 col-xs-3">
          ...
          <br>Status: 
                                                ...
                                                @if($purchases->status == 0 && $purchases->good_receive == 0)
                                                    ...
                                                    @elseif($purchases->status == 7 && $purchases->good_receive == 0)
                               ...
                               @if(auth()->user()->client_id != null)
                                       @if($purchases->approval_1 == '' && $purchases->good_receive == 0)
                                                    <div class="badge badge-danger badge-shadow">Waiting For First Approval</div>
                                                         @elseif($purchases->approval_1 != '' && $purchases->approval_2 == '' && $purchases->good_receive == 0)
                    ...
                    <tr>
                        ...
                        <th  style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <td class=""><strong class="block">From {{$item_name->from}} to {{$item_name->to}}</strong></td>
                                            <td class="">{{ $row->quantity }} KG</td>
