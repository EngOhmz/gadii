    ...
    <div class="section-body">
        <div class="row">
                                        ...
                                        <tr>
                                           ...
                                           <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 106.484px;">Weight</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 171.219px;">Tariff</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 141.219px;">Storage Cost</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                              ...
                                              <td>{{number_format($row->amount,2)}} {{$row->courier->currency_code}}</td>
                                               <?php
                   $off=\App\Models\Courier\CourierActivity::where('loading_id',$row->id)->where('activity','Confirm Commission')->first();
                 $s=$storage->days;
                  $today = date('Y-m-d');
          ...
          $x= round($datediff / (60 * 60 * 24));
             $price=$x * ($storage->price/$row->courier->exchange_rate) * $row->weight;
                                  }
                      ...
                      $price=0;
                                              ...
                                              ?>
                                                 ...
                                                 @if($row->status == 5)
                                        <td>{{number_format($price,2)}} {{$row->courier->currency_code}}</td>
                                                        @elseif($row->status == 6)
                                                          <td>{{number_format($row->storage_costs,2)}} {{$row->courier->currency_code}}</td>
                                                           @endif
                                                <td>
                                                    @if($row->status == 5)
