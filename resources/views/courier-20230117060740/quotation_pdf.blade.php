...
<html>
<head>
    <title>EmaSuite Quatation PDF </title>
</head>
<style type="text/css">
    body{
...
<div class="head-title">
    <h2 class="text-center m-0 p-0">Customer Quatation</h1>
</div>
...
<tfoot>
        ...
        <tr>
            ...
            <td class="w-50">
                <div class="box-text">
                   <p> <strong>Quatation : {{$purchases->confirmation_number}}</strong></p>
      <p> <strong>Quatation Date : {{Carbon\Carbon::parse($purchases->date)->format('d/m/Y')}}</strong></p>
                </div>
            </td>
        </tr>
</tfoot>
...
<footer>
This is a computer generated Quatation
</footer>
</body>
</html>