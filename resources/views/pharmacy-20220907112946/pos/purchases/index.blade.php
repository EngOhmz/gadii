...
$(document).ready(function() {
    ...
    $('.add').on("click", function(e) {
        ...
        html +=
            '<td><input type="text" name="batch_number[]" class="form-control item_batch_number ' + count +
            '"placeholder ="Batch No#" required /></td>';
        html +=
            '<td><input type="month" name="expire_date[]" class="form-control item_monthyear' + count + 
            '"placeholder ="Expires" required  data-format="yyyy/mm/dd"/></td>';  
