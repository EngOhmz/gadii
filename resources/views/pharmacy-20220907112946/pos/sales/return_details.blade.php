    ...
    <div class="section-body">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
              ...
              <a class="btn btn-xs btn-info"  title="Convert to Invoice" onclick="return confirm('Are you sure?')"    href="{{ route('credit_note.approve',$invoices->id)}}"  title="" >Approve Invoice </a>
                @endif

               @if($invoices->status != 0 && $invoices->status != 4 && $invoices->status != 3 && $invoices->good_receive == 1)                      
                <a class="btn btn-xs btn-danger " data-placement="top"  href="{{ route('credit_note.pay',$invoices->id)}}"  title="Add Payment"> Pay invoice  </a>    
           @endif  

      @if($invoices->status != 0 && $invoices->status != 4 && $invoices->status != 3 && $invoices->good_receive == 0)                        
              <a class="btn btn-xs btn-info" data-placement="top"  href="{{ route('credit_note.receive',$invoices->id)}}"  title="Good Receive"> Good Receive </a>   
           @endif  
...
?>
 ...
 <div class="col-lg-3 col-xs-3">
                                      ...
                                      Return Date : {{Carbon\Carbon::parse($invoices->date)->format('d/m/Y')}}                  
