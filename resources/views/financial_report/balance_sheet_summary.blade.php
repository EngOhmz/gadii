...
<div class="panel panel-white col-lg-12">
            ...
            <table id="data-table" class="table table-striped ">
                    ...
                    <tr>
                 <th>#</th>
                        <th colspan="2" style="text-align: center">STATEMENT OF FINANCIAL POSITION FOR THE PERIOD ENDING {{Carbon\Carbon::parse($start_date)->format('d/m/Y')}} </th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
...
?>
                          <tr>
                        <td >{{ $c }} . </td>
                        <td ><b><a onclick="model({{ $account_class->id }},'b_class')" href="#view{{$account_class->id}}" data-toggle="modal" data-target="#appFormModal">{{ $account_class->class_name  }}</a></b></td>
