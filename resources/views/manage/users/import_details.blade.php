            ...
            <div class="col-12 col-sm-12 col-lg-12">
                <div class="card">
                 <div class="card-header header-elements-sm-inline">
								<h4 class="card-title"> Import User Details</h4>
                            ...
                            <div class="tab-pane fade @if(empty($id)) active show @endif" id="home2" role="tabpanel"
                               ...
                               <div class="card">
                                <div class="card-header">
                                     <form action="{{ route('details.sample') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            <div class="container mt-5 text-center">
                                                ...
                                                <form action="{{ route('details.import') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <button class="btn btn-primary">Import User Details</button>
