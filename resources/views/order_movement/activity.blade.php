            ...
            <div class="col-12 col-sm-6 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>All Tracking Activities Performed by Staffs </h4>
                    </div>
                    <div class="card-body">
                                     ...
                                     <table class="table datatable-basic table-striped">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 156.484px;">Staff</th>
                                        ...
                                        <tbody>
                                            ...
                                            $route = App\Models\Route::find($pacel->route_id); 
                                             //$name=App\Models\Pacel\PacelName::find($pacel->pacel_name); 
                                        @endphp
                                                ...
                                                <td>{{$row->user->name}}</td>
                                                <td>{{$pacel->confirmation_number}} - {{$pacel->pacel_name}} </td>                                           
