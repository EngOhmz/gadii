  ...
  <div class="table-responsive">
                           <table class="table datatable-basic table-striped">
                                       <thead>
                                        ...
                                        <tbody>
                                            <?php                   
                                                $account =App\Models\InventoryHistory::where('item_id', $key->id)->whereIn('location',$loc_id)->whereBetween('purchase_date',[$start_date,$end_date])->orderBy('purchase_date','desc')->get();
                                                ?>  
                         ...
                         <?php
                                                ...
                                                $q = App\Models\InventoryHistory::where('item_id', $key->id)->where('type', 'Purchases')->whereIn('location',$loc_id)->whereBetween('purchase_date',[$start_date,$end_date])->sum(\DB::raw('quantity * price'));
                                                $r = App\Models\InventoryHistory::where('item_id', $key->id)->where('type', 'Debit Note')->whereIn('location',$loc_id)->whereBetween('purchase_date',[$start_date,$end_date])->sum(\DB::raw('quantity * price'));
