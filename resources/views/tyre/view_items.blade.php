...
<div class=""><p class="form-control-static item_errors" id="errors" style="text-align:center;color:red;"></p>   </div>
 ...
 <div class="table-responsive" id="cart">
                                              ...
                                              <div class="row body">
                                                      ...
                                                      <?php
                                                     $due=App\Models\Tyre\TyreHistory::where('purchase_id',$purchase_id)->where('item_id',$i->item_name)->where('type', 'Purchases')->sum('quantity');
                                                 $return=App\Models\Tyre\TyreHistory::where('purchase_id',$purchase_id)->where('item_id',$i->item_name)->where('type', 'Debit Note')->sum('quantity');
                                                  $qty=$due-$return;
                                                      ?>
