                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                            ...
                            <a class="nav-link" href=""  data-toggle="modal" href=""  value="{{ $row->id}}" data-type="return" data-target="#appFormModal" onclick="model({{ $row->id }},'return')">View  Items</a>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                            <select class="form-control m-b truck_id" name="truck_id" required id="truck">
                                            ...
                                            <table class="table table-bordered" id="cart">
                                                ...
                                                @foreach($list as $n) 
                                                <option value="{{ $n->id}}" @if(isset($i))@if($n->id == $i->item_id) selected @endif @endif >{{ $n->serial_no }} - {{ $n->position }} </option>
                                                @endforeach
                                                        </select>
           ...
           var id = $('.truck_id').val();
            $.ajax({
               ...
               $('.rtype_'+count).find('.item_name').empty();
                $('.rtype_'+count).find('.item_name').append('<option value="">Select Tire</option>');
                $.each(data,function(key, value)
                {
                 
                     $('.rtype_'+count).find('.item_name').append('<option value=' + value.id+ '>' + value.serial_no + ' - ' + value.position + '</option>');
    ...
    $(document).ready(function() {
         ...
         $(document).on('change', '.truck_id', function() {
            ...
            $.ajax({
                ...
                console.log(data);
                $('.item_name').empty();
               $('.item_name').append('<option value="">Select Tire</option>');
                $.each(data,function(key, value)
                {
                 
                    $('.item_name').append('<option value=' + value.id+ '>' + value.serial_no + ' - ' + value.position + '</option>');
