...
<section class="section">
    <div class="section-body">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                 ...
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"   href="{{ route('inventory_credit_note.edit', $invoices->id)}}"  title="" > Edit </a>          
      ...
      @if($invoices->status == 0 && $invoices->status != 4 && $invoices->status != 3 && $invoices->good_receive == 0)                        
              <a class="btn btn-xs btn-info" data-placement="top"  href="{{ route('inventory_credit_note.receive',$invoices->id)}}"  title="Good Receive"> Approve Credit Note </a>   
           @endif  
             
             <a class="btn btn-xs btn-success"  href="{{ route('inventory_credit_note_pdfview',['download'=>'pdf','id'=>$invoices->id]) }}"  title="" > Download PDF </a>         
                       ...
                       <th style="color:white;">#</th>
                        ...
                        <th  style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <td class=""><strong class="block">{{$item_name->brand->name}} - {{$item_name->serial_no}}</strong></td>
                                            <td class="">{{ $row->quantity }} </td>
                                        <td class="">{{number_format($row->price ,2)}}  </td>                                         
                                         <td class="">{{number_format($row->total_tax ,2)}} 
