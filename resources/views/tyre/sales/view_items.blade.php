...
<div class=""><p class="form-control-static errors" id="errors" style="text-align:center;color:red;"></p>   </div>
 ...
 <div class="table-responsive" id="cart">
                                              ...
                                              <div class="row body">
                                                      ...
                                                      <?php
                                                     $due=App\Models\InvoiceHistory::where('invoice_id',$invoice_id)->where('item_id',$i->item_name)->where('type', 'Sales')->sum('quantity');
                                                         $return=App\Models\InvoiceHistory::where('invoice_id',$invoice_id)->where('item_id',$i->item_name)->where('type', 'Credit Note')->sum('quantity');
                                                          $qty=$due-$return;
                                                      ?>
                          ...
                          <input type="hidden" min="1" name="quantity[]" class="form-control item_quantity" data-sub_category_id={{$i->order_no}} value="{{ isset($i) ? $qty : ''}}" required />
