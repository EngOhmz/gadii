...
<div class="head-title">
    <h1 class="text-center m-0 p-0">Inventory Sales</h1>
</div>
            ...
            <tr align="center">
                <td>{{$i++}}</td>
                   <?php
                                        ...
                                        ?>
                                <td class=""><strong class="block">@if(!empty($item_name->serial_no)) {{$item_name->brand->name}} - {{$item_name->serial_no}}  @else {{$row->item_name}}  @endif   </strong> <br>{{$row->description}}   </td>
