        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-lg-12">
                ...
                <div class="card">
                                    ...
                                    <div class="">                            
                                        <p class="form-control-static" style="text-align:center;"><strong>MUDA  : </strong><?php echo $timecorrect->created_at->format('Y-m-d'). " @ ". $timecorrect->created_at->format('H:i:s'); ?></p>
                                    </div>
