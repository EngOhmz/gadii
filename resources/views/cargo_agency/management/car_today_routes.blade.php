                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            <div class="form-group">
                                                <a class="btn btn-dark"
                                                    href="{{ route('car_pacel_detail', [$data->car_id, $data->start_date, $data->closeDate]) }}"
                                                    role="button">DAR | 1</a><br><br>

                                                <p class="h6">{{ $data->start_date }} {{ $data->closeDate }}</p>

                                                <div class="row">
                                                    <button type="button" class="btn btn-outline-secondary">FROM DAR |
                                                        1</button>
                                                    <button type="button" class="btn btn-outline-secondary">TO
                                                        {{ $data->to }} | {{ $data->driver->name }}</button>
                                                    <button type="button" class="btn btn-outline-secondary">NOW DAR |
                                                        1</button>
                                                    <button type="button" class="btn btn-outline-secondary">MATUMIZI
                                                        0TSH/=</button>
                                ...
                                @else
                                    <li class="list-group-item">
                                        <div class="form-group">
                                            <p class="h6">The car is not loaded</p>
                                        </div>
                                    </li>
                                @endif
