...
<body>
    ...
    <div>
        <h4 align="center" style="margin-top: 0%;" class="fontS">TUNASAFRISHA MIZIGO KUTOKA DAR ES SALAAM<h4>
                ...
                <h3 align="center" style="font-weight: normal;" class="fontL"><b>DELIVERY NOTE</b></h3>
                <hr style="border: dashed;">
                ...
                <div class="space fontS">
                    <div class="col-md-12">
                    <p class="fontL"><b>JINA: {{ $dataResult2->mteja }}</b></p>
                    <p class="space fontL"><b>DATE: {{ $dataResult2->created_at->format('Y-m-d') }} @ {{ $dataResult2->created_at->format('H:i:s') }}<b></p>

                        @foreach($dataResult as $data)
                        
<p class="space fontL"><b>REF: {{ $data->delivery }}</b></p>

<p class="space" class="space fontL">TO: {{ $data->mzigo_unapokwenda }} &nbsp;&nbsp; DESCRIPTION: {{ $data->name }}</p>
...
<p class="space  fontL"><b>TRANSPORT COST : {{ $data->jumla }} TSH</b></p>

<p class="space"><b><hr style="border: dashed;"></b></p>
