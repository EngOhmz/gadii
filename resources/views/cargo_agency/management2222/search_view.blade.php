        ...
        <div class="col-12 col-sm-12 col-lg-12">
         ...
         <div class="card">
                <div class="card-header">
                    <h4>Orodha za Magari</h4>
                </div>
                <div class="card-body">
                    <!-- Tabs within a box -->
                    <!-- <div class="col-md-9 offset-md-9 form-inline">
                    <input type="date" class="form-control" name="dateT" id="date3">&nbsp;&nbsp;
                    ...
                    <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Magari Yaliyofika</a>
                            </li>
                    </ul>
                            ...
                            <div class="tab-pane fade @if(empty($id)) active show @endif" id="home2">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped " id="table-1">
                                        ...
                                        @if(!@empty($cars))
                                              @foreach ($cars as $row)
                                              @php $carNumber = Car::where('id', $row->car_id)->value('carNumber') @endphp
                                                <tr class="gradeA even" role="row">
                                                  <th>{{ $loop->iteration }}</th>
                                                   <td>@php $carNumber  @endphp</td>
                                                   <td><div class="form-inline">
                                                <div class = "input-group"> 
                                            <a href="{{route('car_today_routes',$row->car_id)}}" class="btn btn-outline-primary btn-xs" title="Routes">Routes</a> 
                                        </div>&nbsp
                                    </div>
                                    </td>      
