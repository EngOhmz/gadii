                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link @if(!empty($id)) active show @endif"
                                    href="#profile2" data-toggle="tab">EVENT</a>
                            </li>
                    </ul>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped " id="table-1">
                                        ...
                                        <tr class="gradeA even" role="row">
                                            ...
                                            <a href="#" class="btn btn-outline-primary btn-xs" title="Routes">Angalia Vizuri</a> 
                                        </div>&nbsp
                                    </div>
                                    </td>      
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="gradeA even" role="row">
                                                  <th>no</th>
                                                   ...
                                                   <td><div class="form-inline">
                                                <div class = "input-group"> 
                                            <a href="#" class="btn btn-outline-primary btn-xs" title="Routes">Angalia Mizigo</a> 
                                        </div>&nbsp
                                    </div>
                                    </td>      
