                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                            <li class="nav-item"><a
                                    ...
                                    data-toggle="tab">Kuhariri Gari</a>
                            </li>
                    </ul>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            {{ Form::model($car, array('route' => array('car.update', $car->id),'role'=>'form','enctype'=>'multipart/form-data' ,'method' => 'PUT')) }}
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="form-group row">
                                                                    <label class="control-label">Namba ya Gari<span class="required">
                                                                            </span></label> </label>
                                                                    <input type="text"  name="carNumber" class="form-control" value="{{  old('carNumber', $car->carNumber) }}" required>
                                                                </div>
