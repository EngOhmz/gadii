...
<body>
    ...
    <div>
        <h4 align="center" style="margin-top: 0%;" class="fontS">TUNASAFRISHA MIZIGO KUTOKA DAR ES SALAAM<h4>
                ...
                <h3 align="center" style="font-weight: normal;" class="fontL"><b>MANIFEST 2</b></h3>
                <hr style="border: dashed;">
...
$count = 0;
                ...
                <div class="space  fontS">
                    <div class="col-md-12">                 
<p class="fontL" ><b class="fontN">2 #<?php echo $count; ?></b>&nbsp;&nbsp;<b>JINA:<?php echo $mteja; ?> &nbsp;&nbsp;&nbsp;REF:<?php echo $delivery; ?></b></p>
