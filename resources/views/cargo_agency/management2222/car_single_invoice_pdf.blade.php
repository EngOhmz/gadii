...
<body>
        ...
        <h4 align="center" style="margin-top: 0%;" class="fontS">TUNASAFRISHA MIZIGO KUTOKA DAR ES SALAAM<h4>
                ...
                <h3 align="center" style="font-weight: normal;" class="fontL"><b>IN CAR INVOICE</b></h3>
                <hr style="border: dashed;">
...
use App\Models\PacelHistory;
                        ...
                        $delivery = CustomerPacel::where('id', $pacelUnique->pacel_id)->value('delivery');


                        $receipt = CustomerPacel::where('id', $pacelUnique->pacel_id)->value('receipt');

                        $to = CustomerPacel::where('id', $pacelUnique->pacel_id)->value('mzigo_unapokwenda');


                        $created_at = PacelHistory::where('pacel_id', $pacelUnique->pacel_id)->where('activity', 'kupakia')->latest()->first()->created_at;

                        $total =  $pacels->where('pacel_id',$pacelUnique->pacel_id)->where('activity', 'kupakia')->sum('jumla');


                        ?>
   
                <h3 align="center" style="font-weight: normal; font-size:10px;"><b>INVOICE</b></h3>
                <hr style="border: dashed;">
                        

                <h3 align="center" style="font-weight: normal;" class="fontL"><b>INVOICE</b></h3>
                    <div class="col-md-12">
<p class="fontL"><b>JINA:  &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $pacelUnique->mteja; ?></b></p>
...
<?php $histories =  $pacels->where('pacel_id',$pacelUnique->pacel_id); foreach ($histories as $data): if( $data->activity == "kupakia"): ?>
<br> 
...
<p align="center">======****======</p>
    ...
    <script type="text/php">
        ...
        $x = 20;
        $y = 820;
        $text = "sanga                                            - - - -    {PAGE_NUM} of {PAGE_COUNT} pages    - - - - ";
        $font = null;
        $size = 10;
        $color = array(0,0,0);
